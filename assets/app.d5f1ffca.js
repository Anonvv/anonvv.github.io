import{_ as On}from"./preload-helper.1c052cf7.js";import{i as nn,c as Se,a as ke,b as Gn,d as pn,e as Ie,t as Rn,f as Re,g as Te,h as xe,j as Jn,k as Ae,l as Ce,m as He,n as Vn,o as $e,w as an,p as y,q as u,r as d,u as i,s as f,v as j,x as p,y as v,z as l,A as U,B as H,C as zn,D as N,E as W,F as q,G as K,H as M,I as x,J as $,K as w,L as C,M as P,N as Un,O as X,P as G,Q as en,R as qe,S as D,T as Le,U as Me,V as B,W as hn,X as Kn,Y as Pe,Z as Ee}from"./framework.3a6555e1.js";import{u as I,w as L,a as Y,E as Ne,b as We,i as J,p as Xn,c as je,R as Be,d as De,e as Fe,C as Ye,s as Oe}from"./Debug.vue_vue_type_style_index_0_scoped_true_lang.f6b720f8.js";import{_}from"./plugin-vue_export-helper.21dcd24c.js";import{P as Ge}from"./Pagination.9d20b2d5.js";const Je="http://www.w3.org/2000/svg",F=typeof document!="undefined"?document:null,Tn=F&&F.createElement("template"),Ve={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,o)=>{const a=e?F.createElementNS(Je,n):F.createElement(n,t?{is:t}:void 0);return n==="select"&&o&&o.multiple!=null&&a.setAttribute("multiple",o.multiple),a},createText:n=>F.createTextNode(n),createComment:n=>F.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>F.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},cloneNode(n){const e=n.cloneNode(!0);return"_value"in n&&(e._value=n._value),e},insertStaticContent(n,e,t,o,a,s){const r=t?t.previousSibling:e.lastChild;if(a&&(a===s||a.nextSibling))for(;e.insertBefore(a.cloneNode(!0),t),!(a===s||!(a=a.nextSibling)););else{Tn.innerHTML=o?`<svg>${n}</svg>`:n;const h=Tn.content;if(o){const c=h.firstChild;for(;c.firstChild;)h.appendChild(c.firstChild);h.removeChild(c)}e.insertBefore(h,t)}return[r?r.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}};function ze(n,e,t){const o=n._vtc;o&&(e=(e?[e,...o]:[...o]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}function Ue(n,e,t){const o=n.style,a=nn(t);if(t&&!a){for(const s in t)dn(o,s,t[s]);if(e&&!nn(e))for(const s in e)t[s]==null&&dn(o,s,"")}else{const s=o.display;a?e!==t&&(o.cssText=t):e&&n.removeAttribute("style"),"_vod"in n&&(o.display=s)}}const xn=/\s*!important$/;function dn(n,e,t){if(pn(t))t.forEach(o=>dn(n,e,o));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const o=Ke(n,e);xn.test(t)?n.setProperty(Jn(o),t.replace(xn,""),"important"):n[o]=t}}const An=["Webkit","Moz","ms"],rn={};function Ke(n,e){const t=rn[e];if(t)return t;let o=Ae(e);if(o!=="filter"&&o in n)return rn[e]=o;o=Ce(o);for(let a=0;a<An.length;a++){const s=An[a]+o;if(s in n)return rn[e]=s}return e}const Cn="http://www.w3.org/1999/xlink";function Xe(n,e,t,o,a){if(o&&e.startsWith("xlink:"))t==null?n.removeAttributeNS(Cn,e.slice(6,e.length)):n.setAttributeNS(Cn,e,t);else{const s=He(e);t==null||s&&!Vn(t)?n.removeAttribute(e):n.setAttribute(e,s?"":t)}}function Qe(n,e,t,o,a,s,r){if(e==="innerHTML"||e==="textContent"){o&&r(o,a,s),n[e]=t==null?"":t;return}if(e==="value"&&n.tagName!=="PROGRESS"&&!n.tagName.includes("-")){n._value=t;const c=t==null?"":t;(n.value!==c||n.tagName==="OPTION")&&(n.value=c),t==null&&n.removeAttribute(e);return}let h=!1;if(t===""||t==null){const c=typeof n[e];c==="boolean"?t=Vn(t):t==null&&c==="string"?(t="",h=!0):c==="number"&&(t=0,h=!0)}try{n[e]=t}catch{}h&&n.removeAttribute(e)}const[Qn,Ze]=(()=>{let n=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(n=performance.now.bind(performance));const t=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(t&&Number(t[1])<=53)}return[n,e]})();let mn=0;const nt=Promise.resolve(),et=()=>{mn=0},tt=()=>mn||(nt.then(et),mn=Qn());function O(n,e,t,o){n.addEventListener(e,t,o)}function ot(n,e,t,o){n.removeEventListener(e,t,o)}function at(n,e,t,o,a=null){const s=n._vei||(n._vei={}),r=s[e];if(o&&r)r.value=o;else{const[h,c]=st(e);if(o){const m=s[e]=it(o,a);O(n,h,m,c)}else r&&(ot(n,h,r,c),s[e]=void 0)}}const Hn=/(?:Once|Passive|Capture)$/;function st(n){let e;if(Hn.test(n)){e={};let o;for(;o=n.match(Hn);)n=n.slice(0,n.length-o[0].length),e[o[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Jn(n.slice(2)),e]}function it(n,e){const t=o=>{const a=o.timeStamp||Qn();(Ze||a>=t.attached-1)&&$e(rt(o,t.value),e,5,[o])};return t.value=n,t.attached=tt(),t}function rt(n,e){if(pn(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(o=>a=>!a._stopped&&o&&o(a))}else return e}const $n=/^on[a-z]/,lt=(n,e,t,o,a=!1,s,r,h,c)=>{e==="class"?ze(n,o,a):e==="style"?Ue(n,t,o):Te(e)?xe(e)||at(n,e,t,o,r):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):ut(n,e,o,a))?Qe(n,e,o,s,r,h,c):(e==="true-value"?n._trueValue=o:e==="false-value"&&(n._falseValue=o),Xe(n,e,o,a))};function ut(n,e,t,o){return o?!!(e==="innerHTML"||e==="textContent"||e in n&&$n.test(e)&&Gn(t)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA"||$n.test(e)&&nn(t)?!1:e in n}const qn=n=>{const e=n.props["onUpdate:modelValue"]||!1;return pn(e)?t=>Ie(e,t):e};function ct(n){n.target.composing=!0}function Ln(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ht={created(n,{modifiers:{lazy:e,trim:t,number:o}},a){n._assign=qn(a);const s=o||a.props&&a.props.type==="number";O(n,e?"change":"input",r=>{if(r.target.composing)return;let h=n.value;t&&(h=h.trim()),s&&(h=Rn(h)),n._assign(h)}),t&&O(n,"change",()=>{n.value=n.value.trim()}),e||(O(n,"compositionstart",ct),O(n,"compositionend",Ln),O(n,"change",Ln))},mounted(n,{value:e}){n.value=e==null?"":e},beforeUpdate(n,{value:e,modifiers:{lazy:t,trim:o,number:a}},s){if(n._assign=qn(s),n.composing||document.activeElement===n&&n.type!=="range"&&(t||o&&n.value.trim()===e||(a||n.type==="number")&&Rn(n.value)===e))return;const r=e==null?"":e;n.value!==r&&(n.value=r)}},Mn={beforeMount(n,{value:e},{transition:t}){n._vod=n.style.display==="none"?"":n.style.display,t&&e?t.beforeEnter(n):V(n,e)},mounted(n,{value:e},{transition:t}){t&&e&&t.enter(n)},updated(n,{value:e,oldValue:t},{transition:o}){!e!=!t&&(o?e?(o.beforeEnter(n),V(n,!0),o.enter(n)):o.leave(n,()=>{V(n,!1)}):V(n,e))},beforeUnmount(n,{value:e}){V(n,e)}};function V(n,e){n.style.display=e?n._vod:"none"}const Zn=Re({patchProp:lt},Ve);let z,Pn=!1;function dt(){return z||(z=ke(Zn))}function mt(){return z=Pn?z:Se(Zn),Pn=!0,z}const ne=(...n)=>{const e=dt().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(!a)return;const s=e._component;!Gn(s)&&!s.render&&!s.template&&(s.template=a.innerHTML),a.innerHTML="";const r=t(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),r},e},gt=(...n)=>{const e=mt().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(a)return t(a,!0,a instanceof SVGElement)},e};function ee(n){return nn(n)?document.querySelector(n):n}function pt(n,e){let t=[],o=!0;const a=s=>{if(o){o=!1;return}const r=[],h=Math.min(t.length,s.length);for(let c=0;c<h;c++){let m=t[c];const[g,S,A=""]=s[c];if(m.tagName.toLocaleLowerCase()===g){for(const b in S)m.getAttribute(b)!==S[b]&&m.setAttribute(b,S[b]);for(let b=0;b<m.attributes.length;b++){const k=m.attributes[b].name;k in S||m.removeAttribute(k)}m.innerHTML!==A&&(m.innerHTML=A)}else document.head.removeChild(m),m=En(s[c]),document.head.append(m);r.push(m)}t.slice(h).forEach(c=>document.head.removeChild(c)),s.slice(h).forEach(c=>{const m=En(c);document.head.appendChild(m),r.push(m)}),t=r};an(()=>{const s=n.data,r=e.value,h=s&&s.title,c=s&&s.description,m=s&&s.frontmatter.head;document.title=(h?h+" | ":"")+r.title,document.querySelector("meta[name=description]").setAttribute("content",c||r.description),a([...m?yt(m):[]])})}function En([n,e,t]){const o=document.createElement(n);for(const a in e)o.setAttribute(a,e[a]);return t&&(o.innerHTML=t),o}function ft(n){return n[0]==="meta"&&n[1]&&n[1].name==="description"}function yt(n){return n.filter(e=>!ft(e))}const vt=/#.*$/,wt=/(index)?\.(md|html)$/,tn=/\/$/,bt=/^[a-z]+:/i;function fn(n){return Array.isArray(n)}function yn(n){return bt.test(n)}function _t(n,e){if(e===void 0)return!1;const t=Nn(`/${n.data.relativePath}`),o=Nn(e);return t===o}function Nn(n){return decodeURI(n).replace(vt,"").replace(wt,"")}function St(n,e){const t=n.endsWith("/"),o=e.startsWith("/");return t&&o?n.slice(0,-1)+e:!t&&!o?`${n}/${e}`:n+e}function gn(n){return/^\//.test(n)?n:`/${n}`}function te(n){return n.replace(/(index)?(\.(md|html))?$/,"")||"/"}function kt(n){return n===!1||n==="auto"||fn(n)}function It(n){return n.children!==void 0}function Rt(n){return fn(n)?n.length===0:!n}function vn(n,e){if(kt(n))return n;e=gn(e);for(const t in n)if(e.startsWith(gn(t)))return n[t];return"auto"}function oe(n){return n.reduce((e,t)=>(t.link&&e.push({text:t.text,link:te(t.link)}),It(t)&&(e=[...e,...oe(t.children)]),e),[])}const Tt=["href","aria-label"],xt=["src"],At=y({__name:"NavBarTitle",setup(n){const{site:e,theme:t,localePath:o}=I();return(a,s)=>(u(),d("a",{class:"nav-bar-title",href:i(o),"aria-label":`${i(e).title}, back to home`},[i(t).logo?(u(),d("img",{key:0,class:"logo",src:i(L)(i(t).logo),alt:"Logo"},null,8,xt)):f("",!0),j(" "+p(i(e).title),1)],8,Tt))}});var Ct=_(At,[["__scopeId","data-v-7ac13a1e"]]);function Ht(){const{site:n,localePath:e,theme:t}=I();return v(()=>{const o=n.value.langs,a=Object.keys(o);if(a.length<2)return null;const r=Y().path.replace(e.value,""),h=a.map(m=>({text:o[m].label,link:`${m}${r}`}));return{text:t.value.selectText||"Languages",items:h}})}const $t=["GitHub","GitLab","Bitbucket"].map(n=>[n,new RegExp(n,"i")]);function qt(){const{site:n}=I();return v(()=>{const e=n.value.themeConfig,t=e.docsRepo||e.repo;if(!t)return null;const o=Lt(t);return{text:Mt(o,e.repoLabel),link:o}})}function Lt(n){return Ne.test(n)?n:`https://github.com/${n}`}function Mt(n,e){if(e)return e;const t=n.match(/^https?:\/\/[^/]+/);if(!t)return"Source";const o=$t.find(([a,s])=>s.test(t[0]));return o&&o[0]?o[0]:"Source"}function ae(n){const e=Y(),t=yn(n.value.link);return{props:v(()=>{const a=Wn(`/${e.data.relativePath}`);let s=!1;if(n.value.activeMatch)s=new RegExp(n.value.activeMatch).test(a);else{const r=Wn(n.value.link);s=r==="/"?r===a:a.startsWith(r)}return{class:{active:s,isExternal:t},href:t?n.value.link:L(n.value.link),target:n.value.target||(t?"_blank":null),rel:n.value.rel||(t?"noopener noreferrer":null),"aria-label":n.value.ariaLabel}}),isExternal:t}}function Wn(n){return n.replace(/#.*$/,"").replace(/\?.*$/,"").replace(/\.(html|md)$/,"").replace(/\/index$/,"/")}const Pt={},Et={class:"icon outbound",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",x:"0px",y:"0px",viewBox:"0 0 100 100",width:"15",height:"15"},Nt=l("path",{fill:"currentColor",d:"M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"},null,-1),Wt=l("polygon",{fill:"currentColor",points:"45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"},null,-1),jt=[Nt,Wt];function Bt(n,e){return u(),d("svg",Et,jt)}var wn=_(Pt,[["render",Bt]]);const Dt={class:"nav-link"},Ft=y({__name:"NavLink",props:{item:null},setup(n){const t=U(n),{props:o,isExternal:a}=ae(t.item);return(s,r)=>(u(),d("div",Dt,[l("a",zn({class:"item"},i(o)),[j(p(n.item.text)+" ",1),i(a)?(u(),H(wn,{key:0})):f("",!0)],16)]))}});var jn=_(Ft,[["__scopeId","data-v-49fe041d"]]);const Yt=n=>(N("data-v-07381bdb"),n=n(),W(),n),Ot={class:"nav-dropdown-link-item"},Gt=Yt(()=>l("span",{class:"arrow"},null,-1)),Jt={class:"text"},Vt={class:"icon"},zt=y({__name:"NavDropdownLinkItem",props:{item:null},setup(n){const t=U(n),{props:o,isExternal:a}=ae(t.item);return(s,r)=>(u(),d("div",Ot,[l("a",zn({class:"item"},i(o)),[Gt,l("span",Jt,p(n.item.text),1),l("span",Vt,[i(a)?(u(),H(wn,{key:0})):f("",!0)])],16)]))}});var Ut=_(zt,[["__scopeId","data-v-07381bdb"]]);const Kt=["aria-label"],Xt={class:"button-text"},Qt={class:"dialog"},Zt=y({__name:"NavDropdownLink",props:{item:null},setup(n){const e=Y(),t=q(!1);K(()=>e.path,()=>{t.value=!1});function o(){t.value=!t.value}return(a,s)=>(u(),d("div",{class:M(["nav-dropdown-link",{open:t.value}])},[l("button",{class:"button","aria-label":n.item.ariaLabel,onClick:o},[l("span",Xt,p(n.item.text),1),l("span",{class:M(["button-arrow",t.value?"down":"right"])},null,2)],8,Kt),l("ul",Qt,[(u(!0),d(x,null,$(n.item.items,r=>(u(),d("li",{key:r.text,class:"dialog-item"},[w(Ut,{item:r},null,8,["item"])]))),128))])],2))}});var Bn=_(Zt,[["__scopeId","data-v-18d75f62"]]);const no={key:0,class:"nav-links"},eo={key:1,class:"item"},to={key:2,class:"item"},oo=y({__name:"NavLinks",setup(n){const{theme:e}=I(),t=Ht(),o=qt(),a=v(()=>e.value.nav||o.value||t.value);return(s,r)=>i(a)?(u(),d("nav",no,[i(e).nav?(u(!0),d(x,{key:0},$(i(e).nav,h=>(u(),d("div",{key:h.text,class:"item"},[h.items?(u(),H(Bn,{key:0,item:h},null,8,["item"])):(u(),H(jn,{key:1,item:h},null,8,["item"]))]))),128)):f("",!0),i(t)?(u(),d("div",eo,[w(Bn,{item:i(t)},null,8,["item"])])):f("",!0),i(o)?(u(),d("div",to,[w(jn,{item:i(o)},null,8,["item"])])):f("",!0)])):f("",!0)}});var se=_(oo,[["__scopeId","data-v-35b91e7e"]]);const ao={emits:["toggle"]},so=l("svg",{class:"icon",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",role:"img",viewBox:"0 0 448 512"},[l("path",{fill:"currentColor",d:"M436 124H12c-6.627 0-12-5.373-12-12V80c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12z",class:""})],-1),io=[so];function ro(n,e,t,o,a,s){return u(),d("div",{class:"sidebar-button",onClick:e[0]||(e[0]=r=>n.$emit("toggle"))},io)}var lo=_(ao,[["render",ro]]);const uo=n=>(N("data-v-40587210"),n=n(),W(),n),co={class:"nav-bar"},ho=uo(()=>l("div",{class:"flex-grow"},null,-1)),mo={class:"nav"},go=y({__name:"NavBar",emits:["toggle"],setup(n){return(e,t)=>(u(),d("header",co,[w(lo,{onToggle:t[0]||(t[0]=o=>e.$emit("toggle"))}),w(Ct),ho,l("div",mo,[w(se)]),C(e.$slots,"search",{},void 0,!0)]))}});var po=_(go,[["__scopeId","data-v-40587210"]]);function fo(){let n=null,e=null;const t=_o(o,300);function o(){const r=yo(),h=vo(r);for(let c=0;c<h.length;c++){const m=h[c],g=h[c+1],[S,A]=bo(c,m,g);if(S){history.replaceState(null,document.title,A||" "),a(A);return}}}function a(r){if(s(e),s(n),e=document.querySelector(`.sidebar a[href="${r}"]`),!e)return;e.classList.add("active");const h=e.closest(".sidebar-links > ul > li");h&&h!==e.parentElement?(n=h.querySelector("a"),n&&n.classList.add("active")):n=null}function s(r){r&&r.classList.remove("active")}P(()=>{o(),window.addEventListener("scroll",t)}),Un(()=>{a(decodeURIComponent(location.hash))}),X(()=>{window.removeEventListener("scroll",t)})}function yo(){return[].slice.call(document.querySelectorAll(".sidebar a.sidebar-link-item"))}function vo(n){return[].slice.call(document.querySelectorAll(".header-anchor")).filter(e=>n.some(t=>t.hash===e.hash))}function wo(){return document.querySelector(".nav-bar").offsetHeight}function Dn(n){const e=wo();return n.parentElement.offsetTop-e-15}function bo(n,e,t){const o=window.scrollY;return n===0&&o===0?[!0,null]:o<Dn(e)?[!1,null]:!t||o<Dn(t)?[!0,decodeURIComponent(e.hash)]:[!1,null]}function _o(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),o=!0,setTimeout(()=>{o=!1},e))}}function So(){const n=Y(),{site:e}=I();return fo(),v(()=>{const t=n.data.headers,o=n.data.frontmatter.sidebar,a=n.data.frontmatter.sidebarDepth;if(o===!1)return[];if(o==="auto")return Fn(t,a);const s=vn(e.value.themeConfig.sidebar,n.data.relativePath);return s===!1?[]:s==="auto"?Fn(t,a):s})}function Fn(n,e){const t=[];if(n===void 0)return[];let o;return n.forEach(({level:a,title:s,slug:r})=>{if(a-1>e)return;const h={text:s,link:`#${r}`};a===2?(o=h,t.push(h)):o&&(o.children||(o.children=[])).push(h)}),t}const ie=n=>{const e=Y(),{site:t,frontmatter:o}=I(),a=n.depth||1,s=o.value.sidebarDepth||1/0,r=e.data.headers,h=n.item.text,c=ko(t.value.base,n.item.link),m=n.item.children,g=_t(e,n.item.link),S=a<s?re(g,m,r,a+1):null;return G("li",{class:"sidebar-link"},[G(c?"a":"p",{class:{"sidebar-link-item":!0,active:g},href:c},h),S])};function ko(n,e){return e===void 0||e.startsWith("#")?e:St(n,e)}function re(n,e,t,o=1){return e&&e.length>0?G("ul",{class:"sidebar-links"},e.map(a=>G(ie,{item:a,depth:o}))):n&&t?re(!1,Io(t),void 0,o):null}function Io(n){return le(Ro(n))}function Ro(n){n=n.map(t=>Object.assign({},t));let e;return n.forEach(t=>{t.level===2?e=t:e&&(e.children||(e.children=[])).push(t)}),n.filter(t=>t.level===2)}function le(n){return n.map(e=>({text:e.title,link:`#${e.slug}`,children:e.children?le(e.children):void 0}))}const To={key:0,class:"sidebar-links"},xo=y({__name:"SideBarLinks",setup(n){const e=So();return(t,o)=>i(e).length>0?(u(),d("ul",To,[(u(!0),d(x,null,$(i(e),a=>(u(),H(i(ie),{item:a},null,8,["item"]))),256))])):f("",!0)}});const Ao=y({__name:"SideBar",props:{open:{type:Boolean}},setup(n){return(e,t)=>(u(),d("aside",{class:M(["sidebar",{open:n.open}])},[w(se,{class:"nav"}),C(e.$slots,"sidebar-top",{},void 0,!0),w(xo),C(e.$slots,"sidebar-bottom",{},void 0,!0)],2))}});var Co=_(Ao,[["__scopeId","data-v-17c48e2f"]]);const Ho=/bitbucket.org/;function $o(){const{page:n,theme:e,frontmatter:t}=I(),o=v(()=>{const{repo:s,docsDir:r="",docsBranch:h="master",docsRepo:c=s,editLinks:m}=e.value,g=t.value.editLink!=null?t.value.editLink:m,{relativePath:S}=n.value;return!g||!S||!s?null:qo(s,c,r,h,S)}),a=v(()=>e.value.editLinkText||"Edit this page");return{url:o,text:a}}function qo(n,e,t,o,a){return Ho.test(n)?Mo(n,e,t,o,a):Lo(n,e,t,o,a)}function Lo(n,e,t,o,a){return(yn(e)?e:`https://github.com/${e}`).replace(tn,"")+`/edit/${o}/`+(t?t.replace(tn,"")+"/":"")+a}function Mo(n,e,t,o,a){return(yn(e)?e:n).replace(tn,"")+`/src/${o}/`+(t?t.replace(tn,"")+"/":"")+a+`?mode=edit&spa=0&at=${o}&fileviewer=file-view-default`}const Po={class:"edit-link"},Eo=["href"],No=y({__name:"EditLink",setup(n){const{url:e,text:t}=$o();return(o,a)=>(u(),d("div",Po,[i(e)?(u(),d("a",{key:0,class:"link",href:i(e),target:"_blank",rel:"noopener noreferrer"},[j(p(i(t))+" ",1),w(wn,{class:"icon"})],8,Eo)):f("",!0)]))}});var Wo=_(No,[["__scopeId","data-v-55695e90"]]);const jo={key:0,class:"last-updated"},Bo={class:"prefix"},Do={class:"datetime"},Fo=y({__name:"LastUpdated",setup(n){const{theme:e,page:t}=I(),o=v(()=>{const r=e.value.lastUpdated;return r!==void 0&&r!==!1}),a=v(()=>{const r=e.value.lastUpdated;return r===!0?"Last Updated":r}),s=q("");return P(()=>{s.value=new Date(t.value.lastUpdated).toLocaleString("en-US")}),(r,h)=>i(o)?(u(),d("p",jo,[l("span",Bo,p(i(a))+":",1),l("span",Do,p(s.value),1)])):f("",!0)}});var Yo=_(Fo,[["__scopeId","data-v-30c3cbb4"]]);const Oo={class:"page-footer"},Go={class:"edit"},Jo={class:"updated"},Vo=y({__name:"PageFooter",setup(n){return(e,t)=>(u(),d("footer",Oo,[l("div",Go,[w(Wo)]),l("div",Jo,[w(Yo)])]))}});var zo=_(Vo,[["__scopeId","data-v-5c96fb00"]]);function Uo(){const{page:n,theme:e}=I(),t=v(()=>te(gn(n.value.relativePath))),o=v(()=>{const c=vn(e.value.sidebar,t.value);return fn(c)?oe(c):[]}),a=v(()=>o.value.findIndex(c=>c.link===t.value)),s=v(()=>{if(e.value.nextLinks!==!1&&a.value>-1&&a.value<o.value.length-1)return o.value[a.value+1]}),r=v(()=>{if(e.value.prevLinks!==!1&&a.value>0)return o.value[a.value-1]}),h=v(()=>!!s.value||!!r.value);return{next:s,prev:r,hasLinks:h}}const Ko={},Xo={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},Qo=l("path",{d:"M19,11H7.4l5.3-5.3c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-7,7c-0.1,0.1-0.2,0.2-0.2,0.3c-0.1,0.2-0.1,0.5,0,0.8c0.1,0.1,0.1,0.2,0.2,0.3l7,7c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4L7.4,13H19c0.6,0,1-0.4,1-1S19.6,11,19,11z"},null,-1),Zo=[Qo];function na(n,e){return u(),d("svg",Xo,Zo)}var ea=_(Ko,[["render",na]]);const ta={},oa={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},aa=l("path",{d:"M19.9,12.4c0.1-0.2,0.1-0.5,0-0.8c-0.1-0.1-0.1-0.2-0.2-0.3l-7-7c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l5.3,5.3H5c-0.6,0-1,0.4-1,1s0.4,1,1,1h11.6l-5.3,5.3c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l7-7C19.8,12.6,19.9,12.5,19.9,12.4z"},null,-1),sa=[aa];function ia(n,e){return u(),d("svg",oa,sa)}var ra=_(ta,[["render",ia]]);const la={key:0,class:"next-and-prev-link"},ua={class:"container"},ca={class:"prev"},ha=["href"],da={class:"text"},ma={class:"next"},ga=["href"],pa={class:"text"},fa=y({__name:"NextAndPrevLinks",setup(n){const{hasLinks:e,prev:t,next:o}=Uo();return(a,s)=>i(e)?(u(),d("div",la,[l("div",ua,[l("div",ca,[i(t)?(u(),d("a",{key:0,class:"link",href:i(L)(i(t).link)},[w(ea,{class:"icon icon-prev"}),l("span",da,p(i(t).text),1)],8,ha)):f("",!0)]),l("div",ma,[i(o)?(u(),d("a",{key:0,class:"link",href:i(L)(i(o).link)},[l("span",pa,p(i(o).text),1),w(ra,{class:"icon icon-next"})],8,ga)):f("",!0)])])])):f("",!0)}});var ya=_(fa,[["__scopeId","data-v-e65a9748"]]);const va={class:"page"},wa={class:"container"},ba=y({__name:"Page",setup(n){return(e,t)=>{const o=en("Content");return u(),d("main",va,[l("div",wa,[C(e.$slots,"top",{},void 0,!0),w(o,{class:"content"}),w(zo),w(ya),C(e.$slots,"bottom",{},void 0,!0)])])}}});var _a=_(ba,[["__scopeId","data-v-8fcebc32"]]);const Sa={key:0,id:"ads-container"},ka=y({__name:"Layout",setup(n){const e=qe(()=>On(()=>import("./Home.3c7b90da.js"),["assets/Home.3c7b90da.js","assets/Debug.vue_vue_type_style_index_0_scoped_true_lang.f6b720f8.js","assets/framework.3a6555e1.js","assets/plugin-vue_export-helper.21dcd24c.js","assets/preload-helper.1c052cf7.js","assets/Pagination.9d20b2d5.js"])),t=()=>null,o=t,a=t,s=t,r=Y(),{site:h,page:c,theme:m,frontmatter:g}=I(),S=v(()=>!!g.value.customLayout),A=v(()=>!!g.value.home),b=v(()=>Object.keys(h.value.langs).length>1),k=v(()=>{const T=m.value;return g.value.navbar===!1||T.navbar===!1?!1:h.value.title||T.logo||T.repo||T.nav}),R=q(!1),E=v(()=>g.value.home||g.value.sidebar===!1?!1:!Rt(vn(m.value.sidebar,r.data.relativePath))),sn=T=>{R.value=typeof T=="boolean"?T:!R.value},ve=sn.bind(null,!1);K(r,ve);const we=v(()=>[{"no-navbar":!k.value,"sidebar-open":R.value,"no-sidebar":!E.value}]);return(T,In)=>{const be=en("Content"),_e=en("Debug");return u(),d(x,null,[l("div",{class:M(["theme",i(we)])},[i(k)?(u(),H(po,{key:0,onToggle:sn},{search:D(()=>[C(T.$slots,"navbar-search",{},()=>[i(m).algolia?(u(),H(i(s),{key:0,options:i(m).algolia,multilang:i(b)},null,8,["options","multilang"])):f("",!0)])]),_:3})):f("",!0),w(Co,{open:R.value},{"sidebar-top":D(()=>[C(T.$slots,"sidebar-top")]),"sidebar-bottom":D(()=>[C(T.$slots,"sidebar-bottom")]),_:3},8,["open"]),l("div",{class:"sidebar-mask",onClick:In[0]||(In[0]=hr=>sn(!1))}),i(S)?(u(),H(be,{key:1})):i(A)?C(T.$slots,"home",{key:2},()=>[w(i(e),null,{hero:D(()=>[C(T.$slots,"home-hero")]),features:D(()=>[C(T.$slots,"home-features")]),footer:D(()=>[C(T.$slots,"home-footer")]),_:3})]):(u(),H(_a,{key:3},{top:D(()=>[C(T.$slots,"page-top-ads",{},()=>[i(m).carbonAds&&i(m).carbonAds.carbon?(u(),d("div",Sa,[(u(),H(i(o),{key:"carbon"+i(c).relativePath,code:i(m).carbonAds.carbon,placement:i(m).carbonAds.placement},null,8,["code","placement"]))])):f("",!0)]),C(T.$slots,"page-top")]),bottom:D(()=>[C(T.$slots,"page-bottom"),C(T.$slots,"page-bottom-ads",{},()=>[i(m).carbonAds&&i(m).carbonAds.custom?(u(),H(i(a),{key:"custom"+i(c).relativePath,code:i(m).carbonAds.custom,placement:i(m).carbonAds.placement},null,8,["code","placement"])):f("",!0)])]),_:3}))],2),w(_e)],64)}}}),Ia={class:"theme"},Ra=l("h1",null,"404",-1),Ta=["href"],xa=y({__name:"NotFound",setup(n){const{site:e}=I(),t=["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."];function o(){return t[Math.floor(Math.random()*t.length)]}return(a,s)=>(u(),d("div",Ia,[Ra,l("blockquote",null,p(o()),1),l("a",{href:i(e).base,"aria-label":"go to home"},"Take me home.",8,Ta)]))}}),Aa={Layout:ka,NotFound:xa};class Ca{constructor(){this.x=50,this.y=50,this.vx=Math.random()*2+2,this.vy=Math.random()*2,this.color="#fff",this.shadowBlur=Math.random()*3,this.shadowX=Math.random()*2-1,this.shadowY=Math.random()*2-1,this.radiusX=Math.random()*3,this.radiusY=Math.random()*3,this.rotation=Math.PI*Math.floor(Math.random()*2)}}class bn{constructor(e){this.width=300,this.height=300,this.dustQuantity=50,this.dustArr=[];const t=document.getElementById(e);if(t)this.canvas=t,this.ctx=t.getContext("2d"),this.build(),window.addEventListener("resize",()=>this.resize());else throw new Error("canvasID \u65E0\u6548")}build(){if(this.resize(),this.ctx){const e=bn.getPoint(this.dustQuantity);for(let t of e){const o=new Ca;this.buildDust(t[0],t[1],o),this.dustArr.push(o)}setInterval(()=>{this.play()},40)}}play(){var t;const e=this.dustArr;(t=this.ctx)==null||t.clearRect(0,0,this.width,this.height);for(let o of e)if(o.x<0||o.y<0){const a=this.width,s=Math.floor(Math.random()*window.innerHeight);o.x=a,o.y=s,this.buildDust(a,s,o)}else{const a=o.x-o.vx,s=o.y-o.vy;this.buildDust(a,s,o)}}buildDust(e,t,o){const a=this.ctx;e&&(o.x=e),t&&(o.y=t),a&&(a.beginPath(),a.shadowBlur=o.shadowBlur,a.shadowColor=o.color,a.shadowOffsetX=o.shadowX,a.shadowOffsetY=o.shadowY,a.ellipse(o.x,o.y,o.radiusX,o.radiusY,o.rotation,0,Math.PI*2),a.closePath(),a.fillStyle=o.color,a.fill())}resize(){const e=this.canvas,t=window.innerWidth,o=window.innerHeight;this.width=t,this.height=o,this.dustQuantity=Math.floor((t+o)/38),e!==void 0&&(e.width=t,e.height=o)}static getPoint(e=1){let t=[];for(let o=0;o<e;o++){const a=Math.floor(Math.random()*window.innerWidth),s=Math.floor(Math.random()*window.innerHeight);t.push([a,s])}return t}}const Ha=n=>{const e=localStorage.getItem(n);return e&&JSON.parse(e)},Yn=(n,e)=>{localStorage.setItem(n,JSON.stringify(e))};function $a(n){let e=n[0];for(let t=1;t<n.length;t++){const o=n[t];o.length>e.length&&(e=o)}return e}function ue(n,e){return Array.from(n).filter(a=>e.test(a.nodeName))}function ce(n,e){let t,o,a=0;return function(){t=this,o=arguments;let s=new Date().valueOf();s-a>e&&(n.apply(t,o),a=s)}}const qa=n=>{n.forEach(e=>{const t=new Image;t.src=e})};const La=y({__name:"BgToggle",props:{bgUrl:String},setup(n){const{theme:e}=I(),t=e.value.bgUrls,o=q(0),a=Le("setBg");an(()=>{a(t[o.value])}),Me(()=>{qa(t)}),P(()=>{s()});const s=()=>{const h=Ha("bgIdx");h==null?Yn("bgIdx",o.value):o.value=h},r=()=>{o.value>=t.length-1?o.value=0:o.value++,Yn("bgIdx",o.value)};return(h,c)=>(u(),d("i",{class:"fa fa-retweet bg-toggle",title:"toggle background",onClick:r}))}});var Ma=_(La,[["__scopeId","data-v-2dc83b4c"]]);const Pa=n=>(N("data-v-7d636702"),n=n(),W(),n),Ea={class:"menu-list"},Na=Pa(()=>l("a",{href:""},[l("i",{class:"fa fa-navicon"})],-1)),Wa=[Na],ja=["href"],Ba=["title"],Da=y({__name:"index",setup(n){const{theme:e,page:t}=I(),o=e.value.nav,a=q(!0),s=v(()=>`/${t.value.relativePath.split(".")[0]}`),r=()=>{a.value=!a.value};return(h,c)=>(u(),d("header",null,[l("nav",null,[l("ul",Ea,[l("li",{class:"nav-toggle",onClick:r},Wa),a.value?(u(!0),d(x,{key:0},$(i(o),m=>(u(),d("li",{class:M(m.link===i(s)?"active":"")},[(u(),d("a",{href:m.link,key:m.link},[l("i",{class:M(`fa fa-${m.icon}`),title:m.text},null,10,Ba)],8,ja))],2))),256)):f("",!0),l("li",null,[w(Ma)])])])]))}});var Fa=_(Da,[["__scopeId","data-v-7d636702"]]);const Ya={key:0,class:"social-links"},Oa=["href"],Ga=["title"],Ja=y({__name:"SocialLinks",setup(n){const{theme:e}=I();return(t,o)=>i(e).socialLinks.length?(u(),d("div",Ya,[(u(!0),d(x,null,$(i(e).socialLinks,a=>(u(),d("a",{key:a.link,href:a.link,target:"_blank"},[l("i",{class:M(`fa fa-${a.icon}`),title:a.text},null,10,Ga)],8,Oa))),128))])):f("",!0)}});var Va=_(Ja,[["__scopeId","data-v-1c971fe0"]]);const _n=n=>(N("data-v-1d916c1f"),n=n(),W(),n),za={key:0,class:"aside-wrapper"},Ua={href:"/",class:"logo"},Ka=["src"],Xa={class:"center dr"},Qa={href:"/"},Za={class:"total"},ns=["href"],es=_n(()=>l("span",{class:"total-title"},"Archives Total",-1)),ts={class:"total-number"},os={class:"total-tags"},as=_n(()=>l("span",{class:"total-title"},"Tags:",-1)),ss={class:"total-number"},is={class:"total-categories"},rs=_n(()=>l("span",{class:"total-title"},"Categories:",-1)),ls={class:"total-number"},us=y({__name:"index",setup(n){const{site:e,theme:t,frontmatter:o}=I(),a=e.value.title,s=t.value.logo,r=t.value.posts.length,h=Object.keys(t.value.tags).length,c=Object.keys(t.value.cats).length,m=v(()=>o.value.sidebar);return(g,S)=>i(m)?(u(),d("div",za,[l("aside",null,[l("div",null,[l("a",Ua,[l("img",{src:i(L)(i(s)),alt:"Logo"},null,8,Ka)]),l("h1",Xa,[l("a",Qa,"Dr."+p(i(a)),1)]),l("section",Za,[l("a",{class:"total-archives",href:i(L)("/pages/archives")},[es,l("span",ts,p(i(r)),1)],8,ns),l("div",os,[as,l("span",ss,p(i(h)),1)]),l("div",is,[rs,l("span",ls,p(i(c)),1)])]),w(Va)])])])):f("",!0)}});var cs=_(us,[["__scopeId","data-v-1d916c1f"]]);const hs={class:"message-wrapper"},ds=y({__name:"Message",props:{type:{type:String,required:!0},msg:{type:String,required:!0}},setup(n){return(e,t)=>(u(),d("div",hs,[l("span",null,p(n.msg.value),1)]))}});var ms=_(ds,[["__scopeId","data-v-716cb212"]]);const Q=B({type:"success",msg:""}),gs=(n=Q.type,e,t)=>{Q.type=n,Q.msg=e;const o=ne(ms,{...U(Q)}).mount(document.createElement("div"));document.body.appendChild(o.$el),setTimeout(()=>{document.body.removeChild(o.$el)},t)},he={success(n,e=1e3){gs("success",n,e)},install(n){n.config.globalProperties.message=he}};class ps{constructor(){this.codeEles=document.getElementsByTagName("pre"),Array.from(this.codeEles).forEach(async t=>{const o=document.createElement("i");o.setAttribute("class","btn-copy fa fa-clipboard"),t.appendChild(o),o.addEventListener("click",function(){const a=document.createElement("textarea"),s=o.previousElementSibling;a.value=s.innerText,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),he.success("Copied!")})})}}const fs=n=>(N("data-v-4e6f6b2a"),n=n(),W(),n),ys={class:"post-header"},vs={class:"title"},ws={class:"info"},bs={class:"item date",datetime:"2022-01-25T19:21:35.000Z"},_s=fs(()=>l("div",{class:"divider"},null,-1)),Ss=y({__name:"PostHeader",setup(n){const{frontmatter:e}=I();let t=v(()=>e.value.title),o=v(()=>{const a=e.value.date;return(a?new Date(a).toJSON().split("T")[0]:"").split("-")});return(a,s)=>(u(),d("div",ys,[l("h1",vs,p(i(t)),1),l("div",ws,[l("span",bs,p(i(o)[2])+" / "+p(i(o)[1])+" / "+p(i(o)[0]),1)]),_s]))}});var ks=_(Ss,[["__scopeId","data-v-4e6f6b2a"]]);const Sn=n=>(N("data-v-f9cae6c6"),n=n(),W(),n),Is={class:"post-footer"},Rs=Sn(()=>l("span",null,"\u672C\u6587\u4F5C\u8005\uFF1A",-1)),Ts=["href"],xs=Sn(()=>l("span",null,"\u672C\u6587\u94FE\u63A5\uFF1A",-1)),As=["href"],Cs=Sn(()=>l("li",null,[l("span",null,"\u7248\u6743\u58F0\u660E\uFF1A"),j(" \u672C\u535A\u5BA2\u6240\u6709\u6587\u7AE0\u9664\u7279\u522B\u58F0\u660E\u5916\uFF0C\u5747\u91C7\u7528 "),l("a",{href:"https://creativecommons.org/licenses/by-nc-sa/4.0/",target:"_blank"},"CC BY-NC-SA 4.0"),j(" \u8BB8\u53EF\u534F\u8BAE\uFF0C\u8F6C\u8F7D\u8BF7\u6CE8\u660E\u51FA\u5904\u3002 ")],-1)),Hs=y({__name:"PostFooter",setup(n){const{page:e,site:t,frontmatter:o}=I();let a=v(()=>{const s=`${e.value.relativePath.split(".")[0]}.html`;return`${t.value.themeConfig.website}/${s}`});return v(()=>o.value.postFooter),(s,r)=>(u(),d("div",Is,[l("ul",null,[l("li",null,[Rs,l("a",{href:i(t).themeConfig.website,target:"_blank"},p(i(t).title),9,Ts)]),l("li",null,[xs,l("a",{href:i(a),target:"_blank"},p(i(a)),9,As)]),Cs])]))}});var $s=_(Hs,[["__scopeId","data-v-f9cae6c6"]]);const de=n=>(N("data-v-22a9c1c0"),n=n(),W(),n),qs={class:"prev-next"},Ls=de(()=>l("hr",null,null,-1)),Ms=["href"],Ps={key:1},Es=["href"],Ns={key:1},Ws=de(()=>l("hr",null,null,-1)),js=y({__name:"PrevNext",setup(n){const{theme:e,page:t}=I(),o=v(()=>e.value.posts),a=v(()=>t.value.frontmatter.title);let s=B({regularPath:"",frontMatter:{title:""}}),r=B({regularPath:"",frontMatter:{title:""}});const h=(c,m)=>{m?(c.regularPath=m.regularPath,c.frontMatter.title=m.frontMatter.title):(c.regularPath="",c.frontMatter.title="")};return an(()=>{const c=o.value.findIndex(m=>m.frontMatter.title===a.value);if(c>-1){const m=o.value[c-1],g=o.value[c+1];h(s,m),h(r,g)}}),(c,m)=>{var g,S,A,b,k,R;return u(),d("div",qs,[Ls,l("div",null,[hn(l("a",{class:"prev",href:i(L)((g=i(s))==null?void 0:g.regularPath)},[i(e).docFooter.prev.icon?(u(),d("i",{key:0,class:M(`fa fa-${i(e).docFooter.prev.icon}`)},null,2)):f("",!0),i(e).docFooter.prev.text?(u(),d("span",Ps,p(i(e).docFooter.prev.text),1)):f("",!0),j(" "+p((A=(S=i(s))==null?void 0:S.frontMatter)==null?void 0:A.title),1)],8,Ms),[[Mn,i(s).regularPath]]),hn(l("a",{class:"next",href:i(L)((b=i(r))==null?void 0:b.regularPath)},[j(p((R=(k=i(r))==null?void 0:k.frontMatter)==null?void 0:R.title)+" ",1),i(e).docFooter.next.icon?(u(),d("i",{key:0,class:M(`fa fa-${i(e).docFooter.next.icon}`)},null,2)):f("",!0),i(e).docFooter.next.text?(u(),d("span",Ns,p(i(e).docFooter.next.text),1)):f("",!0)],8,Es),[[Mn,i(r).regularPath]])]),Ws])}}});var Bs=_(js,[["__scopeId","data-v-22a9c1c0"]]);const me=n=>(N("data-v-413ae51b"),n=n(),W(),n),Ds=me(()=>l("i",{class:"fa fa-caret-up"},null,-1)),Fs=me(()=>l("p",null,"TOP",-1)),Ys=[Ds,Fs],Os=y({__name:"BackTop",setup(n){const e=q(0),t=v(()=>e.value>300?"block":"none");P(()=>{window.addEventListener("scroll",a)}),X(()=>{window.removeEventListener("scroll",a)});const o=()=>{e.value=document.documentElement.scrollTop},a=ce.bind(this,o,1e3)(),s=()=>{const r=document.documentElement.scrollTop/6,h=setInterval(()=>{document.documentElement.scrollTop=document.documentElement.scrollTop-r,e.value=document.documentElement.scrollTop,e.value<=0&&clearInterval(h)},50)};return(r,h)=>(u(),d("div",{class:"back-top",style:Kn({display:i(t)}),onClick:s},Ys,4))}});var Gs=_(Os,[["__scopeId","data-v-413ae51b"]]);function Js(n="2022-01-01"){const e=new Date(n),t=new Date().getTime()-e.getTime(),o=24*60*60*1e3,a=t/o,s=Math.floor(a),r=(a-s)*24,h=Math.floor(r),c=(r-h)*60,m=Math.floor(c),g=(c-m)*60,S=Math.floor(g);return{day:s,hour:h,minute:m,second:S}}const Vs=()=>{const n=document.title;document.addEventListener("visibilitychange",function(){document.hidden?document.title="zzZZZ...":document.title=n})};const kn=n=>(N("data-v-514ed06b"),n=n(),W(),n),zs=kn(()=>l("i",{class:"fa fa-heartbeat mr4"},null,-1)),Us=Pe('<p data-v-514ed06b> Published With <a href="https://vitejs.cn/vitepress/" target="_blank" data-v-514ed06b>VitePress</a> &amp; <a href="https://github.com/Yue-plus/hexo-theme-arknights" target="_blank" class="mr4" data-v-514ed06b>Arknights</a><a href="https://travellings.link/" target="_blank" data-v-514ed06b><i class="fa fa-paper-plane-o" title="Travellings" data-v-514ed06b></i></a></p><p data-v-514ed06b> Mirror Hosting <a href="https://wonderven.netlify.app/" target="_blank" data-v-514ed06b>Netlify</a></p>',2),Ks=kn(()=>l("div",null,[l("span",null,"\xA9"),l("span",null,"2021 to 2022")],-1)),Xs=kn(()=>l("div",null,[l("span",null,"ICP"),l("span",null,"\u2014 RHODEISLAND \u2014")],-1)),Qs=y({__name:"Footer",setup(n){const{theme:e}=I(),t=q();let o=B({day:0,hour:0,minute:0,second:0}),a=null;P(()=>{e.value.footer.runtime.enable&&(a=setInterval(s,1e3))}),X(()=>{a&&clearInterval(a)});const s=()=>{const r=Js();o.day=r.day,o.hour=r.hour,o.minute=r.minute,o.second=r.second};return(r,h)=>(u(),d("footer",null,[i(e).footer.runtime.enable?(u(),d("p",{key:0,ref_key:"runtimeRef",ref:t},[zs,j(" "+p(i(o).day)+" days "+p(i(o).hour)+" hours "+p(i(o).minute)+" minutes and "+p(i(o).second)+" seconds ",1)],512)):f("",!0),Us,i(e).footer.copyright?(u(),d(x,{key:1},[Ks,Xs],64)):f("",!0)]))}});var Zs=_(Qs,[["__scopeId","data-v-514ed06b"]]);const ge=/^H[1-6]{1,}$/,ni=n=>{const e=n.childNodes,t=ue(e,ge);return ei(t)};function ei(n){const e=[];for(let t=0;t<n.length;t++){const o=n[t],a=/^(_\d{1,})+(-\d{1,})*/ig,s=o.id.match(a)[0];e.push({nodeName:o.nodeName,text:o.innerText.slice(0,o.innerText.length-1),id:o.id,level:s})}return ti(e)}function ti(n){const e=[],t={};n.forEach(o=>{t[o.level]=o});for(const o in t)if(Object.prototype.hasOwnProperty.call(t,o)){const a=t[o];if(/^(_\d{1,})+$/ig.test(o))e.push(a);else{const h=Object.keys(t).filter(m=>m!==o&&o.includes(m)),c=$a(h);t[c].child?t[c].child.push(a):t[c].child=[a]}}return e}const oi=["href","name","title","onClick"],ai=y({__name:"CataList",props:{tree:Array},setup(n){const e=t=>{t.open=!t.open,t.active=!0};return(t,o)=>(u(),d("ul",null,[(u(!0),d(x,null,$(n.tree,a=>{var s;return u(),d("li",{key:a.id},[l("a",{href:`#${a.id}`,name:a.id,title:a.text,class:M([[a.nodeName,a.active?"active":""],"link"]),onClick:r=>e(a)},p(a.text),11,oi),((s=a.child)==null?void 0:s.length)&&a.open?(u(),H(pe,{key:0,tree:a.child},null,8,["tree"])):f("",!0)])}),128))]))}});var pe=_(ai,[["__scopeId","data-v-33c6374d"]]);const si={key:0,class:"catalog"},ii=y({__name:"index",setup(n){const{frontmatter:e}=I(),t=q(0),o=q(0),a=B({data:[]}),s=B({titleNodes:[],titleMargins:[]});K(e,(b,k)=>{r()},{deep:!0}),P(()=>{r(),window.addEventListener("scroll",c)}),X(()=>{window.removeEventListener("scroll",c)});const r=()=>{var R;const b=(R=document.getElementById("content"))==null?void 0:R.childNodes[0],k=ni(b);a.data=k,o.value=b.getBoundingClientRect().top,g(b)},h=()=>{t.value=document.documentElement.scrollTop,m()},c=ce.bind(this,h,50)(),m=()=>{const b=s.titleMargins;for(let k=0;k<b.length;k++){const R=b[k];if(R.top-t.value>=o.value){A(a.data),S(a.data,R.id);return}}},g=b=>{const k=b.childNodes;s.titleNodes=ue(k,ge);const R=s.titleNodes.map(E=>({id:E.id,top:E.getBoundingClientRect().top}));s.titleMargins=R,m()},S=(b,k)=>{for(let R=0;R<b.length;R++){const E=b[R];if(E.id===k){E.active=!0,E.open=!0;return}E.child&&S(E.child,k)}},A=b=>{for(let k=0;k<b.length;k++){const R=b[k];R.active&&(R.active=!1),R.child&&A(R.child)}};return(b,k)=>a.data.length?(u(),d("div",si,[w(pe,{tree:a.data},null,8,["tree"])])):f("",!0)}});var ri=_(ii,[["__scopeId","data-v-32f802b6"]]);const li={key:1,class:"post-des"},ui=["innerHTML"],ci=["innerHTML"],hi={key:0,class:"post-tag"},di=l("i",{class:"fa fa-tags"},null,-1),mi=["href"],gi=y({__name:"index",setup(n){const{frontmatter:e}=I(),t=v(()=>e.value.page),o=v(()=>e.value.tags||[]);P(()=>{a()}),Un(()=>{a()});const a=()=>{t.value||new ps};return(s,r)=>{const h=en("Content");return u(),d("div",{class:M(["content",i(t)?"":"post-content"]),id:"postContent"},[i(t)?f("",!0):(u(),H(ks,{key:0})),i(t)?f("",!0):(u(),d("div",li,[typeof i(e).description=="string"?(u(),d("p",{key:0,innerHTML:i(e).description},null,8,ui)):(u(!0),d(x,{key:1},$(i(e).description,c=>(u(),d("p",{key:c,innerHTML:c},null,8,ci))),128))])),w(h,{id:"content"}),i(t)?f("",!0):(u(),d(x,{key:2},[i(o).length?(u(),d("p",hi,[di,(u(!0),d(x,null,$(i(o),c=>(u(),d("a",{key:c,href:`/pages/archives#tag=${c}`},p(c),9,mi))),128))])):f("",!0),w($s),w(Bs),w(Gs),w(ri)],64)),w(Zs)],2)}}}),pi=()=>G("script",{src:"https://cdn.jsdelivr.net/gh/stevenjoezhang/live2d-widget/autoload.js"});const fi={ref:"canvasRef",id:"canvas-dust",width:"1036",height:"228"},yi=y({__name:"App",setup(n){const{theme:e}=I(),t=q("111111111111");return Ee("setBg",o=>{t.value=o}),P(()=>{new bn("canvas-dust")}),(o,a)=>(u(),d(x,null,[l("main",{class:"layout",style:Kn({"background-image":`url(${t.value})`})},[w(cs,{class:"aside"}),w(gi,{class:"content"}),w(Fa,{class:"navbar"})],4),i(e).live2d?(u(),H(i(pi),{key:0,class:"l2d-model"})):f("",!0),l("canvas",fi,null,512)],64))}});var vi=_(yi,[["__scopeId","data-v-52e49cdc"]]);const wi=["href"],bi={class:"post-info"},_i={class:"post-info-categories"},Si=["href"],ki={key:1,href:"#"},Ii={class:"post-info-tags"},Ri=["href"],Ti={key:1,href:"#"},xi={datetime:"2022-01-25T19:21:35.000Z"},Ai=["innerHTML"],Ci={class:"post-excerpt"},Hi=["innerHTML"],$i=["innerHTML"],qi=l("span",{class:"post-btn"},"READ MORE +",-1),Li=y({__name:"PostItem",props:{article:{type:Object,required:!0}},setup(n){return(e,t)=>(u(),d("a",{href:i(L)(n.article.regularPath),class:"post-item"},[l("div",bi,[l("div",null,[l("span",_i,[n.article.frontMatter.category&&n.article.frontMatter.category.length?(u(!0),d(x,{key:0},$(n.article.frontMatter.category,o=>(u(),d("a",{key:o,href:i(L)(`/pages/archives#category=${o}`)},p(o),9,Si))),128)):(u(),d("a",ki,"Empty"))]),l("span",Ii,[n.article.frontMatter.tags&&n.article.frontMatter.tags.length?(u(!0),d(x,{key:0},$(n.article.frontMatter.tags,o=>(u(),d("a",{key:o,href:i(L)(`/pages/archives#tag=${o}`)},p(o),9,Ri))),128)):(u(),d("a",Ti," Empty "))])]),l("time",xi,p(n.article.frontMatter.dateArr[2])+" / "+p(n.article.frontMatter.dateArr[1])+" / "+p(n.article.frontMatter.dateArr[0]),1)]),l("h1",{class:"post-title",innerHTML:n.article.frontMatter.title},null,8,Ai),l("div",Ci,[typeof n.article.frontMatter.description=="string"?(u(),d("p",{key:0,innerHTML:n.article.frontMatter.description},null,8,Hi)):(u(!0),d(x,{key:1},$(n.article.frontMatter.description,o=>(u(),d("p",{key:o,innerHTML:o},null,8,$i))),128))]),qi],8,wi))}});var Mi=[{title:"VitePress \u521B\u5EFA\u6587\u7AE0\u76EE\u5F55",content:`1. \u73AF\u5883
VitePress(Vue3 + TS)
2. \u601D\u8DEF
...
`,excerpt:"",url:"/posts\\Vue\\v3-model"}];const Pi={class:"input-group"},Ei=l("i",{class:"fa fa-search"},null,-1),Ni={class:"result"},Wi=["href"],ji=["innerHTML"],Bi=["innerHTML"],Di={key:0,class:"empty"},Fi=l("i",{class:"fa fa-meh-o"},null,-1),Yi=j(" No Data "),Oi=[Fi,Yi],Gi=y({__name:"Search",setup(n){const{theme:e}=I(),t=q("");let o=B([]);const a=v(()=>!!(o.length||t.value));an(()=>{s(t.value)});function s(c){o.length=0,c.trim()!==""&&Mi.forEach(m=>{const g=JSON.parse(JSON.stringify(m)),S=new RegExp(c,"ig"),A=g.title.match(S),b=g.content.match(S);A&&(g.title=r(c,g.title)),b&&(g.content=r(c,g.content)),(A||b)&&o.push(g)})}const r=(c,m)=>{const g=new RegExp(c,"ig");return m.replace(g,`<span class="search-highlight">${c}</span>`)},h=()=>{t.value=""};return(c,m)=>i(e).search?(u(),d("div",{key:0,class:M(["search-wrapper",i(a)?"open":""])},[l("div",Pi,[Ei,hn(l("input",{type:"text",placeholder:"Search","onUpdate:modelValue":m[0]||(m[0]=g=>t.value=g)},null,512),[[ht,t.value]]),t.value?(u(),d("i",{key:0,class:"fa fa-trash",onClick:h})):f("",!0)]),l("ul",Ni,[(u(!0),d(x,null,$(i(o),g=>(u(),d("li",{key:g.title},[l("a",{href:g.url,onClick:h},[l("p",{innerHTML:g.title,class:"title"},null,8,ji),l("p",{innerHTML:g.content,class:"content"},null,8,Bi)],8,Wi)]))),128)),!i(o).length&&t.value!==""?(u(),d("li",Di,Oi)):f("",!0)])],2)):f("",!0)}}),Ji=y({__name:"PostList",props:{posts:Array},setup(n){const e=q("");return(t,o)=>(u(),d(x,null,[w(Gi,{filterKey:e.value,"onUpdate:filterKey":o[0]||(o[0]=a=>e.value=a)},null,8,["filterKey"]),l("div",null,[(u(!0),d(x,null,$(n.posts,(a,s)=>(u(),H(Li,{key:s,article:a},null,8,["article"]))),128))])],64))}}),Vi=y({__name:"index",props:{posts:{type:Array,required:!0},pageNum:{type:Number,default:1},pageSize:{type:Number,default:10}},setup(n){const e=n,{theme:t}=I(),o=We();let a=B([]);a=v(()=>{var h;return(((h=U(e).posts)==null?void 0:h.value)||[]).map(c=>{const m=JSON.parse(JSON.stringify(c)),g=m.frontMatter.date;return m.frontMatter.dateArr=g.split("-"),m})}),P(()=>{Vs()});const s=r=>{const h=L(r===1?"/index.html":`/page_${r}.html`);o.go(h)};return(r,h)=>(u(),d(x,null,[w(Ji,{posts:i(a)},null,8,["posts"]),w(Ge,{pageSize:n.pageSize,pageNum:n.pageNum,total:i(t).posts.length,onPagination:s},null,8,["pageSize","pageNum","total"])],64))}});const zi=n=>(N("data-v-072447f6"),n=n(),W(),n),Ui={class:"loading"},Ki={class:"loading-svg hover",width:"100",height:"100",viewBox:"0 0 40 60"},Xi=zi(()=>l("polygon",{class:"triangulo",fill:"none",stroke:"#fff","stroke-width":"1",points:"16,1 32,32 1,32"},null,-1)),Qi={class:"text",x:"0",y:"45",fill:"#fff"},Zi=y({__name:"Loading",props:{msg:{type:String,required:!0}},setup(n){return(e,t)=>(u(),d("div",Ui,[(u(),d("svg",Ki,[Xi,l("text",Qi,p(n.msg.value),1)]))]))}});var nr=_(Zi,[["__scopeId","data-v-072447f6"]]);const ln=B({msg:"Loading..."});let un;const fe={show(n=ln.msg){ln.msg=n,un=ne(nr,{...U(ln)}).mount(document.createElement("div")).$el,document.body.appendChild(un)},hide(){document.body.removeChild(un)},install(n){n.config.globalProperties.loading=fe}};var on={...Aa,Layout:vi,async enhanceApp({app:n,router:e,siteData:t}){n.component("Page",Vi),n.use(fe)}};const cn=new Set,ye=()=>document.createElement("link"),er=n=>{const e=ye();e.rel="prefetch",e.href=n,document.head.appendChild(e)},tr=n=>{const e=new XMLHttpRequest;e.open("GET",n,e.withCredentials=!0),e.send()};let Z;const or=J&&(Z=ye())&&Z.relList&&Z.relList.supports&&Z.relList.supports("prefetch")?er:tr;function ar(){if(!J||!window.IntersectionObserver)return;let n;if((n=navigator.connection)&&(n.saveData||/2g/.test(n.effectiveType)))return;const e=window.requestIdleCallback||setTimeout;let t=null;const o=()=>{t&&t.disconnect(),t=new IntersectionObserver(s=>{s.forEach(r=>{if(r.isIntersecting){const h=r.target;t.unobserve(h);const{pathname:c}=h;if(!cn.has(c)){cn.add(c);const m=Xn(c);or(m)}}})}),e(()=>{document.querySelectorAll("#app a").forEach(s=>{const{target:r,hostname:h,pathname:c}=s,m=c.match(/\.\w+$/);m&&m[0]!==".html"||r!=="_blank"&&h===location.hostname&&(c!==location.pathname?t.observe(s):cn.add(c))})})};P(o);const a=Y();K(()=>a.path,o),X(()=>{t&&t.disconnect()})}const sr=y({setup(n,{slots:e}){const t=q(!1);return P(()=>{t.value=!0}),()=>t.value&&e.default?e.default():null}}),ir=on.NotFound||(()=>"404 Not Found"),rr={name:"VitePressApp",setup(){const{site:n}=I();return P(()=>{K(()=>n.value.lang,e=>{document.documentElement.lang=e},{immediate:!0})}),ar(),()=>G(on.Layout)}};function lr(){const n=cr(),e=ur();e.provide(Be,n);const t=De(n.route);return e.provide(Fe,t),J&&pt(n.route,t.site),e.component("Content",Ye),e.component("ClientOnly",sr),e.component("Debug",()=>null),Object.defineProperty(e.config.globalProperties,"$frontmatter",{get(){return t.frontmatter.value}}),on.enhanceApp&&on.enhanceApp({app:e,router:n,siteData:Oe}),{app:e,router:n}}function ur(){return gt(rr)}function cr(){let n=J,e;return je(t=>{let o=Xn(t);return n&&(e=o),(n||e===o)&&(o=o.replace(/\.js$/,".lean.js")),J?(n=!1,On(()=>import(o),[])):require(o)},ir)}if(J){const{app:n,router:e}=lr();e.go().then(()=>{n.mount("#app")})}export{jn as N,lr as createApp};
