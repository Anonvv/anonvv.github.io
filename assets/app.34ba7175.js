import{_ as On}from"./preload-helper.1c052cf7.js";import{i as nn,c as Se,a as ke,b as Gn,d as pn,e as Ie,t as Rn,f as Re,g as Te,h as xe,j as Jn,k as Ae,l as Ce,m as $e,n as Vn,o as He,w as an,p as y,q as u,r as h,u as i,s as f,v as j,x as p,y as v,z as r,A as U,B as $,C as zn,D as E,E as W,F as L,G as K,H as M,I as T,J as H,K as w,L as C,M as P,N as Un,O as X,P as G,Q as en,R as qe,S as D,T as Le,U as Me,V as B,W as hn,X as Kn,Y as Pe,Z as Ne}from"./framework.3a6555e1.js";import{u as R,w as q,a as Y,E as Ee,i as J,p as Xn,c as We,R as je,b as Be,d as De,C as Fe,s as Ye}from"./Debug.vue_vue_type_style_index_0_scoped_true_lang.0bf38ae3.js";import{_}from"./plugin-vue_export-helper.21dcd24c.js";const Oe="http://www.w3.org/2000/svg",F=typeof document!="undefined"?document:null,Tn=F&&F.createElement("template"),Ge={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,o)=>{const a=e?F.createElementNS(Oe,n):F.createElement(n,t?{is:t}:void 0);return n==="select"&&o&&o.multiple!=null&&a.setAttribute("multiple",o.multiple),a},createText:n=>F.createTextNode(n),createComment:n=>F.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>F.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},cloneNode(n){const e=n.cloneNode(!0);return"_value"in n&&(e._value=n._value),e},insertStaticContent(n,e,t,o,a,s){const l=t?t.previousSibling:e.lastChild;if(a&&(a===s||a.nextSibling))for(;e.insertBefore(a.cloneNode(!0),t),!(a===s||!(a=a.nextSibling)););else{Tn.innerHTML=o?`<svg>${n}</svg>`:n;const d=Tn.content;if(o){const c=d.firstChild;for(;c.firstChild;)d.appendChild(c.firstChild);d.removeChild(c)}e.insertBefore(d,t)}return[l?l.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}};function Je(n,e,t){const o=n._vtc;o&&(e=(e?[e,...o]:[...o]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}function Ve(n,e,t){const o=n.style,a=nn(t);if(t&&!a){for(const s in t)dn(o,s,t[s]);if(e&&!nn(e))for(const s in e)t[s]==null&&dn(o,s,"")}else{const s=o.display;a?e!==t&&(o.cssText=t):e&&n.removeAttribute("style"),"_vod"in n&&(o.display=s)}}const xn=/\s*!important$/;function dn(n,e,t){if(pn(t))t.forEach(o=>dn(n,e,o));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const o=ze(n,e);xn.test(t)?n.setProperty(Jn(o),t.replace(xn,""),"important"):n[o]=t}}const An=["Webkit","Moz","ms"],rn={};function ze(n,e){const t=rn[e];if(t)return t;let o=Ae(e);if(o!=="filter"&&o in n)return rn[e]=o;o=Ce(o);for(let a=0;a<An.length;a++){const s=An[a]+o;if(s in n)return rn[e]=s}return e}const Cn="http://www.w3.org/1999/xlink";function Ue(n,e,t,o,a){if(o&&e.startsWith("xlink:"))t==null?n.removeAttributeNS(Cn,e.slice(6,e.length)):n.setAttributeNS(Cn,e,t);else{const s=$e(e);t==null||s&&!Vn(t)?n.removeAttribute(e):n.setAttribute(e,s?"":t)}}function Ke(n,e,t,o,a,s,l){if(e==="innerHTML"||e==="textContent"){o&&l(o,a,s),n[e]=t==null?"":t;return}if(e==="value"&&n.tagName!=="PROGRESS"&&!n.tagName.includes("-")){n._value=t;const c=t==null?"":t;(n.value!==c||n.tagName==="OPTION")&&(n.value=c),t==null&&n.removeAttribute(e);return}let d=!1;if(t===""||t==null){const c=typeof n[e];c==="boolean"?t=Vn(t):t==null&&c==="string"?(t="",d=!0):c==="number"&&(t=0,d=!0)}try{n[e]=t}catch{}d&&n.removeAttribute(e)}const[Qn,Xe]=(()=>{let n=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(n=performance.now.bind(performance));const t=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(t&&Number(t[1])<=53)}return[n,e]})();let mn=0;const Qe=Promise.resolve(),Ze=()=>{mn=0},nt=()=>mn||(Qe.then(Ze),mn=Qn());function O(n,e,t,o){n.addEventListener(e,t,o)}function et(n,e,t,o){n.removeEventListener(e,t,o)}function tt(n,e,t,o,a=null){const s=n._vei||(n._vei={}),l=s[e];if(o&&l)l.value=o;else{const[d,c]=ot(e);if(o){const m=s[e]=at(o,a);O(n,d,m,c)}else l&&(et(n,d,l,c),s[e]=void 0)}}const $n=/(?:Once|Passive|Capture)$/;function ot(n){let e;if($n.test(n)){e={};let o;for(;o=n.match($n);)n=n.slice(0,n.length-o[0].length),e[o[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Jn(n.slice(2)),e]}function at(n,e){const t=o=>{const a=o.timeStamp||Qn();(Xe||a>=t.attached-1)&&He(st(o,t.value),e,5,[o])};return t.value=n,t.attached=nt(),t}function st(n,e){if(pn(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(o=>a=>!a._stopped&&o&&o(a))}else return e}const Hn=/^on[a-z]/,it=(n,e,t,o,a=!1,s,l,d,c)=>{e==="class"?Je(n,o,a):e==="style"?Ve(n,t,o):Te(e)?xe(e)||tt(n,e,t,o,l):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):rt(n,e,o,a))?Ke(n,e,o,s,l,d,c):(e==="true-value"?n._trueValue=o:e==="false-value"&&(n._falseValue=o),Ue(n,e,o,a))};function rt(n,e,t,o){return o?!!(e==="innerHTML"||e==="textContent"||e in n&&Hn.test(e)&&Gn(t)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA"||Hn.test(e)&&nn(t)?!1:e in n}const qn=n=>{const e=n.props["onUpdate:modelValue"]||!1;return pn(e)?t=>Ie(e,t):e};function lt(n){n.target.composing=!0}function Ln(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ut={created(n,{modifiers:{lazy:e,trim:t,number:o}},a){n._assign=qn(a);const s=o||a.props&&a.props.type==="number";O(n,e?"change":"input",l=>{if(l.target.composing)return;let d=n.value;t&&(d=d.trim()),s&&(d=Rn(d)),n._assign(d)}),t&&O(n,"change",()=>{n.value=n.value.trim()}),e||(O(n,"compositionstart",lt),O(n,"compositionend",Ln),O(n,"change",Ln))},mounted(n,{value:e}){n.value=e==null?"":e},beforeUpdate(n,{value:e,modifiers:{lazy:t,trim:o,number:a}},s){if(n._assign=qn(s),n.composing||document.activeElement===n&&n.type!=="range"&&(t||o&&n.value.trim()===e||(a||n.type==="number")&&Rn(n.value)===e))return;const l=e==null?"":e;n.value!==l&&(n.value=l)}},Mn={beforeMount(n,{value:e},{transition:t}){n._vod=n.style.display==="none"?"":n.style.display,t&&e?t.beforeEnter(n):V(n,e)},mounted(n,{value:e},{transition:t}){t&&e&&t.enter(n)},updated(n,{value:e,oldValue:t},{transition:o}){!e!=!t&&(o?e?(o.beforeEnter(n),V(n,!0),o.enter(n)):o.leave(n,()=>{V(n,!1)}):V(n,e))},beforeUnmount(n,{value:e}){V(n,e)}};function V(n,e){n.style.display=e?n._vod:"none"}const Zn=Re({patchProp:it},Ge);let z,Pn=!1;function ct(){return z||(z=ke(Zn))}function ht(){return z=Pn?z:Se(Zn),Pn=!0,z}const ne=(...n)=>{const e=ct().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(!a)return;const s=e._component;!Gn(s)&&!s.render&&!s.template&&(s.template=a.innerHTML),a.innerHTML="";const l=t(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),l},e},dt=(...n)=>{const e=ht().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(a)return t(a,!0,a instanceof SVGElement)},e};function ee(n){return nn(n)?document.querySelector(n):n}function mt(n,e){let t=[],o=!0;const a=s=>{if(o){o=!1;return}const l=[],d=Math.min(t.length,s.length);for(let c=0;c<d;c++){let m=t[c];const[g,S,A=""]=s[c];if(m.tagName.toLocaleLowerCase()===g){for(const b in S)m.getAttribute(b)!==S[b]&&m.setAttribute(b,S[b]);for(let b=0;b<m.attributes.length;b++){const k=m.attributes[b].name;k in S||m.removeAttribute(k)}m.innerHTML!==A&&(m.innerHTML=A)}else document.head.removeChild(m),m=Nn(s[c]),document.head.append(m);l.push(m)}t.slice(d).forEach(c=>document.head.removeChild(c)),s.slice(d).forEach(c=>{const m=Nn(c);document.head.appendChild(m),l.push(m)}),t=l};an(()=>{const s=n.data,l=e.value,d=s&&s.title,c=s&&s.description,m=s&&s.frontmatter.head;document.title=(d?d+" | ":"")+l.title,document.querySelector("meta[name=description]").setAttribute("content",c||l.description),a([...m?pt(m):[]])})}function Nn([n,e,t]){const o=document.createElement(n);for(const a in e)o.setAttribute(a,e[a]);return t&&(o.innerHTML=t),o}function gt(n){return n[0]==="meta"&&n[1]&&n[1].name==="description"}function pt(n){return n.filter(e=>!gt(e))}const ft=/#.*$/,yt=/(index)?\.(md|html)$/,tn=/\/$/,vt=/^[a-z]+:/i;function fn(n){return Array.isArray(n)}function yn(n){return vt.test(n)}function wt(n,e){if(e===void 0)return!1;const t=En(`/${n.data.relativePath}`),o=En(e);return t===o}function En(n){return decodeURI(n).replace(ft,"").replace(yt,"")}function bt(n,e){const t=n.endsWith("/"),o=e.startsWith("/");return t&&o?n.slice(0,-1)+e:!t&&!o?`${n}/${e}`:n+e}function gn(n){return/^\//.test(n)?n:`/${n}`}function te(n){return n.replace(/(index)?(\.(md|html))?$/,"")||"/"}function _t(n){return n===!1||n==="auto"||fn(n)}function St(n){return n.children!==void 0}function kt(n){return fn(n)?n.length===0:!n}function vn(n,e){if(_t(n))return n;e=gn(e);for(const t in n)if(e.startsWith(gn(t)))return n[t];return"auto"}function oe(n){return n.reduce((e,t)=>(t.link&&e.push({text:t.text,link:te(t.link)}),St(t)&&(e=[...e,...oe(t.children)]),e),[])}const It=["href","aria-label"],Rt=["src"],Tt=y({__name:"NavBarTitle",setup(n){const{site:e,theme:t,localePath:o}=R();return(a,s)=>(u(),h("a",{class:"nav-bar-title",href:i(o),"aria-label":`${i(e).title}, back to home`},[i(t).logo?(u(),h("img",{key:0,class:"logo",src:i(q)(i(t).logo),alt:"Logo"},null,8,Rt)):f("",!0),j(" "+p(i(e).title),1)],8,It))}});var xt=_(Tt,[["__scopeId","data-v-7ac13a1e"]]);function At(){const{site:n,localePath:e,theme:t}=R();return v(()=>{const o=n.value.langs,a=Object.keys(o);if(a.length<2)return null;const l=Y().path.replace(e.value,""),d=a.map(m=>({text:o[m].label,link:`${m}${l}`}));return{text:t.value.selectText||"Languages",items:d}})}const Ct=["GitHub","GitLab","Bitbucket"].map(n=>[n,new RegExp(n,"i")]);function $t(){const{site:n}=R();return v(()=>{const e=n.value.themeConfig,t=e.docsRepo||e.repo;if(!t)return null;const o=Ht(t);return{text:qt(o,e.repoLabel),link:o}})}function Ht(n){return Ee.test(n)?n:`https://github.com/${n}`}function qt(n,e){if(e)return e;const t=n.match(/^https?:\/\/[^/]+/);if(!t)return"Source";const o=Ct.find(([a,s])=>s.test(t[0]));return o&&o[0]?o[0]:"Source"}function ae(n){const e=Y(),t=yn(n.value.link);return{props:v(()=>{const a=Wn(`/${e.data.relativePath}`);let s=!1;if(n.value.activeMatch)s=new RegExp(n.value.activeMatch).test(a);else{const l=Wn(n.value.link);s=l==="/"?l===a:a.startsWith(l)}return{class:{active:s,isExternal:t},href:t?n.value.link:q(n.value.link),target:n.value.target||(t?"_blank":null),rel:n.value.rel||(t?"noopener noreferrer":null),"aria-label":n.value.ariaLabel}}),isExternal:t}}function Wn(n){return n.replace(/#.*$/,"").replace(/\?.*$/,"").replace(/\.(html|md)$/,"").replace(/\/index$/,"/")}const Lt={},Mt={class:"icon outbound",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",x:"0px",y:"0px",viewBox:"0 0 100 100",width:"15",height:"15"},Pt=r("path",{fill:"currentColor",d:"M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"},null,-1),Nt=r("polygon",{fill:"currentColor",points:"45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"},null,-1),Et=[Pt,Nt];function Wt(n,e){return u(),h("svg",Mt,Et)}var wn=_(Lt,[["render",Wt]]);const jt={class:"nav-link"},Bt=y({__name:"NavLink",props:{item:null},setup(n){const t=U(n),{props:o,isExternal:a}=ae(t.item);return(s,l)=>(u(),h("div",jt,[r("a",zn({class:"item"},i(o)),[j(p(n.item.text)+" ",1),i(a)?(u(),$(wn,{key:0})):f("",!0)],16)]))}});var jn=_(Bt,[["__scopeId","data-v-49fe041d"]]);const Dt=n=>(E("data-v-07381bdb"),n=n(),W(),n),Ft={class:"nav-dropdown-link-item"},Yt=Dt(()=>r("span",{class:"arrow"},null,-1)),Ot={class:"text"},Gt={class:"icon"},Jt=y({__name:"NavDropdownLinkItem",props:{item:null},setup(n){const t=U(n),{props:o,isExternal:a}=ae(t.item);return(s,l)=>(u(),h("div",Ft,[r("a",zn({class:"item"},i(o)),[Yt,r("span",Ot,p(n.item.text),1),r("span",Gt,[i(a)?(u(),$(wn,{key:0})):f("",!0)])],16)]))}});var Vt=_(Jt,[["__scopeId","data-v-07381bdb"]]);const zt=["aria-label"],Ut={class:"button-text"},Kt={class:"dialog"},Xt=y({__name:"NavDropdownLink",props:{item:null},setup(n){const e=Y(),t=L(!1);K(()=>e.path,()=>{t.value=!1});function o(){t.value=!t.value}return(a,s)=>(u(),h("div",{class:M(["nav-dropdown-link",{open:t.value}])},[r("button",{class:"button","aria-label":n.item.ariaLabel,onClick:o},[r("span",Ut,p(n.item.text),1),r("span",{class:M(["button-arrow",t.value?"down":"right"])},null,2)],8,zt),r("ul",Kt,[(u(!0),h(T,null,H(n.item.items,l=>(u(),h("li",{key:l.text,class:"dialog-item"},[w(Vt,{item:l},null,8,["item"])]))),128))])],2))}});var Bn=_(Xt,[["__scopeId","data-v-18d75f62"]]);const Qt={key:0,class:"nav-links"},Zt={key:1,class:"item"},no={key:2,class:"item"},eo=y({__name:"NavLinks",setup(n){const{theme:e}=R(),t=At(),o=$t(),a=v(()=>e.value.nav||o.value||t.value);return(s,l)=>i(a)?(u(),h("nav",Qt,[i(e).nav?(u(!0),h(T,{key:0},H(i(e).nav,d=>(u(),h("div",{key:d.text,class:"item"},[d.items?(u(),$(Bn,{key:0,item:d},null,8,["item"])):(u(),$(jn,{key:1,item:d},null,8,["item"]))]))),128)):f("",!0),i(t)?(u(),h("div",Zt,[w(Bn,{item:i(t)},null,8,["item"])])):f("",!0),i(o)?(u(),h("div",no,[w(jn,{item:i(o)},null,8,["item"])])):f("",!0)])):f("",!0)}});var se=_(eo,[["__scopeId","data-v-35b91e7e"]]);const to={emits:["toggle"]},oo=r("svg",{class:"icon",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",role:"img",viewBox:"0 0 448 512"},[r("path",{fill:"currentColor",d:"M436 124H12c-6.627 0-12-5.373-12-12V80c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12z",class:""})],-1),ao=[oo];function so(n,e,t,o,a,s){return u(),h("div",{class:"sidebar-button",onClick:e[0]||(e[0]=l=>n.$emit("toggle"))},ao)}var io=_(to,[["render",so]]);const ro=n=>(E("data-v-40587210"),n=n(),W(),n),lo={class:"nav-bar"},uo=ro(()=>r("div",{class:"flex-grow"},null,-1)),co={class:"nav"},ho=y({__name:"NavBar",emits:["toggle"],setup(n){return(e,t)=>(u(),h("header",lo,[w(io,{onToggle:t[0]||(t[0]=o=>e.$emit("toggle"))}),w(xt),uo,r("div",co,[w(se)]),C(e.$slots,"search",{},void 0,!0)]))}});var mo=_(ho,[["__scopeId","data-v-40587210"]]);function go(){let n=null,e=null;const t=wo(o,300);function o(){const l=po(),d=fo(l);for(let c=0;c<d.length;c++){const m=d[c],g=d[c+1],[S,A]=vo(c,m,g);if(S){history.replaceState(null,document.title,A||" "),a(A);return}}}function a(l){if(s(e),s(n),e=document.querySelector(`.sidebar a[href="${l}"]`),!e)return;e.classList.add("active");const d=e.closest(".sidebar-links > ul > li");d&&d!==e.parentElement?(n=d.querySelector("a"),n&&n.classList.add("active")):n=null}function s(l){l&&l.classList.remove("active")}P(()=>{o(),window.addEventListener("scroll",t)}),Un(()=>{a(decodeURIComponent(location.hash))}),X(()=>{window.removeEventListener("scroll",t)})}function po(){return[].slice.call(document.querySelectorAll(".sidebar a.sidebar-link-item"))}function fo(n){return[].slice.call(document.querySelectorAll(".header-anchor")).filter(e=>n.some(t=>t.hash===e.hash))}function yo(){return document.querySelector(".nav-bar").offsetHeight}function Dn(n){const e=yo();return n.parentElement.offsetTop-e-15}function vo(n,e,t){const o=window.scrollY;return n===0&&o===0?[!0,null]:o<Dn(e)?[!1,null]:!t||o<Dn(t)?[!0,decodeURIComponent(e.hash)]:[!1,null]}function wo(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),o=!0,setTimeout(()=>{o=!1},e))}}function bo(){const n=Y(),{site:e}=R();return go(),v(()=>{const t=n.data.headers,o=n.data.frontmatter.sidebar,a=n.data.frontmatter.sidebarDepth;if(o===!1)return[];if(o==="auto")return Fn(t,a);const s=vn(e.value.themeConfig.sidebar,n.data.relativePath);return s===!1?[]:s==="auto"?Fn(t,a):s})}function Fn(n,e){const t=[];if(n===void 0)return[];let o;return n.forEach(({level:a,title:s,slug:l})=>{if(a-1>e)return;const d={text:s,link:`#${l}`};a===2?(o=d,t.push(d)):o&&(o.children||(o.children=[])).push(d)}),t}const ie=n=>{const e=Y(),{site:t,frontmatter:o}=R(),a=n.depth||1,s=o.value.sidebarDepth||1/0,l=e.data.headers,d=n.item.text,c=_o(t.value.base,n.item.link),m=n.item.children,g=wt(e,n.item.link),S=a<s?re(g,m,l,a+1):null;return G("li",{class:"sidebar-link"},[G(c?"a":"p",{class:{"sidebar-link-item":!0,active:g},href:c},d),S])};function _o(n,e){return e===void 0||e.startsWith("#")?e:bt(n,e)}function re(n,e,t,o=1){return e&&e.length>0?G("ul",{class:"sidebar-links"},e.map(a=>G(ie,{item:a,depth:o}))):n&&t?re(!1,So(t),void 0,o):null}function So(n){return le(ko(n))}function ko(n){n=n.map(t=>Object.assign({},t));let e;return n.forEach(t=>{t.level===2?e=t:e&&(e.children||(e.children=[])).push(t)}),n.filter(t=>t.level===2)}function le(n){return n.map(e=>({text:e.title,link:`#${e.slug}`,children:e.children?le(e.children):void 0}))}const Io={key:0,class:"sidebar-links"},Ro=y({__name:"SideBarLinks",setup(n){const e=bo();return(t,o)=>i(e).length>0?(u(),h("ul",Io,[(u(!0),h(T,null,H(i(e),a=>(u(),$(i(ie),{item:a},null,8,["item"]))),256))])):f("",!0)}});const To=y({__name:"SideBar",props:{open:{type:Boolean}},setup(n){return(e,t)=>(u(),h("aside",{class:M(["sidebar",{open:n.open}])},[w(se,{class:"nav"}),C(e.$slots,"sidebar-top",{},void 0,!0),w(Ro),C(e.$slots,"sidebar-bottom",{},void 0,!0)],2))}});var xo=_(To,[["__scopeId","data-v-17c48e2f"]]);const Ao=/bitbucket.org/;function Co(){const{page:n,theme:e,frontmatter:t}=R(),o=v(()=>{const{repo:s,docsDir:l="",docsBranch:d="master",docsRepo:c=s,editLinks:m}=e.value,g=t.value.editLink!=null?t.value.editLink:m,{relativePath:S}=n.value;return!g||!S||!s?null:$o(s,c,l,d,S)}),a=v(()=>e.value.editLinkText||"Edit this page");return{url:o,text:a}}function $o(n,e,t,o,a){return Ao.test(n)?qo(n,e,t,o,a):Ho(n,e,t,o,a)}function Ho(n,e,t,o,a){return(yn(e)?e:`https://github.com/${e}`).replace(tn,"")+`/edit/${o}/`+(t?t.replace(tn,"")+"/":"")+a}function qo(n,e,t,o,a){return(yn(e)?e:n).replace(tn,"")+`/src/${o}/`+(t?t.replace(tn,"")+"/":"")+a+`?mode=edit&spa=0&at=${o}&fileviewer=file-view-default`}const Lo={class:"edit-link"},Mo=["href"],Po=y({__name:"EditLink",setup(n){const{url:e,text:t}=Co();return(o,a)=>(u(),h("div",Lo,[i(e)?(u(),h("a",{key:0,class:"link",href:i(e),target:"_blank",rel:"noopener noreferrer"},[j(p(i(t))+" ",1),w(wn,{class:"icon"})],8,Mo)):f("",!0)]))}});var No=_(Po,[["__scopeId","data-v-55695e90"]]);const Eo={key:0,class:"last-updated"},Wo={class:"prefix"},jo={class:"datetime"},Bo=y({__name:"LastUpdated",setup(n){const{theme:e,page:t}=R(),o=v(()=>{const l=e.value.lastUpdated;return l!==void 0&&l!==!1}),a=v(()=>{const l=e.value.lastUpdated;return l===!0?"Last Updated":l}),s=L("");return P(()=>{s.value=new Date(t.value.lastUpdated).toLocaleString("en-US")}),(l,d)=>i(o)?(u(),h("p",Eo,[r("span",Wo,p(i(a))+":",1),r("span",jo,p(s.value),1)])):f("",!0)}});var Do=_(Bo,[["__scopeId","data-v-30c3cbb4"]]);const Fo={class:"page-footer"},Yo={class:"edit"},Oo={class:"updated"},Go=y({__name:"PageFooter",setup(n){return(e,t)=>(u(),h("footer",Fo,[r("div",Yo,[w(No)]),r("div",Oo,[w(Do)])]))}});var Jo=_(Go,[["__scopeId","data-v-5c96fb00"]]);function Vo(){const{page:n,theme:e}=R(),t=v(()=>te(gn(n.value.relativePath))),o=v(()=>{const c=vn(e.value.sidebar,t.value);return fn(c)?oe(c):[]}),a=v(()=>o.value.findIndex(c=>c.link===t.value)),s=v(()=>{if(e.value.nextLinks!==!1&&a.value>-1&&a.value<o.value.length-1)return o.value[a.value+1]}),l=v(()=>{if(e.value.prevLinks!==!1&&a.value>0)return o.value[a.value-1]}),d=v(()=>!!s.value||!!l.value);return{next:s,prev:l,hasLinks:d}}const zo={},Uo={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},Ko=r("path",{d:"M19,11H7.4l5.3-5.3c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-7,7c-0.1,0.1-0.2,0.2-0.2,0.3c-0.1,0.2-0.1,0.5,0,0.8c0.1,0.1,0.1,0.2,0.2,0.3l7,7c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4L7.4,13H19c0.6,0,1-0.4,1-1S19.6,11,19,11z"},null,-1),Xo=[Ko];function Qo(n,e){return u(),h("svg",Uo,Xo)}var Zo=_(zo,[["render",Qo]]);const na={},ea={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},ta=r("path",{d:"M19.9,12.4c0.1-0.2,0.1-0.5,0-0.8c-0.1-0.1-0.1-0.2-0.2-0.3l-7-7c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l5.3,5.3H5c-0.6,0-1,0.4-1,1s0.4,1,1,1h11.6l-5.3,5.3c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l7-7C19.8,12.6,19.9,12.5,19.9,12.4z"},null,-1),oa=[ta];function aa(n,e){return u(),h("svg",ea,oa)}var sa=_(na,[["render",aa]]);const ia={key:0,class:"next-and-prev-link"},ra={class:"container"},la={class:"prev"},ua=["href"],ca={class:"text"},ha={class:"next"},da=["href"],ma={class:"text"},ga=y({__name:"NextAndPrevLinks",setup(n){const{hasLinks:e,prev:t,next:o}=Vo();return(a,s)=>i(e)?(u(),h("div",ia,[r("div",ra,[r("div",la,[i(t)?(u(),h("a",{key:0,class:"link",href:i(q)(i(t).link)},[w(Zo,{class:"icon icon-prev"}),r("span",ca,p(i(t).text),1)],8,ua)):f("",!0)]),r("div",ha,[i(o)?(u(),h("a",{key:0,class:"link",href:i(q)(i(o).link)},[r("span",ma,p(i(o).text),1),w(sa,{class:"icon icon-next"})],8,da)):f("",!0)])])])):f("",!0)}});var pa=_(ga,[["__scopeId","data-v-e65a9748"]]);const fa={class:"page"},ya={class:"container"},va=y({__name:"Page",setup(n){return(e,t)=>{const o=en("Content");return u(),h("main",fa,[r("div",ya,[C(e.$slots,"top",{},void 0,!0),w(o,{class:"content"}),w(Jo),w(pa),C(e.$slots,"bottom",{},void 0,!0)])])}}});var wa=_(va,[["__scopeId","data-v-8fcebc32"]]);const ba={key:0,id:"ads-container"},_a=y({__name:"Layout",setup(n){const e=qe(()=>On(()=>import("./Home.d03d4684.js"),["assets/Home.d03d4684.js","assets/Debug.vue_vue_type_style_index_0_scoped_true_lang.0bf38ae3.js","assets/framework.3a6555e1.js","assets/plugin-vue_export-helper.21dcd24c.js","assets/preload-helper.1c052cf7.js"])),t=()=>null,o=t,a=t,s=t,l=Y(),{site:d,page:c,theme:m,frontmatter:g}=R(),S=v(()=>!!g.value.customLayout),A=v(()=>!!g.value.home),b=v(()=>Object.keys(d.value.langs).length>1),k=v(()=>{const x=m.value;return g.value.navbar===!1||x.navbar===!1?!1:d.value.title||x.logo||x.repo||x.nav}),I=L(!1),N=v(()=>g.value.home||g.value.sidebar===!1?!1:!kt(vn(m.value.sidebar,l.data.relativePath))),sn=x=>{I.value=typeof x=="boolean"?x:!I.value},ve=sn.bind(null,!1);K(l,ve);const we=v(()=>[{"no-navbar":!k.value,"sidebar-open":I.value,"no-sidebar":!N.value}]);return(x,In)=>{const be=en("Content"),_e=en("Debug");return u(),h(T,null,[r("div",{class:M(["theme",i(we)])},[i(k)?(u(),$(mo,{key:0,onToggle:sn},{search:D(()=>[C(x.$slots,"navbar-search",{},()=>[i(m).algolia?(u(),$(i(s),{key:0,options:i(m).algolia,multilang:i(b)},null,8,["options","multilang"])):f("",!0)])]),_:3})):f("",!0),w(xo,{open:I.value},{"sidebar-top":D(()=>[C(x.$slots,"sidebar-top")]),"sidebar-bottom":D(()=>[C(x.$slots,"sidebar-bottom")]),_:3},8,["open"]),r("div",{class:"sidebar-mask",onClick:In[0]||(In[0]=pr=>sn(!1))}),i(S)?(u(),$(be,{key:1})):i(A)?C(x.$slots,"home",{key:2},()=>[w(i(e),null,{hero:D(()=>[C(x.$slots,"home-hero")]),features:D(()=>[C(x.$slots,"home-features")]),footer:D(()=>[C(x.$slots,"home-footer")]),_:3})]):(u(),$(wa,{key:3},{top:D(()=>[C(x.$slots,"page-top-ads",{},()=>[i(m).carbonAds&&i(m).carbonAds.carbon?(u(),h("div",ba,[(u(),$(i(o),{key:"carbon"+i(c).relativePath,code:i(m).carbonAds.carbon,placement:i(m).carbonAds.placement},null,8,["code","placement"]))])):f("",!0)]),C(x.$slots,"page-top")]),bottom:D(()=>[C(x.$slots,"page-bottom"),C(x.$slots,"page-bottom-ads",{},()=>[i(m).carbonAds&&i(m).carbonAds.custom?(u(),$(i(a),{key:"custom"+i(c).relativePath,code:i(m).carbonAds.custom,placement:i(m).carbonAds.placement},null,8,["code","placement"])):f("",!0)])]),_:3}))],2),w(_e)],64)}}}),Sa={class:"theme"},ka=r("h1",null,"404",-1),Ia=["href"],Ra=y({__name:"NotFound",setup(n){const{site:e}=R(),t=["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."];function o(){return t[Math.floor(Math.random()*t.length)]}return(a,s)=>(u(),h("div",Sa,[ka,r("blockquote",null,p(o()),1),r("a",{href:i(e).base,"aria-label":"go to home"},"Take me home.",8,Ia)]))}}),Ta={Layout:_a,NotFound:Ra};class xa{constructor(){this.x=50,this.y=50,this.vx=Math.random()*2+2,this.vy=Math.random()*2,this.color="#fff",this.shadowBlur=Math.random()*3,this.shadowX=Math.random()*2-1,this.shadowY=Math.random()*2-1,this.radiusX=Math.random()*3,this.radiusY=Math.random()*3,this.rotation=Math.PI*Math.floor(Math.random()*2)}}class bn{constructor(e){this.width=300,this.height=300,this.dustQuantity=50,this.dustArr=[];const t=document.getElementById(e);if(t)this.canvas=t,this.ctx=t.getContext("2d"),this.build(),window.addEventListener("resize",()=>this.resize());else throw new Error("canvasID \u65E0\u6548")}build(){if(this.resize(),this.ctx){const e=bn.getPoint(this.dustQuantity);for(let t of e){const o=new xa;this.buildDust(t[0],t[1],o),this.dustArr.push(o)}setInterval(()=>{this.play()},40)}}play(){var t;const e=this.dustArr;(t=this.ctx)==null||t.clearRect(0,0,this.width,this.height);for(let o of e)if(o.x<0||o.y<0){const a=this.width,s=Math.floor(Math.random()*window.innerHeight);o.x=a,o.y=s,this.buildDust(a,s,o)}else{const a=o.x-o.vx,s=o.y-o.vy;this.buildDust(a,s,o)}}buildDust(e,t,o){const a=this.ctx;e&&(o.x=e),t&&(o.y=t),a&&(a.beginPath(),a.shadowBlur=o.shadowBlur,a.shadowColor=o.color,a.shadowOffsetX=o.shadowX,a.shadowOffsetY=o.shadowY,a.ellipse(o.x,o.y,o.radiusX,o.radiusY,o.rotation,0,Math.PI*2),a.closePath(),a.fillStyle=o.color,a.fill())}resize(){const e=this.canvas,t=window.innerWidth,o=window.innerHeight;this.width=t,this.height=o,this.dustQuantity=Math.floor((t+o)/38),e!==void 0&&(e.width=t,e.height=o)}static getPoint(e=1){let t=[];for(let o=0;o<e;o++){const a=Math.floor(Math.random()*window.innerWidth),s=Math.floor(Math.random()*window.innerHeight);t.push([a,s])}return t}}const Aa=n=>{const e=localStorage.getItem(n);return e&&JSON.parse(e)},Yn=(n,e)=>{localStorage.setItem(n,JSON.stringify(e))};function Ca(n){let e=n[0];for(let t=1;t<n.length;t++){const o=n[t];o.length>e.length&&(e=o)}return e}function ue(n,e){return Array.from(n).filter(a=>e.test(a.nodeName))}function ce(n,e){let t,o,a=0;return function(){t=this,o=arguments;let s=new Date().valueOf();s-a>e&&(n.apply(t,o),a=s)}}const $a=n=>{n.forEach(e=>{const t=new Image;t.src=e})};const Ha=y({__name:"BgToggle",props:{bgUrl:String},setup(n){const{theme:e}=R(),t=e.value.bgUrls,o=L(0),a=Le("setBg");an(()=>{a(t[o.value])}),Me(()=>{$a(t)}),P(()=>{s()});const s=()=>{const d=Aa("bgIdx");d==null?Yn("bgIdx",o.value):o.value=d},l=()=>{o.value>=t.length-1?o.value=0:o.value++,Yn("bgIdx",o.value)};return(d,c)=>(u(),h("i",{class:"fa fa-retweet bg-toggle",title:"toggle background",onClick:l}))}});var qa=_(Ha,[["__scopeId","data-v-2dc83b4c"]]);const La=n=>(E("data-v-7d636702"),n=n(),W(),n),Ma={class:"menu-list"},Pa=La(()=>r("a",{href:""},[r("i",{class:"fa fa-navicon"})],-1)),Na=[Pa],Ea=["href"],Wa=["title"],ja=y({__name:"index",setup(n){const{theme:e,page:t}=R(),o=e.value.nav,a=L(!0),s=v(()=>`/${t.value.relativePath.split(".")[0]}`),l=()=>{a.value=!a.value};return(d,c)=>(u(),h("header",null,[r("nav",null,[r("ul",Ma,[r("li",{class:"nav-toggle",onClick:l},Na),a.value?(u(!0),h(T,{key:0},H(i(o),m=>(u(),h("li",{class:M(m.link===i(s)?"active":"")},[(u(),h("a",{href:m.link,key:m.link},[r("i",{class:M(`fa fa-${m.icon}`),title:m.text},null,10,Wa)],8,Ea))],2))),256)):f("",!0),r("li",null,[w(qa)])])])]))}});var Ba=_(ja,[["__scopeId","data-v-7d636702"]]);const Da={key:0,class:"social-links"},Fa=["href"],Ya=["title"],Oa=y({__name:"SocialLinks",setup(n){const{theme:e}=R();return(t,o)=>i(e).socialLinks.length?(u(),h("div",Da,[(u(!0),h(T,null,H(i(e).socialLinks,a=>(u(),h("a",{key:a.link,href:a.link,target:"_blank"},[r("i",{class:M(`fa fa-${a.icon}`),title:a.text},null,10,Ya)],8,Fa))),128))])):f("",!0)}});var Ga=_(Oa,[["__scopeId","data-v-1c971fe0"]]);const _n=n=>(E("data-v-1d916c1f"),n=n(),W(),n),Ja={key:0,class:"aside-wrapper"},Va={href:"/",class:"logo"},za=["src"],Ua={class:"center dr"},Ka={href:"/"},Xa={class:"total"},Qa=["href"],Za=_n(()=>r("span",{class:"total-title"},"Archives Total",-1)),ns={class:"total-number"},es={class:"total-tags"},ts=_n(()=>r("span",{class:"total-title"},"Tags:",-1)),os={class:"total-number"},as={class:"total-categories"},ss=_n(()=>r("span",{class:"total-title"},"Categories:",-1)),is={class:"total-number"},rs=y({__name:"index",setup(n){const{site:e,theme:t,frontmatter:o}=R(),a=e.value.title,s=t.value.logo,l=t.value.posts.length,d=Object.keys(t.value.tags).length,c=Object.keys(t.value.cats).length,m=v(()=>o.value.sidebar);return(g,S)=>i(m)?(u(),h("div",Ja,[r("aside",null,[r("div",null,[r("a",Va,[r("img",{src:i(q)(i(s)),alt:"Logo"},null,8,za)]),r("h1",Ua,[r("a",Ka,"Dr."+p(i(a)),1)]),r("section",Xa,[r("a",{class:"total-archives",href:i(q)("/pages/archives")},[Za,r("span",ns,p(i(l)),1)],8,Qa),r("div",es,[ts,r("span",os,p(i(d)),1)]),r("div",as,[ss,r("span",is,p(i(c)),1)])]),w(Ga)])])])):f("",!0)}});var ls=_(rs,[["__scopeId","data-v-1d916c1f"]]);const us={class:"message-wrapper"},cs=y({__name:"Message",props:{type:{type:String,required:!0},msg:{type:String,required:!0}},setup(n){return(e,t)=>(u(),h("div",us,[r("span",null,p(n.msg.value),1)]))}});var hs=_(cs,[["__scopeId","data-v-716cb212"]]);const Q=B({type:"success",msg:""}),ds=(n=Q.type,e,t)=>{Q.type=n,Q.msg=e;const o=ne(hs,{...U(Q)}).mount(document.createElement("div"));document.body.appendChild(o.$el),setTimeout(()=>{document.body.removeChild(o.$el)},t)},he={success(n,e=1e3){ds("success",n,e)},install(n){n.config.globalProperties.message=he}};class ms{constructor(){this.codeEles=document.getElementsByTagName("pre"),Array.from(this.codeEles).forEach(async t=>{const o=document.createElement("i");o.setAttribute("class","btn-copy fa fa-clipboard"),t.appendChild(o),o.addEventListener("click",function(){const a=document.createElement("textarea"),s=o.previousElementSibling;a.value=s.innerText,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),he.success("Copied!")})})}}const gs=n=>(E("data-v-4e6f6b2a"),n=n(),W(),n),ps={class:"post-header"},fs={class:"title"},ys={class:"info"},vs={class:"item date",datetime:"2022-01-25T19:21:35.000Z"},ws=gs(()=>r("div",{class:"divider"},null,-1)),bs=y({__name:"PostHeader",setup(n){const{frontmatter:e}=R();let t=v(()=>e.value.title),o=v(()=>{const a=e.value.date;return(a?new Date(a).toJSON().split("T")[0]:"").split("-")});return(a,s)=>(u(),h("div",ps,[r("h1",fs,p(i(t)),1),r("div",ys,[r("span",vs,p(i(o)[2])+" / "+p(i(o)[1])+" / "+p(i(o)[0]),1)]),ws]))}});var _s=_(bs,[["__scopeId","data-v-4e6f6b2a"]]);const Sn=n=>(E("data-v-f9cae6c6"),n=n(),W(),n),Ss={class:"post-footer"},ks=Sn(()=>r("span",null,"\u672C\u6587\u4F5C\u8005\uFF1A",-1)),Is=["href"],Rs=Sn(()=>r("span",null,"\u672C\u6587\u94FE\u63A5\uFF1A",-1)),Ts=["href"],xs=Sn(()=>r("li",null,[r("span",null,"\u7248\u6743\u58F0\u660E\uFF1A"),j(" \u672C\u535A\u5BA2\u6240\u6709\u6587\u7AE0\u9664\u7279\u522B\u58F0\u660E\u5916\uFF0C\u5747\u91C7\u7528 "),r("a",{href:"https://creativecommons.org/licenses/by-nc-sa/4.0/",target:"_blank"},"CC BY-NC-SA 4.0"),j(" \u8BB8\u53EF\u534F\u8BAE\uFF0C\u8F6C\u8F7D\u8BF7\u6CE8\u660E\u51FA\u5904\u3002 ")],-1)),As=y({__name:"PostFooter",setup(n){const{page:e,site:t,frontmatter:o}=R();let a=v(()=>{const s=`${e.value.relativePath.split(".")[0]}.html`;return`${t.value.themeConfig.website}/${s}`});return v(()=>o.value.postFooter),(s,l)=>(u(),h("div",Ss,[r("ul",null,[r("li",null,[ks,r("a",{href:i(t).themeConfig.website,target:"_blank"},p(i(t).title),9,Is)]),r("li",null,[Rs,r("a",{href:i(a),target:"_blank"},p(i(a)),9,Ts)]),xs])]))}});var Cs=_(As,[["__scopeId","data-v-f9cae6c6"]]);const de=n=>(E("data-v-22a9c1c0"),n=n(),W(),n),$s={class:"prev-next"},Hs=de(()=>r("hr",null,null,-1)),qs=["href"],Ls={key:1},Ms=["href"],Ps={key:1},Ns=de(()=>r("hr",null,null,-1)),Es=y({__name:"PrevNext",setup(n){const{theme:e,page:t}=R(),o=v(()=>e.value.posts),a=v(()=>t.value.frontmatter.title);let s=B({regularPath:"",frontMatter:{title:""}}),l=B({regularPath:"",frontMatter:{title:""}});const d=(c,m)=>{m?(c.regularPath=m.regularPath,c.frontMatter.title=m.frontMatter.title):(c.regularPath="",c.frontMatter.title="")};return an(()=>{const c=o.value.findIndex(m=>m.frontMatter.title===a.value);if(c>-1){const m=o.value[c-1],g=o.value[c+1];d(s,m),d(l,g)}}),(c,m)=>{var g,S,A,b,k,I;return u(),h("div",$s,[Hs,r("div",null,[hn(r("a",{class:"prev",href:i(q)((g=i(s))==null?void 0:g.regularPath)},[i(e).docFooter.prev.icon?(u(),h("i",{key:0,class:M(`fa fa-${i(e).docFooter.prev.icon}`)},null,2)):f("",!0),i(e).docFooter.prev.text?(u(),h("span",Ls,p(i(e).docFooter.prev.text),1)):f("",!0),j(" "+p((A=(S=i(s))==null?void 0:S.frontMatter)==null?void 0:A.title),1)],8,qs),[[Mn,i(s).regularPath]]),hn(r("a",{class:"next",href:i(q)((b=i(l))==null?void 0:b.regularPath)},[j(p((I=(k=i(l))==null?void 0:k.frontMatter)==null?void 0:I.title)+" ",1),i(e).docFooter.next.icon?(u(),h("i",{key:0,class:M(`fa fa-${i(e).docFooter.next.icon}`)},null,2)):f("",!0),i(e).docFooter.next.text?(u(),h("span",Ps,p(i(e).docFooter.next.text),1)):f("",!0)],8,Ms),[[Mn,i(l).regularPath]])]),Ns])}}});var Ws=_(Es,[["__scopeId","data-v-22a9c1c0"]]);const me=n=>(E("data-v-413ae51b"),n=n(),W(),n),js=me(()=>r("i",{class:"fa fa-caret-up"},null,-1)),Bs=me(()=>r("p",null,"TOP",-1)),Ds=[js,Bs],Fs=y({__name:"BackTop",setup(n){const e=L(0),t=v(()=>e.value>300?"block":"none");P(()=>{window.addEventListener("scroll",a)}),X(()=>{window.removeEventListener("scroll",a)});const o=()=>{e.value=document.documentElement.scrollTop},a=ce.bind(this,o,1e3)(),s=()=>{const l=document.documentElement.scrollTop/6,d=setInterval(()=>{document.documentElement.scrollTop=document.documentElement.scrollTop-l,e.value=document.documentElement.scrollTop,e.value<=0&&clearInterval(d)},50)};return(l,d)=>(u(),h("div",{class:"back-top",style:Kn({display:i(t)}),onClick:s},Ds,4))}});var Ys=_(Fs,[["__scopeId","data-v-413ae51b"]]);function Os(n="2022-01-01"){const e=new Date(n),t=new Date().getTime()-e.getTime(),o=24*60*60*1e3,a=t/o,s=Math.floor(a),l=(a-s)*24,d=Math.floor(l),c=(l-d)*60,m=Math.floor(c),g=(c-m)*60,S=Math.floor(g);return{day:s,hour:d,minute:m,second:S}}const Gs=()=>{const n=document.title;document.addEventListener("visibilitychange",function(){document.hidden?document.title="zzZZZ...":document.title=n})};const kn=n=>(E("data-v-514ed06b"),n=n(),W(),n),Js=kn(()=>r("i",{class:"fa fa-heartbeat mr4"},null,-1)),Vs=Pe('<p data-v-514ed06b> Published With <a href="https://vitejs.cn/vitepress/" target="_blank" data-v-514ed06b>VitePress</a> &amp; <a href="https://github.com/Yue-plus/hexo-theme-arknights" target="_blank" class="mr4" data-v-514ed06b>Arknights</a><a href="https://travellings.link/" target="_blank" data-v-514ed06b><i class="fa fa-paper-plane-o" title="Travellings" data-v-514ed06b></i></a></p><p data-v-514ed06b> Mirror Hosting <a href="https://wonderven.netlify.app/" target="_blank" data-v-514ed06b>Netlify</a></p>',2),zs=kn(()=>r("div",null,[r("span",null,"\xA9"),r("span",null,"2021 to 2022")],-1)),Us=kn(()=>r("div",null,[r("span",null,"ICP"),r("span",null,"\u2014 RHODEISLAND \u2014")],-1)),Ks=y({__name:"Footer",setup(n){const{theme:e}=R(),t=L();let o=B({day:0,hour:0,minute:0,second:0}),a=null;P(()=>{e.value.footer.runtime.enable&&(a=setInterval(s,1e3))}),X(()=>{a&&clearInterval(a)});const s=()=>{const l=Os();o.day=l.day,o.hour=l.hour,o.minute=l.minute,o.second=l.second};return(l,d)=>(u(),h("footer",null,[i(e).footer.runtime.enable?(u(),h("p",{key:0,ref_key:"runtimeRef",ref:t},[Js,j(" "+p(i(o).day)+" days "+p(i(o).hour)+" hours "+p(i(o).minute)+" minutes and "+p(i(o).second)+" seconds ",1)],512)):f("",!0),Vs,i(e).footer.copyright?(u(),h(T,{key:1},[zs,Us],64)):f("",!0)]))}});var Xs=_(Ks,[["__scopeId","data-v-514ed06b"]]);const ge=/^H[1-6]{1,}$/,Qs=n=>{const e=n.childNodes,t=ue(e,ge);return Zs(t)};function Zs(n){const e=[];for(let t=0;t<n.length;t++){const o=n[t],a=/^(_\d{1,})+(-\d{1,})*/ig,s=o.id.match(a)[0];e.push({nodeName:o.nodeName,text:o.innerText.slice(0,o.innerText.length-1),id:o.id,level:s})}return ni(e)}function ni(n){const e=[],t={};n.forEach(o=>{t[o.level]=o});for(const o in t)if(Object.prototype.hasOwnProperty.call(t,o)){const a=t[o];if(/^(_\d{1,})+$/ig.test(o))e.push(a);else{const d=Object.keys(t).filter(m=>m!==o&&o.includes(m)),c=Ca(d);t[c].child?t[c].child.push(a):t[c].child=[a]}}return e}const ei=["href","name","title","onClick"],ti=y({__name:"CataList",props:{tree:Array},setup(n){const e=t=>{t.open=!t.open,t.active=!0};return(t,o)=>(u(),h("ul",null,[(u(!0),h(T,null,H(n.tree,a=>{var s;return u(),h("li",{key:a.id},[r("a",{href:`#${a.id}`,name:a.id,title:a.text,class:M([[a.nodeName,a.active?"active":""],"link"]),onClick:l=>e(a)},p(a.text),11,ei),((s=a.child)==null?void 0:s.length)&&a.open?(u(),$(pe,{key:0,tree:a.child},null,8,["tree"])):f("",!0)])}),128))]))}});var pe=_(ti,[["__scopeId","data-v-33c6374d"]]);const oi={key:0,class:"catalog"},ai=y({__name:"index",setup(n){const{frontmatter:e}=R(),t=L(0),o=L(0),a=B({data:[]}),s=B({titleNodes:[],titleMargins:[]});K(e,(b,k)=>{l()},{deep:!0}),P(()=>{l(),window.addEventListener("scroll",c)}),X(()=>{window.removeEventListener("scroll",c)});const l=()=>{var I;const b=(I=document.getElementById("content"))==null?void 0:I.childNodes[0],k=Qs(b);a.data=k,o.value=b.getBoundingClientRect().top,g(b)},d=()=>{t.value=document.documentElement.scrollTop,m()},c=ce.bind(this,d,50)(),m=()=>{const b=s.titleMargins;for(let k=0;k<b.length;k++){const I=b[k];if(I.top-t.value>=o.value){A(a.data),S(a.data,I.id);return}}},g=b=>{const k=b.childNodes;s.titleNodes=ue(k,ge);const I=s.titleNodes.map(N=>({id:N.id,top:N.getBoundingClientRect().top}));s.titleMargins=I,m()},S=(b,k)=>{for(let I=0;I<b.length;I++){const N=b[I];if(N.id===k){N.active=!0,N.open=!0;return}N.child&&S(N.child,k)}},A=b=>{for(let k=0;k<b.length;k++){const I=b[k];I.active&&(I.active=!1),I.child&&A(I.child)}};return(b,k)=>a.data.length?(u(),h("div",oi,[w(pe,{tree:a.data},null,8,["tree"])])):f("",!0)}});var si=_(ai,[["__scopeId","data-v-32f802b6"]]);const ii={key:1,class:"post-des"},ri=["innerHTML"],li=["innerHTML"],ui={key:0,class:"post-tag"},ci=r("i",{class:"fa fa-tags"},null,-1),hi=["href"],di=y({__name:"index",setup(n){const{frontmatter:e}=R(),t=v(()=>e.value.page),o=v(()=>e.value.tags||[]);P(()=>{a()}),Un(()=>{a()});const a=()=>{t.value||new ms};return(s,l)=>{const d=en("Content");return u(),h("div",{class:M(["content",i(t)?"":"post-content"]),id:"postContent"},[i(t)?f("",!0):(u(),$(_s,{key:0})),i(t)?f("",!0):(u(),h("div",ii,[typeof i(e).description=="string"?(u(),h("p",{key:0,innerHTML:i(e).description},null,8,ri)):(u(!0),h(T,{key:1},H(i(e).description,c=>(u(),h("p",{key:c,innerHTML:c},null,8,li))),128))])),w(d,{id:"content"}),i(t)?f("",!0):(u(),h(T,{key:2},[i(o).length?(u(),h("p",ui,[ci,(u(!0),h(T,null,H(i(o),c=>(u(),h("a",{key:c,href:`/pages/archives#tag=${c}`},p(c),9,hi))),128))])):f("",!0),w(Cs),w(Ws),w(Ys),w(si)],64)),w(Xs)],2)}}}),mi=()=>G("script",{src:"https://cdn.jsdelivr.net/gh/stevenjoezhang/live2d-widget/autoload.js"});const gi={ref:"canvasRef",id:"canvas-dust",width:"1036",height:"228"},pi=y({__name:"App",setup(n){const{theme:e}=R(),t=L("111111111111");return Ne("setBg",o=>{t.value=o}),P(()=>{new bn("canvas-dust")}),(o,a)=>(u(),h(T,null,[r("main",{class:"layout",style:Kn({"background-image":`url(${t.value})`})},[w(ls,{class:"aside"}),w(di,{class:"content"}),w(Ba,{class:"navbar"})],4),i(e).live2d?(u(),$(i(mi),{key:0,class:"l2d-model"})):f("",!0),r("canvas",gi,null,512)],64))}});var fi=_(pi,[["__scopeId","data-v-52e49cdc"]]);const yi=["href"],vi={class:"post-info"},wi={class:"post-info-categories"},bi=["href"],_i={key:1,href:"#"},Si={class:"post-info-tags"},ki=["href"],Ii={key:1,href:"#"},Ri={datetime:"2022-01-25T19:21:35.000Z"},Ti=["innerHTML"],xi={class:"post-excerpt"},Ai=["innerHTML"],Ci=["innerHTML"],$i=r("span",{class:"post-btn"},"READ MORE +",-1),Hi=y({__name:"PostItem",props:{article:{type:Object,required:!0}},setup(n){return(e,t)=>(u(),h("a",{href:i(q)(n.article.regularPath),class:"post-item"},[r("div",vi,[r("div",null,[r("span",wi,[n.article.frontMatter.category&&n.article.frontMatter.category.length?(u(!0),h(T,{key:0},H(n.article.frontMatter.category,o=>(u(),h("a",{key:o,href:i(q)(`/pages/archives#category=${o}`)},p(o),9,bi))),128)):(u(),h("a",_i,"Empty"))]),r("span",Si,[n.article.frontMatter.tags&&n.article.frontMatter.tags.length?(u(!0),h(T,{key:0},H(n.article.frontMatter.tags,o=>(u(),h("a",{key:o,href:i(q)(`/pages/archives#tag=${o}`)},p(o),9,ki))),128)):(u(),h("a",Ii," Empty "))])]),r("time",Ri,p(n.article.frontMatter.dateArr[2])+" / "+p(n.article.frontMatter.dateArr[1])+" / "+p(n.article.frontMatter.dateArr[0]),1)]),r("h1",{class:"post-title",innerHTML:n.article.frontMatter.title},null,8,Ti),r("div",xi,[typeof n.article.frontMatter.description=="string"?(u(),h("p",{key:0,innerHTML:n.article.frontMatter.description},null,8,Ai)):(u(!0),h(T,{key:1},H(n.article.frontMatter.description,o=>(u(),h("p",{key:o,innerHTML:o},null,8,Ci))),128))]),$i],8,yi))}});var qi=[{title:"VitePress \u521B\u5EFA\u6587\u7AE0\u76EE\u5F55",content:`1. \u73AF\u5883
VitePress(Vue3 + TS)
2. \u601D\u8DEF
...
`,excerpt:"",url:"/posts\\Vue\\v3-model"}];const Li={class:"input-group"},Mi=r("i",{class:"fa fa-search"},null,-1),Pi={class:"result"},Ni=["href"],Ei=["innerHTML"],Wi=["innerHTML"],ji={key:0,class:"empty"},Bi=r("i",{class:"fa fa-meh-o"},null,-1),Di=j(" No Data "),Fi=[Bi,Di],Yi=y({__name:"Search",setup(n){const{theme:e}=R(),t=L("");let o=B([]);const a=v(()=>!!(o.length||t.value));an(()=>{s(t.value)});function s(c){o.length=0,c.trim()!==""&&qi.forEach(m=>{const g=JSON.parse(JSON.stringify(m)),S=new RegExp(c,"ig"),A=g.title.match(S),b=g.content.match(S);A&&(g.title=l(c,g.title)),b&&(g.content=l(c,g.content)),(A||b)&&o.push(g)})}const l=(c,m)=>{const g=new RegExp(c,"ig");return m.replace(g,`<span class="search-highlight">${c}</span>`)},d=()=>{t.value=""};return(c,m)=>i(e).search?(u(),h("div",{key:0,class:M(["search-wrapper",i(a)?"open":""])},[r("div",Li,[Mi,hn(r("input",{type:"text",placeholder:"Search","onUpdate:modelValue":m[0]||(m[0]=g=>t.value=g)},null,512),[[ut,t.value]]),t.value?(u(),h("i",{key:0,class:"fa fa-trash",onClick:d})):f("",!0)]),r("ul",Pi,[(u(!0),h(T,null,H(i(o),g=>(u(),h("li",{key:g.title},[r("a",{href:g.url,onClick:d},[r("p",{innerHTML:g.title,class:"title"},null,8,Ei),r("p",{innerHTML:g.content,class:"content"},null,8,Wi)],8,Ni)]))),128)),!i(o).length&&t.value!==""?(u(),h("li",ji,Fi)):f("",!0)])],2)):f("",!0)}}),Oi=y({__name:"PostList",props:{posts:Array},setup(n){const e=L("");return(t,o)=>(u(),h(T,null,[w(Yi,{filterKey:e.value,"onUpdate:filterKey":o[0]||(o[0]=a=>e.value=a)},null,8,["filterKey"]),r("div",null,[(u(!0),h(T,null,H(n.posts,(a,s)=>(u(),$(Hi,{key:s,article:a},null,8,["article"]))),128))])],64))}});const Gi={class:"pagination"},Ji=["href"],Vi=["href"],zi=["href"],Ui=y({__name:"Pagination",props:{current:Number,pageNum:Number},setup(n){return(e,t)=>(u(),h("div",Gi,[n.current>1?(u(),h("a",{key:0,class:"link",href:i(q)(n.current===2?"/index.html":`/page_${n.current-1}.html`)},"Prev",8,Ji)):f("",!0),(u(!0),h(T,null,H(n.pageNum,o=>(u(),h("a",{class:M(["link",{active:n.current===o}]),key:o,href:i(q)(o===1?"/index.html":`/page_${o}.html`)},p(o),11,Vi))),128)),n.current<n.pageNum?(u(),h("a",{key:1,class:"link",href:i(q)(`/page_${n.current+1}.html`)},"Next",8,zi)):f("",!0)]))}});var Ki=_(Ui,[["__scopeId","data-v-653fd1d2"]]);const Xi=y({__name:"index",props:{posts:Array,pageCurrent:Number,pagesNum:Number},setup(n){const e=n;let t=B([]);return t=v(()=>{var a;return(((a=U(e).posts)==null?void 0:a.value)||[]).map(s=>{const l=JSON.parse(JSON.stringify(s)),d=l.frontMatter.date;return l.frontMatter.dateArr=d.split("-"),l})}),P(()=>{Gs()}),(o,a)=>(u(),h(T,null,[w(Oi,{posts:i(t)},null,8,["posts"]),w(Ki,{current:n.pageCurrent,pageNum:n.pagesNum},null,8,["current","pageNum"])],64))}});const Qi=n=>(E("data-v-072447f6"),n=n(),W(),n),Zi={class:"loading"},nr={class:"loading-svg hover",width:"100",height:"100",viewBox:"0 0 40 60"},er=Qi(()=>r("polygon",{class:"triangulo",fill:"none",stroke:"#fff","stroke-width":"1",points:"16,1 32,32 1,32"},null,-1)),tr={class:"text",x:"0",y:"45",fill:"#fff"},or=y({__name:"Loading",props:{msg:{type:String,required:!0}},setup(n){return(e,t)=>(u(),h("div",Zi,[(u(),h("svg",nr,[er,r("text",tr,p(n.msg.value),1)]))]))}});var ar=_(or,[["__scopeId","data-v-072447f6"]]);const ln=B({msg:"Loading..."});let un;const fe={show(n=ln.msg){ln.msg=n,un=ne(ar,{...U(ln)}).mount(document.createElement("div")).$el,document.body.appendChild(un)},hide(){document.body.removeChild(un)},install(n){n.config.globalProperties.loading=fe}};var on={...Ta,Layout:fi,async enhanceApp({app:n,router:e,siteData:t}){n.component("Page",Xi),n.use(fe)}};const cn=new Set,ye=()=>document.createElement("link"),sr=n=>{const e=ye();e.rel="prefetch",e.href=n,document.head.appendChild(e)},ir=n=>{const e=new XMLHttpRequest;e.open("GET",n,e.withCredentials=!0),e.send()};let Z;const rr=J&&(Z=ye())&&Z.relList&&Z.relList.supports&&Z.relList.supports("prefetch")?sr:ir;function lr(){if(!J||!window.IntersectionObserver)return;let n;if((n=navigator.connection)&&(n.saveData||/2g/.test(n.effectiveType)))return;const e=window.requestIdleCallback||setTimeout;let t=null;const o=()=>{t&&t.disconnect(),t=new IntersectionObserver(s=>{s.forEach(l=>{if(l.isIntersecting){const d=l.target;t.unobserve(d);const{pathname:c}=d;if(!cn.has(c)){cn.add(c);const m=Xn(c);rr(m)}}})}),e(()=>{document.querySelectorAll("#app a").forEach(s=>{const{target:l,hostname:d,pathname:c}=s,m=c.match(/\.\w+$/);m&&m[0]!==".html"||l!=="_blank"&&d===location.hostname&&(c!==location.pathname?t.observe(s):cn.add(c))})})};P(o);const a=Y();K(()=>a.path,o),X(()=>{t&&t.disconnect()})}const ur=y({setup(n,{slots:e}){const t=L(!1);return P(()=>{t.value=!0}),()=>t.value&&e.default?e.default():null}}),cr=on.NotFound||(()=>"404 Not Found"),hr={name:"VitePressApp",setup(){const{site:n}=R();return P(()=>{K(()=>n.value.lang,e=>{document.documentElement.lang=e},{immediate:!0})}),lr(),()=>G(on.Layout)}};function dr(){const n=gr(),e=mr();e.provide(je,n);const t=Be(n.route);return e.provide(De,t),J&&mt(n.route,t.site),e.component("Content",Fe),e.component("ClientOnly",ur),e.component("Debug",()=>null),Object.defineProperty(e.config.globalProperties,"$frontmatter",{get(){return t.frontmatter.value}}),on.enhanceApp&&on.enhanceApp({app:e,router:n,siteData:Ye}),{app:e,router:n}}function mr(){return dt(hr)}function gr(){let n=J,e;return We(t=>{let o=Xn(t);return n&&(e=o),(n||e===o)&&(o=o.replace(/\.js$/,".lean.js")),J?(n=!1,On(()=>import(o),[])):require(o)},cr)}if(J){const{app:n,router:e}=dr();e.go().then(()=>{n.mount("#app")})}export{jn as N,dr as createApp};
