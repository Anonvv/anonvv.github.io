import{_ as Yn}from"./preload-helper.1c052cf7.js";import{i as nn,c as _e,a as ke,b as Gn,d as fn,e as Ie,t as Rn,f as Re,g as xe,h as Te,j as Jn,k as qe,l as Ae,m as He,n as zn,o as Ce,w as an,_ as S,p as v,q as c,r as m,u as r,s as f,v as L,x as p,y,z as i,A as sn,B as H,C as Vn,D as j,E as W,F as C,G as U,H as P,I as x,J as $,K as b,L as A,M,N as Un,O as K,P as G,Q as en,R as $e,S as B,T as Le,U as Pe,V as D,W as dn,X as Kn,Y as Ee}from"./plugin-vue_export-helper.c35c1c54.js";import{u as R,w as E,a as O,E as Me,i as J,p as Xn,c as Ne,R as je,b as We,d as Be,C as De,s as Fe}from"./Debug.vue_vue_type_style_index_0_scoped_true_lang.574cb2a8.js";import{P as Oe}from"./Pagination.7bbf7d94.js";const Ye="http://www.w3.org/2000/svg",F=typeof document!="undefined"?document:null,xn=F&&F.createElement("template"),Ge={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,o)=>{const a=e?F.createElementNS(Ye,n):F.createElement(n,t?{is:t}:void 0);return n==="select"&&o&&o.multiple!=null&&a.setAttribute("multiple",o.multiple),a},createText:n=>F.createTextNode(n),createComment:n=>F.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>F.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},cloneNode(n){const e=n.cloneNode(!0);return"_value"in n&&(e._value=n._value),e},insertStaticContent(n,e,t,o,a,s){const u=t?t.previousSibling:e.lastChild;if(a&&(a===s||a.nextSibling))for(;e.insertBefore(a.cloneNode(!0),t),!(a===s||!(a=a.nextSibling)););else{xn.innerHTML=o?`<svg>${n}</svg>`:n;const h=xn.content;if(o){const l=h.firstChild;for(;l.firstChild;)h.appendChild(l.firstChild);h.removeChild(l)}e.insertBefore(h,t)}return[u?u.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}};function Je(n,e,t){const o=n._vtc;o&&(e=(e?[e,...o]:[...o]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}function ze(n,e,t){const o=n.style,a=nn(t);if(t&&!a){for(const s in t)mn(o,s,t[s]);if(e&&!nn(e))for(const s in e)t[s]==null&&mn(o,s,"")}else{const s=o.display;a?e!==t&&(o.cssText=t):e&&n.removeAttribute("style"),"_vod"in n&&(o.display=s)}}const Tn=/\s*!important$/;function mn(n,e,t){if(fn(t))t.forEach(o=>mn(n,e,o));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const o=Ve(n,e);Tn.test(t)?n.setProperty(Jn(o),t.replace(Tn,""),"important"):n[o]=t}}const qn=["Webkit","Moz","ms"],ln={};function Ve(n,e){const t=ln[e];if(t)return t;let o=qe(e);if(o!=="filter"&&o in n)return ln[e]=o;o=Ae(o);for(let a=0;a<qn.length;a++){const s=qn[a]+o;if(s in n)return ln[e]=s}return e}const An="http://www.w3.org/1999/xlink";function Ue(n,e,t,o,a){if(o&&e.startsWith("xlink:"))t==null?n.removeAttributeNS(An,e.slice(6,e.length)):n.setAttributeNS(An,e,t);else{const s=He(e);t==null||s&&!zn(t)?n.removeAttribute(e):n.setAttribute(e,s?"":t)}}function Ke(n,e,t,o,a,s,u){if(e==="innerHTML"||e==="textContent"){o&&u(o,a,s),n[e]=t==null?"":t;return}if(e==="value"&&n.tagName!=="PROGRESS"&&!n.tagName.includes("-")){n._value=t;const l=t==null?"":t;(n.value!==l||n.tagName==="OPTION")&&(n.value=l),t==null&&n.removeAttribute(e);return}let h=!1;if(t===""||t==null){const l=typeof n[e];l==="boolean"?t=zn(t):t==null&&l==="string"?(t="",h=!0):l==="number"&&(t=0,h=!0)}try{n[e]=t}catch{}h&&n.removeAttribute(e)}const[Qn,Xe]=(()=>{let n=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(n=performance.now.bind(performance));const t=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(t&&Number(t[1])<=53)}return[n,e]})();let gn=0;const Qe=Promise.resolve(),Ze=()=>{gn=0},nt=()=>gn||(Qe.then(Ze),gn=Qn());function Y(n,e,t,o){n.addEventListener(e,t,o)}function et(n,e,t,o){n.removeEventListener(e,t,o)}function tt(n,e,t,o,a=null){const s=n._vei||(n._vei={}),u=s[e];if(o&&u)u.value=o;else{const[h,l]=ot(e);if(o){const d=s[e]=at(o,a);Y(n,h,d,l)}else u&&(et(n,h,u,l),s[e]=void 0)}}const Hn=/(?:Once|Passive|Capture)$/;function ot(n){let e;if(Hn.test(n)){e={};let o;for(;o=n.match(Hn);)n=n.slice(0,n.length-o[0].length),e[o[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Jn(n.slice(2)),e]}function at(n,e){const t=o=>{const a=o.timeStamp||Qn();(Xe||a>=t.attached-1)&&Ce(st(o,t.value),e,5,[o])};return t.value=n,t.attached=nt(),t}function st(n,e){if(fn(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(o=>a=>!a._stopped&&o&&o(a))}else return e}const Cn=/^on[a-z]/,rt=(n,e,t,o,a=!1,s,u,h,l)=>{e==="class"?Je(n,o,a):e==="style"?ze(n,t,o):xe(e)?Te(e)||tt(n,e,t,o,u):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):it(n,e,o,a))?Ke(n,e,o,s,u,h,l):(e==="true-value"?n._trueValue=o:e==="false-value"&&(n._falseValue=o),Ue(n,e,o,a))};function it(n,e,t,o){return o?!!(e==="innerHTML"||e==="textContent"||e in n&&Cn.test(e)&&Gn(t)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA"||Cn.test(e)&&nn(t)?!1:e in n}const $n=n=>{const e=n.props["onUpdate:modelValue"]||!1;return fn(e)?t=>Ie(e,t):e};function lt(n){n.target.composing=!0}function Ln(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ut={created(n,{modifiers:{lazy:e,trim:t,number:o}},a){n._assign=$n(a);const s=o||a.props&&a.props.type==="number";Y(n,e?"change":"input",u=>{if(u.target.composing)return;let h=n.value;t&&(h=h.trim()),s&&(h=Rn(h)),n._assign(h)}),t&&Y(n,"change",()=>{n.value=n.value.trim()}),e||(Y(n,"compositionstart",lt),Y(n,"compositionend",Ln),Y(n,"change",Ln))},mounted(n,{value:e}){n.value=e==null?"":e},beforeUpdate(n,{value:e,modifiers:{lazy:t,trim:o,number:a}},s){if(n._assign=$n(s),n.composing||document.activeElement===n&&n.type!=="range"&&(t||o&&n.value.trim()===e||(a||n.type==="number")&&Rn(n.value)===e))return;const u=e==null?"":e;n.value!==u&&(n.value=u)}},Pn={beforeMount(n,{value:e},{transition:t}){n._vod=n.style.display==="none"?"":n.style.display,t&&e?t.beforeEnter(n):z(n,e)},mounted(n,{value:e},{transition:t}){t&&e&&t.enter(n)},updated(n,{value:e,oldValue:t},{transition:o}){!e!=!t&&(o?e?(o.beforeEnter(n),z(n,!0),o.enter(n)):o.leave(n,()=>{z(n,!1)}):z(n,e))},beforeUnmount(n,{value:e}){z(n,e)}};function z(n,e){n.style.display=e?n._vod:"none"}const Zn=Re({patchProp:rt},Ge);let V,En=!1;function ct(){return V||(V=ke(Zn))}function ht(){return V=En?V:_e(Zn),En=!0,V}const ne=(...n)=>{const e=ct().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(!a)return;const s=e._component;!Gn(s)&&!s.render&&!s.template&&(s.template=a.innerHTML),a.innerHTML="";const u=t(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),u},e},dt=(...n)=>{const e=ht().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(a)return t(a,!0,a instanceof SVGElement)},e};function ee(n){return nn(n)?document.querySelector(n):n}function mt(n,e){let t=[],o=!0;const a=s=>{if(o){o=!1;return}const u=[],h=Math.min(t.length,s.length);for(let l=0;l<h;l++){let d=t[l];const[g,_,q=""]=s[l];if(d.tagName.toLocaleLowerCase()===g){for(const w in _)d.getAttribute(w)!==_[w]&&d.setAttribute(w,_[w]);for(let w=0;w<d.attributes.length;w++){const k=d.attributes[w].name;k in _||d.removeAttribute(k)}d.innerHTML!==q&&(d.innerHTML=q)}else document.head.removeChild(d),d=Mn(s[l]),document.head.append(d);u.push(d)}t.slice(h).forEach(l=>document.head.removeChild(l)),s.slice(h).forEach(l=>{const d=Mn(l);document.head.appendChild(d),u.push(d)}),t=u};an(()=>{const s=n.data,u=e.value,h=s&&s.title,l=s&&s.description,d=s&&s.frontmatter.head;document.title=(h?h+" | ":"")+u.title,document.querySelector("meta[name=description]").setAttribute("content",l||u.description),a([...d?pt(d):[]])})}function Mn([n,e,t]){const o=document.createElement(n);for(const a in e)o.setAttribute(a,e[a]);return t&&(o.innerHTML=t),o}function gt(n){return n[0]==="meta"&&n[1]&&n[1].name==="description"}function pt(n){return n.filter(e=>!gt(e))}const ft=/#.*$/,yt=/(index)?\.(md|html)$/,tn=/\/$/,vt=/^[a-z]+:/i;function yn(n){return Array.isArray(n)}function vn(n){return vt.test(n)}function wt(n,e){if(e===void 0)return!1;const t=Nn(`/${n.data.relativePath}`),o=Nn(e);return t===o}function Nn(n){return decodeURI(n).replace(ft,"").replace(yt,"")}function bt(n,e){const t=n.endsWith("/"),o=e.startsWith("/");return t&&o?n.slice(0,-1)+e:!t&&!o?`${n}/${e}`:n+e}function pn(n){return/^\//.test(n)?n:`/${n}`}function te(n){return n.replace(/(index)?(\.(md|html))?$/,"")||"/"}function St(n){return n===!1||n==="auto"||yn(n)}function _t(n){return n.children!==void 0}function kt(n){return yn(n)?n.length===0:!n}function wn(n,e){if(St(n))return n;e=pn(e);for(const t in n)if(e.startsWith(pn(t)))return n[t];return"auto"}function oe(n){return n.reduce((e,t)=>(t.link&&e.push({text:t.text,link:te(t.link)}),_t(t)&&(e=[...e,...oe(t.children)]),e),[])}const It=["href","aria-label"],Rt=["src"],xt=v({__name:"NavBarTitle",setup(n){const{site:e,theme:t,localePath:o}=R();return(a,s)=>(c(),m("a",{class:"nav-bar-title",href:r(o),"aria-label":`${r(e).title}, back to home`},[r(t).logo?(c(),m("img",{key:0,class:"logo",src:r(E)(r(t).logo),alt:"Logo"},null,8,Rt)):f("",!0),L(" "+p(r(e).title),1)],8,It))}});var Tt=S(xt,[["__scopeId","data-v-7ac13a1e"]]);function qt(){const{site:n,localePath:e,theme:t}=R();return y(()=>{const o=n.value.langs,a=Object.keys(o);if(a.length<2)return null;const u=O().path.replace(e.value,""),h=a.map(d=>({text:o[d].label,link:`${d}${u}`}));return{text:t.value.selectText||"Languages",items:h}})}const At=["GitHub","GitLab","Bitbucket"].map(n=>[n,new RegExp(n,"i")]);function Ht(){const{site:n}=R();return y(()=>{const e=n.value.themeConfig,t=e.docsRepo||e.repo;if(!t)return null;const o=Ct(t);return{text:$t(o,e.repoLabel),link:o}})}function Ct(n){return Me.test(n)?n:`https://github.com/${n}`}function $t(n,e){if(e)return e;const t=n.match(/^https?:\/\/[^/]+/);if(!t)return"Source";const o=At.find(([a,s])=>s.test(t[0]));return o&&o[0]?o[0]:"Source"}function ae(n){const e=O(),t=vn(n.value.link);return{props:y(()=>{const a=jn(`/${e.data.relativePath}`);let s=!1;if(n.value.activeMatch)s=new RegExp(n.value.activeMatch).test(a);else{const u=jn(n.value.link);s=u==="/"?u===a:a.startsWith(u)}return{class:{active:s,isExternal:t},href:t?n.value.link:E(n.value.link),target:n.value.target||(t?"_blank":null),rel:n.value.rel||(t?"noopener noreferrer":null),"aria-label":n.value.ariaLabel}}),isExternal:t}}function jn(n){return n.replace(/#.*$/,"").replace(/\?.*$/,"").replace(/\.(html|md)$/,"").replace(/\/index$/,"/")}const Lt={},Pt={class:"icon outbound",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",x:"0px",y:"0px",viewBox:"0 0 100 100",width:"15",height:"15"},Et=i("path",{fill:"currentColor",d:"M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"},null,-1),Mt=i("polygon",{fill:"currentColor",points:"45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"},null,-1),Nt=[Et,Mt];function jt(n,e){return c(),m("svg",Pt,Nt)}var bn=S(Lt,[["render",jt]]);const Wt={class:"nav-link"},Bt=v({__name:"NavLink",props:{item:null},setup(n){const t=sn(n),{props:o,isExternal:a}=ae(t.item);return(s,u)=>(c(),m("div",Wt,[i("a",Vn({class:"item"},r(o)),[L(p(n.item.text)+" ",1),r(a)?(c(),H(bn,{key:0})):f("",!0)],16)]))}});var Wn=S(Bt,[["__scopeId","data-v-49fe041d"]]);const Dt=n=>(j("data-v-07381bdb"),n=n(),W(),n),Ft={class:"nav-dropdown-link-item"},Ot=Dt(()=>i("span",{class:"arrow"},null,-1)),Yt={class:"text"},Gt={class:"icon"},Jt=v({__name:"NavDropdownLinkItem",props:{item:null},setup(n){const t=sn(n),{props:o,isExternal:a}=ae(t.item);return(s,u)=>(c(),m("div",Ft,[i("a",Vn({class:"item"},r(o)),[Ot,i("span",Yt,p(n.item.text),1),i("span",Gt,[r(a)?(c(),H(bn,{key:0})):f("",!0)])],16)]))}});var zt=S(Jt,[["__scopeId","data-v-07381bdb"]]);const Vt=["aria-label"],Ut={class:"button-text"},Kt={class:"dialog"},Xt=v({__name:"NavDropdownLink",props:{item:null},setup(n){const e=O(),t=C(!1);U(()=>e.path,()=>{t.value=!1});function o(){t.value=!t.value}return(a,s)=>(c(),m("div",{class:P(["nav-dropdown-link",{open:t.value}])},[i("button",{class:"button","aria-label":n.item.ariaLabel,onClick:o},[i("span",Ut,p(n.item.text),1),i("span",{class:P(["button-arrow",t.value?"down":"right"])},null,2)],8,Vt),i("ul",Kt,[(c(!0),m(x,null,$(n.item.items,u=>(c(),m("li",{key:u.text,class:"dialog-item"},[b(zt,{item:u},null,8,["item"])]))),128))])],2))}});var Bn=S(Xt,[["__scopeId","data-v-18d75f62"]]);const Qt={key:0,class:"nav-links"},Zt={key:1,class:"item"},no={key:2,class:"item"},eo=v({__name:"NavLinks",setup(n){const{theme:e}=R(),t=qt(),o=Ht(),a=y(()=>e.value.nav||o.value||t.value);return(s,u)=>r(a)?(c(),m("nav",Qt,[r(e).nav?(c(!0),m(x,{key:0},$(r(e).nav,h=>(c(),m("div",{key:h.text,class:"item"},[h.items?(c(),H(Bn,{key:0,item:h},null,8,["item"])):(c(),H(Wn,{key:1,item:h},null,8,["item"]))]))),128)):f("",!0),r(t)?(c(),m("div",Zt,[b(Bn,{item:r(t)},null,8,["item"])])):f("",!0),r(o)?(c(),m("div",no,[b(Wn,{item:r(o)},null,8,["item"])])):f("",!0)])):f("",!0)}});var se=S(eo,[["__scopeId","data-v-35b91e7e"]]);const to={emits:["toggle"]},oo=i("svg",{class:"icon",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",role:"img",viewBox:"0 0 448 512"},[i("path",{fill:"currentColor",d:"M436 124H12c-6.627 0-12-5.373-12-12V80c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12z",class:""})],-1),ao=[oo];function so(n,e,t,o,a,s){return c(),m("div",{class:"sidebar-button",onClick:e[0]||(e[0]=u=>n.$emit("toggle"))},ao)}var ro=S(to,[["render",so]]);const io=n=>(j("data-v-40587210"),n=n(),W(),n),lo={class:"nav-bar"},uo=io(()=>i("div",{class:"flex-grow"},null,-1)),co={class:"nav"},ho=v({__name:"NavBar",emits:["toggle"],setup(n){return(e,t)=>(c(),m("header",lo,[b(ro,{onToggle:t[0]||(t[0]=o=>e.$emit("toggle"))}),b(Tt),uo,i("div",co,[b(se)]),A(e.$slots,"search",{},void 0,!0)]))}});var mo=S(ho,[["__scopeId","data-v-40587210"]]);function go(){let n=null,e=null;const t=wo(o,300);function o(){const u=po(),h=fo(u);for(let l=0;l<h.length;l++){const d=h[l],g=h[l+1],[_,q]=vo(l,d,g);if(_){history.replaceState(null,document.title,q||" "),a(q);return}}}function a(u){if(s(e),s(n),e=document.querySelector(`.sidebar a[href="${u}"]`),!e)return;e.classList.add("active");const h=e.closest(".sidebar-links > ul > li");h&&h!==e.parentElement?(n=h.querySelector("a"),n&&n.classList.add("active")):n=null}function s(u){u&&u.classList.remove("active")}M(()=>{o(),window.addEventListener("scroll",t)}),Un(()=>{a(decodeURIComponent(location.hash))}),K(()=>{window.removeEventListener("scroll",t)})}function po(){return[].slice.call(document.querySelectorAll(".sidebar a.sidebar-link-item"))}function fo(n){return[].slice.call(document.querySelectorAll(".header-anchor")).filter(e=>n.some(t=>t.hash===e.hash))}function yo(){return document.querySelector(".nav-bar").offsetHeight}function Dn(n){const e=yo();return n.parentElement.offsetTop-e-15}function vo(n,e,t){const o=window.scrollY;return n===0&&o===0?[!0,null]:o<Dn(e)?[!1,null]:!t||o<Dn(t)?[!0,decodeURIComponent(e.hash)]:[!1,null]}function wo(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),o=!0,setTimeout(()=>{o=!1},e))}}function bo(){const n=O(),{site:e}=R();return go(),y(()=>{const t=n.data.headers,o=n.data.frontmatter.sidebar,a=n.data.frontmatter.sidebarDepth;if(o===!1)return[];if(o==="auto")return Fn(t,a);const s=wn(e.value.themeConfig.sidebar,n.data.relativePath);return s===!1?[]:s==="auto"?Fn(t,a):s})}function Fn(n,e){const t=[];if(n===void 0)return[];let o;return n.forEach(({level:a,title:s,slug:u})=>{if(a-1>e)return;const h={text:s,link:`#${u}`};a===2?(o=h,t.push(h)):o&&(o.children||(o.children=[])).push(h)}),t}const re=n=>{const e=O(),{site:t,frontmatter:o}=R(),a=n.depth||1,s=o.value.sidebarDepth||1/0,u=e.data.headers,h=n.item.text,l=So(t.value.base,n.item.link),d=n.item.children,g=wt(e,n.item.link),_=a<s?ie(g,d,u,a+1):null;return G("li",{class:"sidebar-link"},[G(l?"a":"p",{class:{"sidebar-link-item":!0,active:g},href:l},h),_])};function So(n,e){return e===void 0||e.startsWith("#")?e:bt(n,e)}function ie(n,e,t,o=1){return e&&e.length>0?G("ul",{class:"sidebar-links"},e.map(a=>G(re,{item:a,depth:o}))):n&&t?ie(!1,_o(t),void 0,o):null}function _o(n){return le(ko(n))}function ko(n){n=n.map(t=>Object.assign({},t));let e;return n.forEach(t=>{t.level===2?e=t:e&&(e.children||(e.children=[])).push(t)}),n.filter(t=>t.level===2)}function le(n){return n.map(e=>({text:e.title,link:`#${e.slug}`,children:e.children?le(e.children):void 0}))}const Io={key:0,class:"sidebar-links"},Ro=v({__name:"SideBarLinks",setup(n){const e=bo();return(t,o)=>r(e).length>0?(c(),m("ul",Io,[(c(!0),m(x,null,$(r(e),a=>(c(),H(r(re),{item:a},null,8,["item"]))),256))])):f("",!0)}});const xo=v({__name:"SideBar",props:{open:{type:Boolean}},setup(n){return(e,t)=>(c(),m("aside",{class:P(["sidebar",{open:n.open}])},[b(se,{class:"nav"}),A(e.$slots,"sidebar-top",{},void 0,!0),b(Ro),A(e.$slots,"sidebar-bottom",{},void 0,!0)],2))}});var To=S(xo,[["__scopeId","data-v-17c48e2f"]]);const qo=/bitbucket.org/;function Ao(){const{page:n,theme:e,frontmatter:t}=R(),o=y(()=>{const{repo:s,docsDir:u="",docsBranch:h="master",docsRepo:l=s,editLinks:d}=e.value,g=t.value.editLink!=null?t.value.editLink:d,{relativePath:_}=n.value;return!g||!_||!s?null:Ho(s,l,u,h,_)}),a=y(()=>e.value.editLinkText||"Edit this page");return{url:o,text:a}}function Ho(n,e,t,o,a){return qo.test(n)?$o(n,e,t,o,a):Co(n,e,t,o,a)}function Co(n,e,t,o,a){return(vn(e)?e:`https://github.com/${e}`).replace(tn,"")+`/edit/${o}/`+(t?t.replace(tn,"")+"/":"")+a}function $o(n,e,t,o,a){return(vn(e)?e:n).replace(tn,"")+`/src/${o}/`+(t?t.replace(tn,"")+"/":"")+a+`?mode=edit&spa=0&at=${o}&fileviewer=file-view-default`}const Lo={class:"edit-link"},Po=["href"],Eo=v({__name:"EditLink",setup(n){const{url:e,text:t}=Ao();return(o,a)=>(c(),m("div",Lo,[r(e)?(c(),m("a",{key:0,class:"link",href:r(e),target:"_blank",rel:"noopener noreferrer"},[L(p(r(t))+" ",1),b(bn,{class:"icon"})],8,Po)):f("",!0)]))}});var Mo=S(Eo,[["__scopeId","data-v-55695e90"]]);const No={key:0,class:"last-updated"},jo={class:"prefix"},Wo={class:"datetime"},Bo=v({__name:"LastUpdated",setup(n){const{theme:e,page:t}=R(),o=y(()=>{const u=e.value.lastUpdated;return u!==void 0&&u!==!1}),a=y(()=>{const u=e.value.lastUpdated;return u===!0?"Last Updated":u}),s=C("");return M(()=>{s.value=new Date(t.value.lastUpdated).toLocaleString("en-US")}),(u,h)=>r(o)?(c(),m("p",No,[i("span",jo,p(r(a))+":",1),i("span",Wo,p(s.value),1)])):f("",!0)}});var Do=S(Bo,[["__scopeId","data-v-30c3cbb4"]]);const Fo={class:"page-footer"},Oo={class:"edit"},Yo={class:"updated"},Go=v({__name:"PageFooter",setup(n){return(e,t)=>(c(),m("footer",Fo,[i("div",Oo,[b(Mo)]),i("div",Yo,[b(Do)])]))}});var Jo=S(Go,[["__scopeId","data-v-5c96fb00"]]);function zo(){const{page:n,theme:e}=R(),t=y(()=>te(pn(n.value.relativePath))),o=y(()=>{const l=wn(e.value.sidebar,t.value);return yn(l)?oe(l):[]}),a=y(()=>o.value.findIndex(l=>l.link===t.value)),s=y(()=>{if(e.value.nextLinks!==!1&&a.value>-1&&a.value<o.value.length-1)return o.value[a.value+1]}),u=y(()=>{if(e.value.prevLinks!==!1&&a.value>0)return o.value[a.value-1]}),h=y(()=>!!s.value||!!u.value);return{next:s,prev:u,hasLinks:h}}const Vo={},Uo={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},Ko=i("path",{d:"M19,11H7.4l5.3-5.3c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-7,7c-0.1,0.1-0.2,0.2-0.2,0.3c-0.1,0.2-0.1,0.5,0,0.8c0.1,0.1,0.1,0.2,0.2,0.3l7,7c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4L7.4,13H19c0.6,0,1-0.4,1-1S19.6,11,19,11z"},null,-1),Xo=[Ko];function Qo(n,e){return c(),m("svg",Uo,Xo)}var Zo=S(Vo,[["render",Qo]]);const na={},ea={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},ta=i("path",{d:"M19.9,12.4c0.1-0.2,0.1-0.5,0-0.8c-0.1-0.1-0.1-0.2-0.2-0.3l-7-7c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l5.3,5.3H5c-0.6,0-1,0.4-1,1s0.4,1,1,1h11.6l-5.3,5.3c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l7-7C19.8,12.6,19.9,12.5,19.9,12.4z"},null,-1),oa=[ta];function aa(n,e){return c(),m("svg",ea,oa)}var sa=S(na,[["render",aa]]);const ra={key:0,class:"next-and-prev-link"},ia={class:"container"},la={class:"prev"},ua=["href"],ca={class:"text"},ha={class:"next"},da=["href"],ma={class:"text"},ga=v({__name:"NextAndPrevLinks",setup(n){const{hasLinks:e,prev:t,next:o}=zo();return(a,s)=>r(e)?(c(),m("div",ra,[i("div",ia,[i("div",la,[r(t)?(c(),m("a",{key:0,class:"link",href:r(E)(r(t).link)},[b(Zo,{class:"icon icon-prev"}),i("span",ca,p(r(t).text),1)],8,ua)):f("",!0)]),i("div",ha,[r(o)?(c(),m("a",{key:0,class:"link",href:r(E)(r(o).link)},[i("span",ma,p(r(o).text),1),b(sa,{class:"icon icon-next"})],8,da)):f("",!0)])])])):f("",!0)}});var pa=S(ga,[["__scopeId","data-v-e65a9748"]]);const fa={class:"page"},ya={class:"container"},va=v({__name:"Page",setup(n){return(e,t)=>{const o=en("Content");return c(),m("main",fa,[i("div",ya,[A(e.$slots,"top",{},void 0,!0),b(o,{class:"content"}),b(Jo),b(pa),A(e.$slots,"bottom",{},void 0,!0)])])}}});var wa=S(va,[["__scopeId","data-v-8fcebc32"]]);const ba={key:0,id:"ads-container"},Sa=v({__name:"Layout",setup(n){const e=$e(()=>Yn(()=>import("./Home.20612d9b.js"),["assets/Home.20612d9b.js","assets/Debug.vue_vue_type_style_index_0_scoped_true_lang.574cb2a8.js","assets/plugin-vue_export-helper.c35c1c54.js","assets/preload-helper.1c052cf7.js","assets/Pagination.7bbf7d94.js"])),t=()=>null,o=t,a=t,s=t,u=O(),{site:h,page:l,theme:d,frontmatter:g}=R(),_=y(()=>!!g.value.customLayout),q=y(()=>!!g.value.home),w=y(()=>Object.keys(h.value.langs).length>1),k=y(()=>{const T=d.value;return g.value.navbar===!1||T.navbar===!1?!1:h.value.title||T.logo||T.repo||T.nav}),I=C(!1),N=y(()=>g.value.home||g.value.sidebar===!1?!1:!kt(wn(d.value.sidebar,u.data.relativePath))),rn=T=>{I.value=typeof T=="boolean"?T:!I.value},ve=rn.bind(null,!1);U(u,ve);const we=y(()=>[{"no-navbar":!k.value,"sidebar-open":I.value,"no-sidebar":!N.value}]);return(T,In)=>{const be=en("Content"),Se=en("Debug");return c(),m(x,null,[i("div",{class:P(["theme",r(we)])},[r(k)?(c(),H(mo,{key:0,onToggle:rn},{search:B(()=>[A(T.$slots,"navbar-search",{},()=>[r(d).algolia?(c(),H(r(s),{key:0,options:r(d).algolia,multilang:r(w)},null,8,["options","multilang"])):f("",!0)])]),_:3})):f("",!0),b(To,{open:I.value},{"sidebar-top":B(()=>[A(T.$slots,"sidebar-top")]),"sidebar-bottom":B(()=>[A(T.$slots,"sidebar-bottom")]),_:3},8,["open"]),i("div",{class:"sidebar-mask",onClick:In[0]||(In[0]=ri=>rn(!1))}),r(_)?(c(),H(be,{key:1})):r(q)?A(T.$slots,"home",{key:2},()=>[b(r(e),null,{hero:B(()=>[A(T.$slots,"home-hero")]),features:B(()=>[A(T.$slots,"home-features")]),footer:B(()=>[A(T.$slots,"home-footer")]),_:3})]):(c(),H(wa,{key:3},{top:B(()=>[A(T.$slots,"page-top-ads",{},()=>[r(d).carbonAds&&r(d).carbonAds.carbon?(c(),m("div",ba,[(c(),H(r(o),{key:"carbon"+r(l).relativePath,code:r(d).carbonAds.carbon,placement:r(d).carbonAds.placement},null,8,["code","placement"]))])):f("",!0)]),A(T.$slots,"page-top")]),bottom:B(()=>[A(T.$slots,"page-bottom"),A(T.$slots,"page-bottom-ads",{},()=>[r(d).carbonAds&&r(d).carbonAds.custom?(c(),H(r(a),{key:"custom"+r(l).relativePath,code:r(d).carbonAds.custom,placement:r(d).carbonAds.placement},null,8,["code","placement"])):f("",!0)])]),_:3}))],2),b(Se)],64)}}}),_a={class:"theme"},ka=i("h1",null,"404",-1),Ia=["href"],Ra=v({__name:"NotFound",setup(n){const{site:e}=R(),t=["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."];function o(){return t[Math.floor(Math.random()*t.length)]}return(a,s)=>(c(),m("div",_a,[ka,i("blockquote",null,p(o()),1),i("a",{href:r(e).base,"aria-label":"go to home"},"Take me home.",8,Ia)]))}}),xa={Layout:Sa,NotFound:Ra};class Ta{constructor(){this.x=50,this.y=50,this.vx=Math.random()*2+2,this.vy=Math.random()*2,this.color="#fff",this.shadowBlur=Math.random()*3,this.shadowX=Math.random()*2-1,this.shadowY=Math.random()*2-1,this.radiusX=Math.random()*3,this.radiusY=Math.random()*3,this.rotation=Math.PI*Math.floor(Math.random()*2)}}class Sn{constructor(e){this.width=300,this.height=300,this.dustQuantity=50,this.dustArr=[];const t=document.getElementById(e);if(t)this.canvas=t,this.ctx=t.getContext("2d"),this.build(),window.addEventListener("resize",()=>this.resize());else throw new Error("canvasID \u65E0\u6548")}build(){if(this.resize(),this.ctx){const e=Sn.getPoint(this.dustQuantity);for(let t of e){const o=new Ta;this.buildDust(t[0],t[1],o),this.dustArr.push(o)}setInterval(()=>{this.play()},40)}}play(){var t;const e=this.dustArr;(t=this.ctx)==null||t.clearRect(0,0,this.width,this.height);for(let o of e)if(o.x<0||o.y<0){const a=this.width,s=Math.floor(Math.random()*window.innerHeight);o.x=a,o.y=s,this.buildDust(a,s,o)}else{const a=o.x-o.vx,s=o.y-o.vy;this.buildDust(a,s,o)}}buildDust(e,t,o){const a=this.ctx;e&&(o.x=e),t&&(o.y=t),a&&(a.beginPath(),a.shadowBlur=o.shadowBlur,a.shadowColor=o.color,a.shadowOffsetX=o.shadowX,a.shadowOffsetY=o.shadowY,a.ellipse(o.x,o.y,o.radiusX,o.radiusY,o.rotation,0,Math.PI*2),a.closePath(),a.fillStyle=o.color,a.fill())}resize(){const e=this.canvas,t=window.innerWidth,o=window.innerHeight;this.width=t,this.height=o,this.dustQuantity=Math.floor((t+o)/38),e!==void 0&&(e.width=t,e.height=o)}static getPoint(e=1){let t=[];for(let o=0;o<e;o++){const a=Math.floor(Math.random()*window.innerWidth),s=Math.floor(Math.random()*window.innerHeight);t.push([a,s])}return t}}const qa=n=>{const e=localStorage.getItem(n);return e&&JSON.parse(e)},On=(n,e)=>{localStorage.setItem(n,JSON.stringify(e))};function Aa(n){let e=n[0];for(let t=1;t<n.length;t++){const o=n[t];o.length>e.length&&(e=o)}return e}function ue(n,e){return Array.from(n).filter(a=>e.test(a.nodeName))}function ce(n,e){let t,o,a=0;return function(){t=this,o=arguments;let s=new Date().valueOf();s-a>e&&(n.apply(t,o),a=s)}}const Ha=n=>{n.forEach(e=>{const t=new Image;t.src=e})};const Ca=v({__name:"BgToggle",props:{bgUrl:String},setup(n){const{theme:e}=R(),t=e.value.bgUrls,o=C(0),a=Le("setBg");an(()=>{a(t[o.value])}),Pe(()=>{Ha(t)}),M(()=>{s()});const s=()=>{const h=qa("bgIdx");h==null?On("bgIdx",o.value):o.value=h},u=()=>{o.value>=t.length-1?o.value=0:o.value++,On("bgIdx",o.value)};return(h,l)=>(c(),m("i",{class:"fa fa-retweet bg-toggle",title:"toggle background",onClick:u}))}});var $a=S(Ca,[["__scopeId","data-v-2dc83b4c"]]);const La=n=>(j("data-v-7d636702"),n=n(),W(),n),Pa={class:"menu-list"},Ea=La(()=>i("a",{href:""},[i("i",{class:"fa fa-navicon"})],-1)),Ma=[Ea],Na=["href"],ja=["title"],Wa=v({__name:"index",setup(n){const{theme:e,page:t}=R(),o=e.value.nav,a=C(!0),s=y(()=>`/${t.value.relativePath.split(".")[0]}`),u=()=>{a.value=!a.value};return(h,l)=>(c(),m("header",null,[i("nav",null,[i("ul",Pa,[i("li",{class:"nav-toggle",onClick:u},Ma),a.value?(c(!0),m(x,{key:0},$(r(o),d=>(c(),m("li",{class:P(d.link===r(s)?"active":"")},[(c(),m("a",{href:d.link,key:d.link},[i("i",{class:P(`fa fa-${d.icon}`),title:d.text},null,10,ja)],8,Na))],2))),256)):f("",!0),i("li",null,[b($a)])])])]))}});var Ba=S(Wa,[["__scopeId","data-v-7d636702"]]);const _n=n=>(j("data-v-19749d0f"),n=n(),W(),n),Da={key:0,class:"aside-wrapper"},Fa={href:"/",class:"logo"},Oa=["src"],Ya={class:"center dr"},Ga={href:"/"},Ja={class:"total"},za=["href"],Va=_n(()=>i("span",{class:"total-title"},"Archives Total",-1)),Ua={class:"total-number"},Ka={class:"total-tags"},Xa=_n(()=>i("span",{class:"total-title"},"Tags:",-1)),Qa={class:"total-number"},Za={class:"total-categories"},ns=_n(()=>i("span",{class:"total-title"},"Categories:",-1)),es={class:"total-number"},ts=v({__name:"index",setup(n){const{site:e,theme:t,frontmatter:o}=R(),a=e.value.title,s=t.value.logo,u=t.value.posts.length,h=Object.keys(t.value.tags).length,l=Object.keys(t.value.cats).length,d=y(()=>o.value.sidebar);return(g,_)=>r(d)?(c(),m("div",Da,[i("aside",null,[i("div",null,[i("a",Fa,[i("img",{src:r(E)(r(s)),alt:"Logo"},null,8,Oa)]),i("h1",Ya,[i("a",Ga,"Dr."+p(r(a)),1)]),i("section",Ja,[i("a",{class:"total-archives",href:r(E)("/pages/archives")},[Va,i("span",Ua,p(r(u)),1)],8,za),i("div",Ka,[Xa,i("span",Qa,p(r(h)),1)]),i("div",Za,[ns,i("span",es,p(r(l)),1)])])])])])):f("",!0)}});var os=S(ts,[["__scopeId","data-v-19749d0f"]]);const as={class:"message-wrapper"},ss=v({__name:"Message",props:{type:{type:String,required:!0},msg:{type:String,required:!0}},setup(n){return(e,t)=>(c(),m("div",as,[i("span",null,p(n.msg.value),1)]))}});var rs=S(ss,[["__scopeId","data-v-716cb212"]]);const Q=D({type:"success",msg:""}),is=(n=Q.type,e,t)=>{Q.type=n,Q.msg=e;const o=ne(rs,{...sn(Q)}).mount(document.createElement("div"));document.body.appendChild(o.$el),setTimeout(()=>{document.body.removeChild(o.$el)},t)},he={success(n,e=1e3){is("success",n,e)},install(n){n.config.globalProperties.message=he}};class ls{constructor(){this.codeEles=document.getElementsByTagName("pre"),Array.from(this.codeEles).forEach(async t=>{const o=document.createElement("i");o.setAttribute("class","btn-copy fa fa-clipboard"),t.appendChild(o),o.addEventListener("click",function(){const a=document.createElement("textarea"),s=o.previousElementSibling;a.value=s.innerText,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),he.success("Copied!")})})}}const us=n=>(j("data-v-4e6f6b2a"),n=n(),W(),n),cs={class:"post-header"},hs={class:"title"},ds={class:"info"},ms={class:"item date",datetime:"2022-01-25T19:21:35.000Z"},gs=us(()=>i("div",{class:"divider"},null,-1)),ps=v({__name:"PostHeader",setup(n){const{frontmatter:e}=R();let t=y(()=>e.value.title),o=y(()=>{const a=e.value.date;return(a?new Date(a).toJSON().split("T")[0]:"").split("-")});return(a,s)=>(c(),m("div",cs,[i("h1",hs,p(r(t)),1),i("div",ds,[i("span",ms,p(r(o)[2])+" / "+p(r(o)[1])+" / "+p(r(o)[0]),1)]),gs]))}});var fs=S(ps,[["__scopeId","data-v-4e6f6b2a"]]);const kn=n=>(j("data-v-f9cae6c6"),n=n(),W(),n),ys={class:"post-footer"},vs=kn(()=>i("span",null,"\u672C\u6587\u4F5C\u8005\uFF1A",-1)),ws=["href"],bs=kn(()=>i("span",null,"\u672C\u6587\u94FE\u63A5\uFF1A",-1)),Ss=["href"],_s=kn(()=>i("li",null,[i("span",null,"\u7248\u6743\u58F0\u660E\uFF1A"),L(" \u672C\u535A\u5BA2\u6240\u6709\u6587\u7AE0\u9664\u7279\u522B\u58F0\u660E\u5916\uFF0C\u5747\u91C7\u7528 "),i("a",{href:"https://creativecommons.org/licenses/by-nc-sa/4.0/",target:"_blank"},"CC BY-NC-SA 4.0"),L(" \u8BB8\u53EF\u534F\u8BAE\uFF0C\u8F6C\u8F7D\u8BF7\u6CE8\u660E\u51FA\u5904\u3002 ")],-1)),ks=v({__name:"PostFooter",setup(n){const{page:e,site:t,frontmatter:o}=R();let a=y(()=>{const s=`${e.value.relativePath.split(".")[0]}.html`;return`${t.value.themeConfig.website}/${s}`});return y(()=>o.value.postFooter),(s,u)=>(c(),m("div",ys,[i("ul",null,[i("li",null,[vs,i("a",{href:r(t).themeConfig.website,target:"_blank"},p(r(t).title),9,ws)]),i("li",null,[bs,i("a",{href:r(a),target:"_blank"},p(r(a)),9,Ss)]),_s])]))}});var Is=S(ks,[["__scopeId","data-v-f9cae6c6"]]);const de=n=>(j("data-v-22a9c1c0"),n=n(),W(),n),Rs={class:"prev-next"},xs=de(()=>i("hr",null,null,-1)),Ts=["href"],qs={key:1},As=["href"],Hs={key:1},Cs=de(()=>i("hr",null,null,-1)),$s=v({__name:"PrevNext",setup(n){const{theme:e,page:t}=R(),o=y(()=>e.value.posts),a=y(()=>t.value.frontmatter.title);let s=D({regularPath:"",frontMatter:{title:""}}),u=D({regularPath:"",frontMatter:{title:""}});const h=(l,d)=>{d?(l.regularPath=d.regularPath,l.frontMatter.title=d.frontMatter.title):(l.regularPath="",l.frontMatter.title="")};return an(()=>{const l=o.value.findIndex(d=>d.frontMatter.title===a.value);if(l>-1){const d=o.value[l-1],g=o.value[l+1];h(s,d),h(u,g)}}),(l,d)=>{var g,_,q,w,k,I;return c(),m("div",Rs,[xs,i("div",null,[dn(i("a",{class:"prev",href:r(E)((g=r(s))==null?void 0:g.regularPath)},[r(e).docFooter.prev.icon?(c(),m("i",{key:0,class:P(`fa fa-${r(e).docFooter.prev.icon}`)},null,2)):f("",!0),r(e).docFooter.prev.text?(c(),m("span",qs,p(r(e).docFooter.prev.text),1)):f("",!0),L(" "+p((q=(_=r(s))==null?void 0:_.frontMatter)==null?void 0:q.title),1)],8,Ts),[[Pn,r(s).regularPath]]),dn(i("a",{class:"next",href:r(E)((w=r(u))==null?void 0:w.regularPath)},[L(p((I=(k=r(u))==null?void 0:k.frontMatter)==null?void 0:I.title)+" ",1),r(e).docFooter.next.icon?(c(),m("i",{key:0,class:P(`fa fa-${r(e).docFooter.next.icon}`)},null,2)):f("",!0),r(e).docFooter.next.text?(c(),m("span",Hs,p(r(e).docFooter.next.text),1)):f("",!0)],8,As),[[Pn,r(u).regularPath]])]),Cs])}}});var Ls=S($s,[["__scopeId","data-v-22a9c1c0"]]);const me=n=>(j("data-v-413ae51b"),n=n(),W(),n),Ps=me(()=>i("i",{class:"fa fa-caret-up"},null,-1)),Es=me(()=>i("p",null,"TOP",-1)),Ms=[Ps,Es],Ns=v({__name:"BackTop",setup(n){const e=C(0),t=y(()=>e.value>300?"block":"none");M(()=>{window.addEventListener("scroll",a)}),K(()=>{window.removeEventListener("scroll",a)});const o=()=>{e.value=document.documentElement.scrollTop},a=ce.bind(this,o,1e3)(),s=()=>{const u=document.documentElement.scrollTop/6,h=setInterval(()=>{document.documentElement.scrollTop=document.documentElement.scrollTop-u,e.value=document.documentElement.scrollTop,e.value<=0&&clearInterval(h)},50)};return(u,h)=>(c(),m("div",{class:"back-top",style:Kn({display:r(t)}),onClick:s},Ms,4))}});var js=S(Ns,[["__scopeId","data-v-413ae51b"]]);function Ws(n="2022-01-01"){const e=new Date(n),t=new Date().getTime()-e.getTime(),o=24*60*60*1e3,a=t/o,s=Math.floor(a),u=(a-s)*24,h=Math.floor(u),l=(u-h)*60,d=Math.floor(l),g=(l-d)*60,_=Math.floor(g);return{day:s,hour:h,minute:d,second:_}}const X=n=>(j("data-v-fef88b9a"),n=n(),W(),n),Bs=X(()=>i("p",null,[L(" Mirror Hosting "),i("a",{href:"https://wonderven.netlify.app/",target:"_blank"},"Netlify")],-1)),Ds={key:0,class:"social-links"},Fs=["href"],Os=X(()=>i("p",null,[L(" Published With "),i("a",{href:"https://vitejs.cn/vitepress/",target:"_blank"},"VitePress"),L(" & "),i("a",{href:"https://github.com/Yue-plus/hexo-theme-arknights",target:"_blank",class:"mr4"},"Arknights"),i("a",{href:"https://travellings.link/",target:"_blank"},[i("i",{class:"fa fa-paper-plane-o",title:"Travellings"})])],-1)),Ys=X(()=>i("i",{class:"fa fa-heartbeat mr4"},null,-1)),Gs=X(()=>i("div",null,[i("span",null,"\xA9"),i("span",null,"2022")],-1)),Js=X(()=>i("div",null,[i("span",null,"ICP"),i("span",null,"\u2014 RHODEISLAND \u2014")],-1)),zs=v({__name:"Footer",setup(n){const{theme:e}=R(),t=C();let o=D({day:0,hour:0,minute:0,second:0}),a=null;M(()=>{e.value.footer.runtime.enable&&(a=setInterval(s,1e3))}),K(()=>{a&&clearInterval(a)});const s=()=>{const u=Ws();o.day=u.day,o.hour=u.hour,o.minute=u.minute,o.second=u.second};return(u,h)=>(c(),m("footer",null,[Bs,r(e).socialLinks.length?(c(),m("p",Ds,[(c(!0),m(x,null,$(r(e).socialLinks,(l,d)=>(c(),m(x,{key:l.link},[i("i",{class:P(`fa fa-${l.icon} mr4`)},null,2),i("a",{href:l.link,target:"_blank"},p(l.text)+" "+p(d===r(e).socialLinks.length-1?"":" | "),9,Fs)],64))),128))])):f("",!0),Os,r(e).footer.runtime.enable?(c(),m("p",{key:1,ref_key:"runtimeRef",ref:t},[Ys,L(" "+p(r(o).day)+" days "+p(r(o).hour)+" hours "+p(r(o).minute)+" minutes and "+p(r(o).second)+" seconds ",1)],512)):f("",!0),r(e).footer.copyright?(c(),m(x,{key:2},[Gs,Js],64)):f("",!0)]))}});var Vs=S(zs,[["__scopeId","data-v-fef88b9a"]]);const ge=/^H[1-6]{1,}$/,Us=n=>{const e=n.childNodes,t=ue(e,ge);return Ks(t)};function Ks(n){const e=[];for(let t=0;t<n.length;t++){const o=n[t],a=/^(_\d{1,})+(-\d{1,})*/ig,s=o.id.match(a)[0];e.push({nodeName:o.nodeName,text:o.innerText.slice(0,o.innerText.length-1),id:o.id,level:s})}return Xs(e)}function Xs(n){const e=[],t={};n.forEach(o=>{t[o.level]=o});for(const o in t)if(Object.prototype.hasOwnProperty.call(t,o)){const a=t[o];if(/^(_\d{1,})+$/ig.test(o))e.push(a);else{const h=Object.keys(t).filter(d=>d!==o&&o.includes(d)),l=Aa(h);t[l].child?t[l].child.push(a):t[l].child=[a]}}return e}const Qs=["href","name","title","onClick"],Zs=v({__name:"CataList",props:{tree:Array},setup(n){const e=t=>{t.open=!t.open,t.active=!0};return(t,o)=>(c(),m("ul",null,[(c(!0),m(x,null,$(n.tree,a=>{var s;return c(),m("li",{key:a.id},[i("a",{href:`#${a.id}`,name:a.id,title:a.text,class:P([[a.nodeName,a.active?"active":""],"link"]),onClick:u=>e(a)},p(a.text),11,Qs),((s=a.child)==null?void 0:s.length)&&a.open?(c(),H(pe,{key:0,tree:a.child},null,8,["tree"])):f("",!0)])}),128))]))}});var pe=S(Zs,[["__scopeId","data-v-33c6374d"]]);const nr={key:0,class:"catalog"},er=v({__name:"index",setup(n){const{frontmatter:e}=R(),t=C(0),o=C(0),a=D({data:[]}),s=D({titleNodes:[],titleMargins:[]});U(e,(w,k)=>{u()},{deep:!0}),M(()=>{u(),window.addEventListener("scroll",l)}),K(()=>{window.removeEventListener("scroll",l)});const u=()=>{var I;const w=(I=document.getElementById("content"))==null?void 0:I.childNodes[0],k=Us(w);a.data=k,o.value=w.getBoundingClientRect().top,g(w)},h=()=>{t.value=document.documentElement.scrollTop,d()},l=ce.bind(this,h,50)(),d=()=>{const w=s.titleMargins;for(let k=0;k<w.length;k++){const I=w[k];if(I.top-t.value>=o.value){q(a.data),_(a.data,I.id);return}}},g=w=>{const k=w.childNodes;s.titleNodes=ue(k,ge);const I=s.titleNodes.map(N=>({id:N.id,top:N.getBoundingClientRect().top}));s.titleMargins=I,d()},_=(w,k)=>{for(let I=0;I<w.length;I++){const N=w[I];if(N.id===k){N.active=!0,N.open=!0;return}N.child&&_(N.child,k)}},q=w=>{for(let k=0;k<w.length;k++){const I=w[k];I.active&&(I.active=!1),I.child&&q(I.child)}};return(w,k)=>a.data.length?(c(),m("div",nr,[b(pe,{tree:a.data},null,8,["tree"])])):f("",!0)}});var tr=S(er,[["__scopeId","data-v-32f802b6"]]);const or={key:1,class:"post-des"},ar=["innerHTML"],sr=["innerHTML"],rr={key:0,class:"post-tag"},ir=i("i",{class:"fa fa-tags"},null,-1),lr=["href"],ur=v({__name:"index",setup(n){const{frontmatter:e}=R(),t=y(()=>e.value.page),o=y(()=>e.value.tags||[]);M(()=>{a()}),Un(()=>{a()});const a=()=>{t.value||new ls};return(s,u)=>{const h=en("Content");return c(),m("div",{class:P(["content",r(t)?"":"post-content"]),id:"postContent"},[r(t)?f("",!0):(c(),H(fs,{key:0})),r(t)?f("",!0):(c(),m("div",or,[typeof r(e).description=="string"?(c(),m("p",{key:0,innerHTML:r(e).description},null,8,ar)):(c(!0),m(x,{key:1},$(r(e).description,l=>(c(),m("p",{key:l,innerHTML:l},null,8,sr))),128))])),b(h,{id:"content"}),r(t)?f("",!0):(c(),m(x,{key:2},[r(o).length?(c(),m("p",rr,[ir,(c(!0),m(x,null,$(r(o),l=>(c(),m("a",{key:l,href:`/pages/archives#tag=${l}`},p(l),9,lr))),128))])):f("",!0),b(Is),b(Ls),b(js),b(tr)],64)),b(Vs)],2)}}}),cr=()=>G("script",{src:"https://cdn.jsdelivr.net/gh/stevenjoezhang/live2d-widget/autoload.js"});const hr={ref:"canvasRef",id:"canvas-dust",width:"1036",height:"228"},dr=v({__name:"App",setup(n){const{theme:e}=R(),t=C("");return Ee("setBg",o=>{t.value=o}),M(()=>{new Sn("canvas-dust")}),(o,a)=>(c(),m(x,null,[i("main",{class:"layout",style:Kn({"background-image":`url(${t.value})`})},[b(os,{class:"aside"}),b(ur,{class:"content"}),b(Ba,{class:"navbar"})],4),r(e).live2d?(c(),H(r(cr),{key:0,class:"l2d-model"})):f("",!0),i("canvas",hr,null,512)],64))}});var mr=S(dr,[["__scopeId","data-v-30a51452"]]);const gr=["href"],pr={class:"post-info"},fr={class:"post-info-categories"},yr=["href"],vr={key:1,href:"#"},wr={class:"post-info-tags"},br=["href"],Sr={key:1,href:"#"},_r={datetime:"2022-01-25T19:21:35.000Z"},kr=["innerHTML"],Ir={class:"post-excerpt"},Rr=["innerHTML"],xr=["innerHTML"],Tr=i("span",{class:"post-btn"},"READ MORE +",-1),qr=v({__name:"PostItem",props:{article:{type:Object,required:!0}},setup(n){return(e,t)=>(c(),m("a",{href:r(E)(n.article.regularPath),class:"post-item"},[i("div",pr,[i("div",null,[i("span",fr,[n.article.frontMatter.category&&n.article.frontMatter.category.length?(c(!0),m(x,{key:0},$(n.article.frontMatter.category,o=>(c(),m("a",{key:o,href:r(E)(`/pages/archives#category=${o}`)},p(o),9,yr))),128)):(c(),m("a",vr,"Empty"))]),i("span",wr,[n.article.frontMatter.tags&&n.article.frontMatter.tags.length?(c(!0),m(x,{key:0},$(n.article.frontMatter.tags,o=>(c(),m("a",{key:o,href:r(E)(`/pages/archives#tag=${o}`)},p(o),9,br))),128)):(c(),m("a",Sr," Empty "))])]),i("time",_r,p(n.article.frontMatter.dateArr[2])+" / "+p(n.article.frontMatter.dateArr[1])+" / "+p(n.article.frontMatter.dateArr[0]),1)]),i("h1",{class:"post-title",innerHTML:n.article.frontMatter.title},null,8,kr),i("div",Ir,[typeof n.article.frontMatter.description=="string"?(c(),m("p",{key:0,innerHTML:n.article.frontMatter.description},null,8,Rr)):(c(!0),m(x,{key:1},$(n.article.frontMatter.description,o=>(c(),m("p",{key:o,innerHTML:o},null,8,xr))),128))]),Tr],8,gr))}});var Ar=[{title:"VitePress \u521B\u5EFA\u6587\u7AE0\u76EE\u5F55",content:`1. \u73AF\u5883
VitePress(Vue3 + TS)
2. \u601D\u8DEF
...
\u8FD4\u56DE\u5BF9\u8C61\u952E\u503C\u5BF9\u3002\u8FD4\u56DE\u503C\uFF1A[][]
`,excerpt:"",url:"/posts\\tech\\javascript\\es6"},{title:"\u56FE\u7247\u9884\u52A0\u8F7D",content:`\u9884\u52A0\u8F7D:\u5728\u9875\u9762\u52A0\u8F7D\u5B8C\u6210\u524D\uFF0C\u63D0\u524D\u52A0\u8F7D\u56FE\u7247\u7B49\u8D44\u6E90\uFF0C\u6709\u5229\u4E8E\u63D0\u9AD8\u7528\u6237\u4F53\u9A8C\u3002
&lt;script setup lang=&quot;ts&quot;&gt;
...
`,excerpt:"",url:"/posts\\tech\\vite\\start"},{title:"\u6D4F\u89C8\u5668\u63D2\u4EF6",content:`1. \u5B89\u88C5\u65B9\u5F0F
...
`,excerpt:"",url:"/posts\\vue\\v3-model"}];const Hr={class:"input-group"},Cr=i("i",{class:"fa fa-search"},null,-1),$r={class:"result"},Lr=["href"],Pr=["innerHTML"],Er=["innerHTML"],Mr={key:0,class:"empty"},Nr=i("i",{class:"fa fa-meh-o"},null,-1),jr=L(" No Data "),Wr=[Nr,jr],Br=v({__name:"Search",setup(n){const{theme:e}=R(),t=C("");let o=D([]);const a=y(()=>!!(o.length||t.value));an(()=>{s(t.value)});function s(l){o.length=0,l.trim()!==""&&Ar.forEach(d=>{const g=JSON.parse(JSON.stringify(d)),_=new RegExp(l,"ig"),q=g.title.match(_),w=g.content.match(_);q&&(g.title=u(l,g.title)),w&&(g.content=u(l,g.content)),(q||w)&&o.push(g)})}const u=(l,d)=>{const g=new RegExp(l,"ig");return d.replace(g,`<span class="search-highlight">${l}</span>`)},h=()=>{t.value=""};return(l,d)=>r(e).search?(c(),m("div",{key:0,class:P(["search-wrapper",r(a)?"open":""])},[i("div",Hr,[Cr,dn(i("input",{type:"text",placeholder:"Search","onUpdate:modelValue":d[0]||(d[0]=g=>t.value=g)},null,512),[[ut,t.value]]),t.value?(c(),m("i",{key:0,class:"fa fa-trash",onClick:h})):f("",!0)]),i("ul",$r,[(c(!0),m(x,null,$(r(o),g=>(c(),m("li",{key:g.title},[i("a",{href:g.url,onClick:h},[i("p",{innerHTML:g.title,class:"title"},null,8,Pr),i("p",{innerHTML:g.content,class:"content"},null,8,Er)],8,Lr)]))),128)),!r(o).length&&t.value!==""?(c(),m("li",Mr,Wr)):f("",!0)])],2)):f("",!0)}}),Dr=v({__name:"PostList",props:{posts:Array},setup(n){const e=C("");return(t,o)=>(c(),m(x,null,[b(Br,{filterKey:e.value,"onUpdate:filterKey":o[0]||(o[0]=a=>e.value=a)},null,8,["filterKey"]),i("div",null,[(c(!0),m(x,null,$(n.posts,(a,s)=>(c(),H(qr,{key:s,article:a},null,8,["article"]))),128))])],64))}}),Fr=v({__name:"index",setup(n){const{theme:e}=R(),t=e.value.posts,o=C(1),a=C(e.value.pageSize),s=y(()=>t.slice(a.value*(o.value-1),a.value*o.value).map(l=>{const d=JSON.parse(JSON.stringify(l)),g=d.frontMatter.date;return d.frontMatter.dateArr=g.split("-"),d})),u=()=>{window.scrollTo(0,0)};return(h,l)=>(c(),m(x,null,[b(Dr,{posts:r(s)},null,8,["posts"]),b(Oe,{pageSize:a.value,pageNum:o.value,"onUpdate:pageNum":l[0]||(l[0]=d=>o.value=d),total:r(e).posts.length,onPagination:u},null,8,["pageSize","pageNum","total"])],64))}});const Or=n=>(j("data-v-072447f6"),n=n(),W(),n),Yr={class:"loading"},Gr={class:"loading-svg hover",width:"100",height:"100",viewBox:"0 0 40 60"},Jr=Or(()=>i("polygon",{class:"triangulo",fill:"none",stroke:"#fff","stroke-width":"1",points:"16,1 32,32 1,32"},null,-1)),zr={class:"text",x:"0",y:"45",fill:"#fff"},Vr=v({__name:"Loading",props:{msg:{type:String,required:!0}},setup(n){return(e,t)=>(c(),m("div",Yr,[(c(),m("svg",Gr,[Jr,i("text",zr,p(n.msg.value),1)]))]))}});var Ur=S(Vr,[["__scopeId","data-v-072447f6"]]);const un=D({msg:"Loading..."});let cn;const fe={show(n=un.msg){un.msg=n,cn=ne(Ur,{...sn(un)}).mount(document.createElement("div")).$el,document.body.appendChild(cn)},hide(){document.body.removeChild(cn)},install(n){n.config.globalProperties.loading=fe}};var on={...xa,Layout:mr,async enhanceApp({app:n,router:e,siteData:t}){n.component("Page",Fr),n.use(fe)}};const hn=new Set,ye=()=>document.createElement("link"),Kr=n=>{const e=ye();e.rel="prefetch",e.href=n,document.head.appendChild(e)},Xr=n=>{const e=new XMLHttpRequest;e.open("GET",n,e.withCredentials=!0),e.send()};let Z;const Qr=J&&(Z=ye())&&Z.relList&&Z.relList.supports&&Z.relList.supports("prefetch")?Kr:Xr;function Zr(){if(!J||!window.IntersectionObserver)return;let n;if((n=navigator.connection)&&(n.saveData||/2g/.test(n.effectiveType)))return;const e=window.requestIdleCallback||setTimeout;let t=null;const o=()=>{t&&t.disconnect(),t=new IntersectionObserver(s=>{s.forEach(u=>{if(u.isIntersecting){const h=u.target;t.unobserve(h);const{pathname:l}=h;if(!hn.has(l)){hn.add(l);const d=Xn(l);Qr(d)}}})}),e(()=>{document.querySelectorAll("#app a").forEach(s=>{const{target:u,hostname:h,pathname:l}=s,d=l.match(/\.\w+$/);d&&d[0]!==".html"||u!=="_blank"&&h===location.hostname&&(l!==location.pathname?t.observe(s):hn.add(l))})})};M(o);const a=O();U(()=>a.path,o),K(()=>{t&&t.disconnect()})}const ni=v({setup(n,{slots:e}){const t=C(!1);return M(()=>{t.value=!0}),()=>t.value&&e.default?e.default():null}}),ei=on.NotFound||(()=>"404 Not Found"),ti={name:"VitePressApp",setup(){const{site:n}=R();return M(()=>{U(()=>n.value.lang,e=>{document.documentElement.lang=e},{immediate:!0})}),Zr(),()=>G(on.Layout)}};function oi(){const n=si(),e=ai();e.provide(je,n);const t=We(n.route);return e.provide(Be,t),J&&mt(n.route,t.site),e.component("Content",De),e.component("ClientOnly",ni),e.component("Debug",()=>null),Object.defineProperty(e.config.globalProperties,"$frontmatter",{get(){return t.frontmatter.value}}),on.enhanceApp&&on.enhanceApp({app:e,router:n,siteData:Fe}),{app:e,router:n}}function ai(){return dt(ti)}function si(){let n=J,e;return Ne(t=>{let o=Xn(t);return n&&(e=o),(n||e===o)&&(o=o.replace(/\.js$/,".lean.js")),J?(n=!1,Yn(()=>import(o),[])):require(o)},ei)}if(J){const{app:n,router:e}=oi();e.go().then(()=>{n.mount("#app")})}export{Wn as N,oi as createApp};
