import{_ as On}from"./preload-helper.1c052cf7.js";import{i as Z,c as _e,a as ke,b as Gn,d as pn,e as Ie,t as Rn,f as Re,g as Te,h as xe,j as Jn,k as Ae,l as Ce,m as He,n as Vn,o as $e,w as on,_ as S,p as y,q as h,r as m,u as i,s as f,v as j,x as p,y as v,z as r,A as an,B as H,C as zn,D as N,E as W,F as $,G as U,H as L,I as x,J as q,K as w,L as C,M as P,N as Un,O as K,P as G,Q as nn,R as qe,S as B,T as Le,U as Me,V as D,W as cn,X as Kn,Y as Pe,Z as Ee}from"./plugin-vue_export-helper.a92e0a4e.js";import{u as I,w as M,a as Y,E as Ne,i as J,p as Xn,c as We,R as je,b as Be,d as De,C as Fe,s as Ye}from"./Debug.vue_vue_type_style_index_0_scoped_true_lang.508716ca.js";import{P as Oe}from"./Pagination.3dd74beb.js";const Ge="http://www.w3.org/2000/svg",F=typeof document!="undefined"?document:null,Tn=F&&F.createElement("template"),Je={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,o)=>{const a=e?F.createElementNS(Ge,n):F.createElement(n,t?{is:t}:void 0);return n==="select"&&o&&o.multiple!=null&&a.setAttribute("multiple",o.multiple),a},createText:n=>F.createTextNode(n),createComment:n=>F.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>F.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},cloneNode(n){const e=n.cloneNode(!0);return"_value"in n&&(e._value=n._value),e},insertStaticContent(n,e,t,o,a,s){const l=t?t.previousSibling:e.lastChild;if(a&&(a===s||a.nextSibling))for(;e.insertBefore(a.cloneNode(!0),t),!(a===s||!(a=a.nextSibling)););else{Tn.innerHTML=o?`<svg>${n}</svg>`:n;const c=Tn.content;if(o){const u=c.firstChild;for(;u.firstChild;)c.appendChild(u.firstChild);c.removeChild(u)}e.insertBefore(c,t)}return[l?l.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}};function Ve(n,e,t){const o=n._vtc;o&&(e=(e?[e,...o]:[...o]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}function ze(n,e,t){const o=n.style,a=Z(t);if(t&&!a){for(const s in t)dn(o,s,t[s]);if(e&&!Z(e))for(const s in e)t[s]==null&&dn(o,s,"")}else{const s=o.display;a?e!==t&&(o.cssText=t):e&&n.removeAttribute("style"),"_vod"in n&&(o.display=s)}}const xn=/\s*!important$/;function dn(n,e,t){if(pn(t))t.forEach(o=>dn(n,e,o));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const o=Ue(n,e);xn.test(t)?n.setProperty(Jn(o),t.replace(xn,""),"important"):n[o]=t}}const An=["Webkit","Moz","ms"],rn={};function Ue(n,e){const t=rn[e];if(t)return t;let o=Ae(e);if(o!=="filter"&&o in n)return rn[e]=o;o=Ce(o);for(let a=0;a<An.length;a++){const s=An[a]+o;if(s in n)return rn[e]=s}return e}const Cn="http://www.w3.org/1999/xlink";function Ke(n,e,t,o,a){if(o&&e.startsWith("xlink:"))t==null?n.removeAttributeNS(Cn,e.slice(6,e.length)):n.setAttributeNS(Cn,e,t);else{const s=He(e);t==null||s&&!Vn(t)?n.removeAttribute(e):n.setAttribute(e,s?"":t)}}function Xe(n,e,t,o,a,s,l){if(e==="innerHTML"||e==="textContent"){o&&l(o,a,s),n[e]=t==null?"":t;return}if(e==="value"&&n.tagName!=="PROGRESS"&&!n.tagName.includes("-")){n._value=t;const u=t==null?"":t;(n.value!==u||n.tagName==="OPTION")&&(n.value=u),t==null&&n.removeAttribute(e);return}let c=!1;if(t===""||t==null){const u=typeof n[e];u==="boolean"?t=Vn(t):t==null&&u==="string"?(t="",c=!0):u==="number"&&(t=0,c=!0)}try{n[e]=t}catch{}c&&n.removeAttribute(e)}const[Qn,Qe]=(()=>{let n=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(n=performance.now.bind(performance));const t=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(t&&Number(t[1])<=53)}return[n,e]})();let mn=0;const Ze=Promise.resolve(),nt=()=>{mn=0},et=()=>mn||(Ze.then(nt),mn=Qn());function O(n,e,t,o){n.addEventListener(e,t,o)}function tt(n,e,t,o){n.removeEventListener(e,t,o)}function ot(n,e,t,o,a=null){const s=n._vei||(n._vei={}),l=s[e];if(o&&l)l.value=o;else{const[c,u]=at(e);if(o){const d=s[e]=st(o,a);O(n,c,d,u)}else l&&(tt(n,c,l,u),s[e]=void 0)}}const Hn=/(?:Once|Passive|Capture)$/;function at(n){let e;if(Hn.test(n)){e={};let o;for(;o=n.match(Hn);)n=n.slice(0,n.length-o[0].length),e[o[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Jn(n.slice(2)),e]}function st(n,e){const t=o=>{const a=o.timeStamp||Qn();(Qe||a>=t.attached-1)&&$e(it(o,t.value),e,5,[o])};return t.value=n,t.attached=et(),t}function it(n,e){if(pn(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(o=>a=>!a._stopped&&o&&o(a))}else return e}const $n=/^on[a-z]/,rt=(n,e,t,o,a=!1,s,l,c,u)=>{e==="class"?Ve(n,o,a):e==="style"?ze(n,t,o):Te(e)?xe(e)||ot(n,e,t,o,l):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):lt(n,e,o,a))?Xe(n,e,o,s,l,c,u):(e==="true-value"?n._trueValue=o:e==="false-value"&&(n._falseValue=o),Ke(n,e,o,a))};function lt(n,e,t,o){return o?!!(e==="innerHTML"||e==="textContent"||e in n&&$n.test(e)&&Gn(t)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA"||$n.test(e)&&Z(t)?!1:e in n}const qn=n=>{const e=n.props["onUpdate:modelValue"]||!1;return pn(e)?t=>Ie(e,t):e};function ut(n){n.target.composing=!0}function Ln(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ht={created(n,{modifiers:{lazy:e,trim:t,number:o}},a){n._assign=qn(a);const s=o||a.props&&a.props.type==="number";O(n,e?"change":"input",l=>{if(l.target.composing)return;let c=n.value;t&&(c=c.trim()),s&&(c=Rn(c)),n._assign(c)}),t&&O(n,"change",()=>{n.value=n.value.trim()}),e||(O(n,"compositionstart",ut),O(n,"compositionend",Ln),O(n,"change",Ln))},mounted(n,{value:e}){n.value=e==null?"":e},beforeUpdate(n,{value:e,modifiers:{lazy:t,trim:o,number:a}},s){if(n._assign=qn(s),n.composing||document.activeElement===n&&n.type!=="range"&&(t||o&&n.value.trim()===e||(a||n.type==="number")&&Rn(n.value)===e))return;const l=e==null?"":e;n.value!==l&&(n.value=l)}},Mn={beforeMount(n,{value:e},{transition:t}){n._vod=n.style.display==="none"?"":n.style.display,t&&e?t.beforeEnter(n):V(n,e)},mounted(n,{value:e},{transition:t}){t&&e&&t.enter(n)},updated(n,{value:e,oldValue:t},{transition:o}){!e!=!t&&(o?e?(o.beforeEnter(n),V(n,!0),o.enter(n)):o.leave(n,()=>{V(n,!1)}):V(n,e))},beforeUnmount(n,{value:e}){V(n,e)}};function V(n,e){n.style.display=e?n._vod:"none"}const Zn=Re({patchProp:rt},Je);let z,Pn=!1;function ct(){return z||(z=ke(Zn))}function dt(){return z=Pn?z:_e(Zn),Pn=!0,z}const ne=(...n)=>{const e=ct().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(!a)return;const s=e._component;!Gn(s)&&!s.render&&!s.template&&(s.template=a.innerHTML),a.innerHTML="";const l=t(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),l},e},mt=(...n)=>{const e=dt().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(a)return t(a,!0,a instanceof SVGElement)},e};function ee(n){return Z(n)?document.querySelector(n):n}function gt(n,e){let t=[],o=!0;const a=s=>{if(o){o=!1;return}const l=[],c=Math.min(t.length,s.length);for(let u=0;u<c;u++){let d=t[u];const[g,_,A=""]=s[u];if(d.tagName.toLocaleLowerCase()===g){for(const b in _)d.getAttribute(b)!==_[b]&&d.setAttribute(b,_[b]);for(let b=0;b<d.attributes.length;b++){const k=d.attributes[b].name;k in _||d.removeAttribute(k)}d.innerHTML!==A&&(d.innerHTML=A)}else document.head.removeChild(d),d=En(s[u]),document.head.append(d);l.push(d)}t.slice(c).forEach(u=>document.head.removeChild(u)),s.slice(c).forEach(u=>{const d=En(u);document.head.appendChild(d),l.push(d)}),t=l};on(()=>{const s=n.data,l=e.value,c=s&&s.title,u=s&&s.description,d=s&&s.frontmatter.head;document.title=(c?c+" | ":"")+l.title,document.querySelector("meta[name=description]").setAttribute("content",u||l.description),a([...d?ft(d):[]])})}function En([n,e,t]){const o=document.createElement(n);for(const a in e)o.setAttribute(a,e[a]);return t&&(o.innerHTML=t),o}function pt(n){return n[0]==="meta"&&n[1]&&n[1].name==="description"}function ft(n){return n.filter(e=>!pt(e))}const yt=/#.*$/,vt=/(index)?\.(md|html)$/,en=/\/$/,wt=/^[a-z]+:/i;function fn(n){return Array.isArray(n)}function yn(n){return wt.test(n)}function bt(n,e){if(e===void 0)return!1;const t=Nn(`/${n.data.relativePath}`),o=Nn(e);return t===o}function Nn(n){return decodeURI(n).replace(yt,"").replace(vt,"")}function St(n,e){const t=n.endsWith("/"),o=e.startsWith("/");return t&&o?n.slice(0,-1)+e:!t&&!o?`${n}/${e}`:n+e}function gn(n){return/^\//.test(n)?n:`/${n}`}function te(n){return n.replace(/(index)?(\.(md|html))?$/,"")||"/"}function _t(n){return n===!1||n==="auto"||fn(n)}function kt(n){return n.children!==void 0}function It(n){return fn(n)?n.length===0:!n}function vn(n,e){if(_t(n))return n;e=gn(e);for(const t in n)if(e.startsWith(gn(t)))return n[t];return"auto"}function oe(n){return n.reduce((e,t)=>(t.link&&e.push({text:t.text,link:te(t.link)}),kt(t)&&(e=[...e,...oe(t.children)]),e),[])}const Rt=["href","aria-label"],Tt=["src"],xt=y({__name:"NavBarTitle",setup(n){const{site:e,theme:t,localePath:o}=I();return(a,s)=>(h(),m("a",{class:"nav-bar-title",href:i(o),"aria-label":`${i(e).title}, back to home`},[i(t).logo?(h(),m("img",{key:0,class:"logo",src:i(M)(i(t).logo),alt:"Logo"},null,8,Tt)):f("",!0),j(" "+p(i(e).title),1)],8,Rt))}});var At=S(xt,[["__scopeId","data-v-7ac13a1e"]]);function Ct(){const{site:n,localePath:e,theme:t}=I();return v(()=>{const o=n.value.langs,a=Object.keys(o);if(a.length<2)return null;const l=Y().path.replace(e.value,""),c=a.map(d=>({text:o[d].label,link:`${d}${l}`}));return{text:t.value.selectText||"Languages",items:c}})}const Ht=["GitHub","GitLab","Bitbucket"].map(n=>[n,new RegExp(n,"i")]);function $t(){const{site:n}=I();return v(()=>{const e=n.value.themeConfig,t=e.docsRepo||e.repo;if(!t)return null;const o=qt(t);return{text:Lt(o,e.repoLabel),link:o}})}function qt(n){return Ne.test(n)?n:`https://github.com/${n}`}function Lt(n,e){if(e)return e;const t=n.match(/^https?:\/\/[^/]+/);if(!t)return"Source";const o=Ht.find(([a,s])=>s.test(t[0]));return o&&o[0]?o[0]:"Source"}function ae(n){const e=Y(),t=yn(n.value.link);return{props:v(()=>{const a=Wn(`/${e.data.relativePath}`);let s=!1;if(n.value.activeMatch)s=new RegExp(n.value.activeMatch).test(a);else{const l=Wn(n.value.link);s=l==="/"?l===a:a.startsWith(l)}return{class:{active:s,isExternal:t},href:t?n.value.link:M(n.value.link),target:n.value.target||(t?"_blank":null),rel:n.value.rel||(t?"noopener noreferrer":null),"aria-label":n.value.ariaLabel}}),isExternal:t}}function Wn(n){return n.replace(/#.*$/,"").replace(/\?.*$/,"").replace(/\.(html|md)$/,"").replace(/\/index$/,"/")}const Mt={},Pt={class:"icon outbound",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",x:"0px",y:"0px",viewBox:"0 0 100 100",width:"15",height:"15"},Et=r("path",{fill:"currentColor",d:"M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"},null,-1),Nt=r("polygon",{fill:"currentColor",points:"45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"},null,-1),Wt=[Et,Nt];function jt(n,e){return h(),m("svg",Pt,Wt)}var wn=S(Mt,[["render",jt]]);const Bt={class:"nav-link"},Dt=y({__name:"NavLink",props:{item:null},setup(n){const t=an(n),{props:o,isExternal:a}=ae(t.item);return(s,l)=>(h(),m("div",Bt,[r("a",zn({class:"item"},i(o)),[j(p(n.item.text)+" ",1),i(a)?(h(),H(wn,{key:0})):f("",!0)],16)]))}});var jn=S(Dt,[["__scopeId","data-v-49fe041d"]]);const Ft=n=>(N("data-v-07381bdb"),n=n(),W(),n),Yt={class:"nav-dropdown-link-item"},Ot=Ft(()=>r("span",{class:"arrow"},null,-1)),Gt={class:"text"},Jt={class:"icon"},Vt=y({__name:"NavDropdownLinkItem",props:{item:null},setup(n){const t=an(n),{props:o,isExternal:a}=ae(t.item);return(s,l)=>(h(),m("div",Yt,[r("a",zn({class:"item"},i(o)),[Ot,r("span",Gt,p(n.item.text),1),r("span",Jt,[i(a)?(h(),H(wn,{key:0})):f("",!0)])],16)]))}});var zt=S(Vt,[["__scopeId","data-v-07381bdb"]]);const Ut=["aria-label"],Kt={class:"button-text"},Xt={class:"dialog"},Qt=y({__name:"NavDropdownLink",props:{item:null},setup(n){const e=Y(),t=$(!1);U(()=>e.path,()=>{t.value=!1});function o(){t.value=!t.value}return(a,s)=>(h(),m("div",{class:L(["nav-dropdown-link",{open:t.value}])},[r("button",{class:"button","aria-label":n.item.ariaLabel,onClick:o},[r("span",Kt,p(n.item.text),1),r("span",{class:L(["button-arrow",t.value?"down":"right"])},null,2)],8,Ut),r("ul",Xt,[(h(!0),m(x,null,q(n.item.items,l=>(h(),m("li",{key:l.text,class:"dialog-item"},[w(zt,{item:l},null,8,["item"])]))),128))])],2))}});var Bn=S(Qt,[["__scopeId","data-v-18d75f62"]]);const Zt={key:0,class:"nav-links"},no={key:1,class:"item"},eo={key:2,class:"item"},to=y({__name:"NavLinks",setup(n){const{theme:e}=I(),t=Ct(),o=$t(),a=v(()=>e.value.nav||o.value||t.value);return(s,l)=>i(a)?(h(),m("nav",Zt,[i(e).nav?(h(!0),m(x,{key:0},q(i(e).nav,c=>(h(),m("div",{key:c.text,class:"item"},[c.items?(h(),H(Bn,{key:0,item:c},null,8,["item"])):(h(),H(jn,{key:1,item:c},null,8,["item"]))]))),128)):f("",!0),i(t)?(h(),m("div",no,[w(Bn,{item:i(t)},null,8,["item"])])):f("",!0),i(o)?(h(),m("div",eo,[w(jn,{item:i(o)},null,8,["item"])])):f("",!0)])):f("",!0)}});var se=S(to,[["__scopeId","data-v-35b91e7e"]]);const oo={emits:["toggle"]},ao=r("svg",{class:"icon",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",role:"img",viewBox:"0 0 448 512"},[r("path",{fill:"currentColor",d:"M436 124H12c-6.627 0-12-5.373-12-12V80c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12z",class:""})],-1),so=[ao];function io(n,e,t,o,a,s){return h(),m("div",{class:"sidebar-button",onClick:e[0]||(e[0]=l=>n.$emit("toggle"))},so)}var ro=S(oo,[["render",io]]);const lo=n=>(N("data-v-40587210"),n=n(),W(),n),uo={class:"nav-bar"},ho=lo(()=>r("div",{class:"flex-grow"},null,-1)),co={class:"nav"},mo=y({__name:"NavBar",emits:["toggle"],setup(n){return(e,t)=>(h(),m("header",uo,[w(ro,{onToggle:t[0]||(t[0]=o=>e.$emit("toggle"))}),w(At),ho,r("div",co,[w(se)]),C(e.$slots,"search",{},void 0,!0)]))}});var go=S(mo,[["__scopeId","data-v-40587210"]]);function po(){let n=null,e=null;const t=bo(o,300);function o(){const l=fo(),c=yo(l);for(let u=0;u<c.length;u++){const d=c[u],g=c[u+1],[_,A]=wo(u,d,g);if(_){history.replaceState(null,document.title,A||" "),a(A);return}}}function a(l){if(s(e),s(n),e=document.querySelector(`.sidebar a[href="${l}"]`),!e)return;e.classList.add("active");const c=e.closest(".sidebar-links > ul > li");c&&c!==e.parentElement?(n=c.querySelector("a"),n&&n.classList.add("active")):n=null}function s(l){l&&l.classList.remove("active")}P(()=>{o(),window.addEventListener("scroll",t)}),Un(()=>{a(decodeURIComponent(location.hash))}),K(()=>{window.removeEventListener("scroll",t)})}function fo(){return[].slice.call(document.querySelectorAll(".sidebar a.sidebar-link-item"))}function yo(n){return[].slice.call(document.querySelectorAll(".header-anchor")).filter(e=>n.some(t=>t.hash===e.hash))}function vo(){return document.querySelector(".nav-bar").offsetHeight}function Dn(n){const e=vo();return n.parentElement.offsetTop-e-15}function wo(n,e,t){const o=window.scrollY;return n===0&&o===0?[!0,null]:o<Dn(e)?[!1,null]:!t||o<Dn(t)?[!0,decodeURIComponent(e.hash)]:[!1,null]}function bo(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),o=!0,setTimeout(()=>{o=!1},e))}}function So(){const n=Y(),{site:e}=I();return po(),v(()=>{const t=n.data.headers,o=n.data.frontmatter.sidebar,a=n.data.frontmatter.sidebarDepth;if(o===!1)return[];if(o==="auto")return Fn(t,a);const s=vn(e.value.themeConfig.sidebar,n.data.relativePath);return s===!1?[]:s==="auto"?Fn(t,a):s})}function Fn(n,e){const t=[];if(n===void 0)return[];let o;return n.forEach(({level:a,title:s,slug:l})=>{if(a-1>e)return;const c={text:s,link:`#${l}`};a===2?(o=c,t.push(c)):o&&(o.children||(o.children=[])).push(c)}),t}const ie=n=>{const e=Y(),{site:t,frontmatter:o}=I(),a=n.depth||1,s=o.value.sidebarDepth||1/0,l=e.data.headers,c=n.item.text,u=_o(t.value.base,n.item.link),d=n.item.children,g=bt(e,n.item.link),_=a<s?re(g,d,l,a+1):null;return G("li",{class:"sidebar-link"},[G(u?"a":"p",{class:{"sidebar-link-item":!0,active:g},href:u},c),_])};function _o(n,e){return e===void 0||e.startsWith("#")?e:St(n,e)}function re(n,e,t,o=1){return e&&e.length>0?G("ul",{class:"sidebar-links"},e.map(a=>G(ie,{item:a,depth:o}))):n&&t?re(!1,ko(t),void 0,o):null}function ko(n){return le(Io(n))}function Io(n){n=n.map(t=>Object.assign({},t));let e;return n.forEach(t=>{t.level===2?e=t:e&&(e.children||(e.children=[])).push(t)}),n.filter(t=>t.level===2)}function le(n){return n.map(e=>({text:e.title,link:`#${e.slug}`,children:e.children?le(e.children):void 0}))}const Ro={key:0,class:"sidebar-links"},To=y({__name:"SideBarLinks",setup(n){const e=So();return(t,o)=>i(e).length>0?(h(),m("ul",Ro,[(h(!0),m(x,null,q(i(e),a=>(h(),H(i(ie),{item:a},null,8,["item"]))),256))])):f("",!0)}});const xo=y({__name:"SideBar",props:{open:{type:Boolean}},setup(n){return(e,t)=>(h(),m("aside",{class:L(["sidebar",{open:n.open}])},[w(se,{class:"nav"}),C(e.$slots,"sidebar-top",{},void 0,!0),w(To),C(e.$slots,"sidebar-bottom",{},void 0,!0)],2))}});var Ao=S(xo,[["__scopeId","data-v-17c48e2f"]]);const Co=/bitbucket.org/;function Ho(){const{page:n,theme:e,frontmatter:t}=I(),o=v(()=>{const{repo:s,docsDir:l="",docsBranch:c="master",docsRepo:u=s,editLinks:d}=e.value,g=t.value.editLink!=null?t.value.editLink:d,{relativePath:_}=n.value;return!g||!_||!s?null:$o(s,u,l,c,_)}),a=v(()=>e.value.editLinkText||"Edit this page");return{url:o,text:a}}function $o(n,e,t,o,a){return Co.test(n)?Lo(n,e,t,o,a):qo(n,e,t,o,a)}function qo(n,e,t,o,a){return(yn(e)?e:`https://github.com/${e}`).replace(en,"")+`/edit/${o}/`+(t?t.replace(en,"")+"/":"")+a}function Lo(n,e,t,o,a){return(yn(e)?e:n).replace(en,"")+`/src/${o}/`+(t?t.replace(en,"")+"/":"")+a+`?mode=edit&spa=0&at=${o}&fileviewer=file-view-default`}const Mo={class:"edit-link"},Po=["href"],Eo=y({__name:"EditLink",setup(n){const{url:e,text:t}=Ho();return(o,a)=>(h(),m("div",Mo,[i(e)?(h(),m("a",{key:0,class:"link",href:i(e),target:"_blank",rel:"noopener noreferrer"},[j(p(i(t))+" ",1),w(wn,{class:"icon"})],8,Po)):f("",!0)]))}});var No=S(Eo,[["__scopeId","data-v-55695e90"]]);const Wo={key:0,class:"last-updated"},jo={class:"prefix"},Bo={class:"datetime"},Do=y({__name:"LastUpdated",setup(n){const{theme:e,page:t}=I(),o=v(()=>{const l=e.value.lastUpdated;return l!==void 0&&l!==!1}),a=v(()=>{const l=e.value.lastUpdated;return l===!0?"Last Updated":l}),s=$("");return P(()=>{s.value=new Date(t.value.lastUpdated).toLocaleString("en-US")}),(l,c)=>i(o)?(h(),m("p",Wo,[r("span",jo,p(i(a))+":",1),r("span",Bo,p(s.value),1)])):f("",!0)}});var Fo=S(Do,[["__scopeId","data-v-30c3cbb4"]]);const Yo={class:"page-footer"},Oo={class:"edit"},Go={class:"updated"},Jo=y({__name:"PageFooter",setup(n){return(e,t)=>(h(),m("footer",Yo,[r("div",Oo,[w(No)]),r("div",Go,[w(Fo)])]))}});var Vo=S(Jo,[["__scopeId","data-v-5c96fb00"]]);function zo(){const{page:n,theme:e}=I(),t=v(()=>te(gn(n.value.relativePath))),o=v(()=>{const u=vn(e.value.sidebar,t.value);return fn(u)?oe(u):[]}),a=v(()=>o.value.findIndex(u=>u.link===t.value)),s=v(()=>{if(e.value.nextLinks!==!1&&a.value>-1&&a.value<o.value.length-1)return o.value[a.value+1]}),l=v(()=>{if(e.value.prevLinks!==!1&&a.value>0)return o.value[a.value-1]}),c=v(()=>!!s.value||!!l.value);return{next:s,prev:l,hasLinks:c}}const Uo={},Ko={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},Xo=r("path",{d:"M19,11H7.4l5.3-5.3c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-7,7c-0.1,0.1-0.2,0.2-0.2,0.3c-0.1,0.2-0.1,0.5,0,0.8c0.1,0.1,0.1,0.2,0.2,0.3l7,7c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4L7.4,13H19c0.6,0,1-0.4,1-1S19.6,11,19,11z"},null,-1),Qo=[Xo];function Zo(n,e){return h(),m("svg",Ko,Qo)}var na=S(Uo,[["render",Zo]]);const ea={},ta={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},oa=r("path",{d:"M19.9,12.4c0.1-0.2,0.1-0.5,0-0.8c-0.1-0.1-0.1-0.2-0.2-0.3l-7-7c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l5.3,5.3H5c-0.6,0-1,0.4-1,1s0.4,1,1,1h11.6l-5.3,5.3c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l7-7C19.8,12.6,19.9,12.5,19.9,12.4z"},null,-1),aa=[oa];function sa(n,e){return h(),m("svg",ta,aa)}var ia=S(ea,[["render",sa]]);const ra={key:0,class:"next-and-prev-link"},la={class:"container"},ua={class:"prev"},ha=["href"],ca={class:"text"},da={class:"next"},ma=["href"],ga={class:"text"},pa=y({__name:"NextAndPrevLinks",setup(n){const{hasLinks:e,prev:t,next:o}=zo();return(a,s)=>i(e)?(h(),m("div",ra,[r("div",la,[r("div",ua,[i(t)?(h(),m("a",{key:0,class:"link",href:i(M)(i(t).link)},[w(na,{class:"icon icon-prev"}),r("span",ca,p(i(t).text),1)],8,ha)):f("",!0)]),r("div",da,[i(o)?(h(),m("a",{key:0,class:"link",href:i(M)(i(o).link)},[r("span",ga,p(i(o).text),1),w(ia,{class:"icon icon-next"})],8,ma)):f("",!0)])])])):f("",!0)}});var fa=S(pa,[["__scopeId","data-v-e65a9748"]]);const ya={class:"page"},va={class:"container"},wa=y({__name:"Page",setup(n){return(e,t)=>{const o=nn("Content");return h(),m("main",ya,[r("div",va,[C(e.$slots,"top",{},void 0,!0),w(o,{class:"content"}),w(Vo),w(fa),C(e.$slots,"bottom",{},void 0,!0)])])}}});var ba=S(wa,[["__scopeId","data-v-8fcebc32"]]);const Sa={key:0,id:"ads-container"},_a=y({__name:"Layout",setup(n){const e=qe(()=>On(()=>import("./Home.4c8fd896.js"),["assets/Home.4c8fd896.js","assets/Debug.vue_vue_type_style_index_0_scoped_true_lang.508716ca.js","assets/plugin-vue_export-helper.a92e0a4e.js","assets/preload-helper.1c052cf7.js","assets/Pagination.3dd74beb.js"])),t=()=>null,o=t,a=t,s=t,l=Y(),{site:c,page:u,theme:d,frontmatter:g}=I(),_=v(()=>!!g.value.customLayout),A=v(()=>!!g.value.home),b=v(()=>Object.keys(c.value.langs).length>1),k=v(()=>{const T=d.value;return g.value.navbar===!1||T.navbar===!1?!1:c.value.title||T.logo||T.repo||T.nav}),R=$(!1),E=v(()=>g.value.home||g.value.sidebar===!1?!1:!It(vn(d.value.sidebar,l.data.relativePath))),sn=T=>{R.value=typeof T=="boolean"?T:!R.value},ve=sn.bind(null,!1);U(l,ve);const we=v(()=>[{"no-navbar":!k.value,"sidebar-open":R.value,"no-sidebar":!E.value}]);return(T,In)=>{const be=nn("Content"),Se=nn("Debug");return h(),m(x,null,[r("div",{class:L(["theme",i(we)])},[i(k)?(h(),H(go,{key:0,onToggle:sn},{search:B(()=>[C(T.$slots,"navbar-search",{},()=>[i(d).algolia?(h(),H(i(s),{key:0,options:i(d).algolia,multilang:i(b)},null,8,["options","multilang"])):f("",!0)])]),_:3})):f("",!0),w(Ao,{open:R.value},{"sidebar-top":B(()=>[C(T.$slots,"sidebar-top")]),"sidebar-bottom":B(()=>[C(T.$slots,"sidebar-bottom")]),_:3},8,["open"]),r("div",{class:"sidebar-mask",onClick:In[0]||(In[0]=ur=>sn(!1))}),i(_)?(h(),H(be,{key:1})):i(A)?C(T.$slots,"home",{key:2},()=>[w(i(e),null,{hero:B(()=>[C(T.$slots,"home-hero")]),features:B(()=>[C(T.$slots,"home-features")]),footer:B(()=>[C(T.$slots,"home-footer")]),_:3})]):(h(),H(ba,{key:3},{top:B(()=>[C(T.$slots,"page-top-ads",{},()=>[i(d).carbonAds&&i(d).carbonAds.carbon?(h(),m("div",Sa,[(h(),H(i(o),{key:"carbon"+i(u).relativePath,code:i(d).carbonAds.carbon,placement:i(d).carbonAds.placement},null,8,["code","placement"]))])):f("",!0)]),C(T.$slots,"page-top")]),bottom:B(()=>[C(T.$slots,"page-bottom"),C(T.$slots,"page-bottom-ads",{},()=>[i(d).carbonAds&&i(d).carbonAds.custom?(h(),H(i(a),{key:"custom"+i(u).relativePath,code:i(d).carbonAds.custom,placement:i(d).carbonAds.placement},null,8,["code","placement"])):f("",!0)])]),_:3}))],2),w(Se)],64)}}}),ka={class:"theme"},Ia=r("h1",null,"404",-1),Ra=["href"],Ta=y({__name:"NotFound",setup(n){const{site:e}=I(),t=["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."];function o(){return t[Math.floor(Math.random()*t.length)]}return(a,s)=>(h(),m("div",ka,[Ia,r("blockquote",null,p(o()),1),r("a",{href:i(e).base,"aria-label":"go to home"},"Take me home.",8,Ra)]))}}),xa={Layout:_a,NotFound:Ta};class Aa{constructor(){this.x=50,this.y=50,this.vx=Math.random()*2+2,this.vy=Math.random()*2,this.color="#fff",this.shadowBlur=Math.random()*3,this.shadowX=Math.random()*2-1,this.shadowY=Math.random()*2-1,this.radiusX=Math.random()*3,this.radiusY=Math.random()*3,this.rotation=Math.PI*Math.floor(Math.random()*2)}}class bn{constructor(e){this.width=300,this.height=300,this.dustQuantity=50,this.dustArr=[];const t=document.getElementById(e);if(t)this.canvas=t,this.ctx=t.getContext("2d"),this.build(),window.addEventListener("resize",()=>this.resize());else throw new Error("canvasID \u65E0\u6548")}build(){if(this.resize(),this.ctx){const e=bn.getPoint(this.dustQuantity);for(let t of e){const o=new Aa;this.buildDust(t[0],t[1],o),this.dustArr.push(o)}setInterval(()=>{this.play()},40)}}play(){var t;const e=this.dustArr;(t=this.ctx)==null||t.clearRect(0,0,this.width,this.height);for(let o of e)if(o.x<0||o.y<0){const a=this.width,s=Math.floor(Math.random()*window.innerHeight);o.x=a,o.y=s,this.buildDust(a,s,o)}else{const a=o.x-o.vx,s=o.y-o.vy;this.buildDust(a,s,o)}}buildDust(e,t,o){const a=this.ctx;e&&(o.x=e),t&&(o.y=t),a&&(a.beginPath(),a.shadowBlur=o.shadowBlur,a.shadowColor=o.color,a.shadowOffsetX=o.shadowX,a.shadowOffsetY=o.shadowY,a.ellipse(o.x,o.y,o.radiusX,o.radiusY,o.rotation,0,Math.PI*2),a.closePath(),a.fillStyle=o.color,a.fill())}resize(){const e=this.canvas,t=window.innerWidth,o=window.innerHeight;this.width=t,this.height=o,this.dustQuantity=Math.floor((t+o)/38),e!==void 0&&(e.width=t,e.height=o)}static getPoint(e=1){let t=[];for(let o=0;o<e;o++){const a=Math.floor(Math.random()*window.innerWidth),s=Math.floor(Math.random()*window.innerHeight);t.push([a,s])}return t}}const Ca=n=>{const e=localStorage.getItem(n);return e&&JSON.parse(e)},Yn=(n,e)=>{localStorage.setItem(n,JSON.stringify(e))};function Ha(n){let e=n[0];for(let t=1;t<n.length;t++){const o=n[t];o.length>e.length&&(e=o)}return e}function ue(n,e){return Array.from(n).filter(a=>e.test(a.nodeName))}function he(n,e){let t,o,a=0;return function(){t=this,o=arguments;let s=new Date().valueOf();s-a>e&&(n.apply(t,o),a=s)}}const $a=n=>{n.forEach(e=>{const t=new Image;t.src=e})};const qa=y({__name:"BgToggle",props:{bgUrl:String},setup(n){const{theme:e}=I(),t=e.value.bgUrls,o=$(0),a=Le("setBg");on(()=>{a(t[o.value])}),Me(()=>{$a(t)}),P(()=>{s()});const s=()=>{const c=Ca("bgIdx");c==null?Yn("bgIdx",o.value):o.value=c},l=()=>{o.value>=t.length-1?o.value=0:o.value++,Yn("bgIdx",o.value)};return(c,u)=>(h(),m("i",{class:"fa fa-retweet bg-toggle",title:"toggle background",onClick:l}))}});var La=S(qa,[["__scopeId","data-v-2dc83b4c"]]);const Ma=n=>(N("data-v-7d636702"),n=n(),W(),n),Pa={class:"menu-list"},Ea=Ma(()=>r("a",{href:""},[r("i",{class:"fa fa-navicon"})],-1)),Na=[Ea],Wa=["href"],ja=["title"],Ba=y({__name:"index",setup(n){const{theme:e,page:t}=I(),o=e.value.nav,a=$(!0),s=v(()=>`/${t.value.relativePath.split(".")[0]}`),l=()=>{a.value=!a.value};return(c,u)=>(h(),m("header",null,[r("nav",null,[r("ul",Pa,[r("li",{class:"nav-toggle",onClick:l},Na),a.value?(h(!0),m(x,{key:0},q(i(o),d=>(h(),m("li",{class:L(d.link===i(s)?"active":"")},[(h(),m("a",{href:d.link,key:d.link},[r("i",{class:L(`fa fa-${d.icon}`),title:d.text},null,10,ja)],8,Wa))],2))),256)):f("",!0),r("li",null,[w(La)])])])]))}});var Da=S(Ba,[["__scopeId","data-v-7d636702"]]);const Fa={key:0,class:"social-links"},Ya=["href"],Oa=["title"],Ga=y({__name:"SocialLinks",setup(n){const{theme:e}=I();return(t,o)=>i(e).socialLinks.length?(h(),m("div",Fa,[(h(!0),m(x,null,q(i(e).socialLinks,a=>(h(),m("a",{key:a.link,href:a.link,target:"_blank"},[r("i",{class:L(`fa fa-${a.icon}`),title:a.text},null,10,Oa)],8,Ya))),128))])):f("",!0)}});var Ja=S(Ga,[["__scopeId","data-v-1c971fe0"]]);const Sn=n=>(N("data-v-1d916c1f"),n=n(),W(),n),Va={key:0,class:"aside-wrapper"},za={href:"/",class:"logo"},Ua=["src"],Ka={class:"center dr"},Xa={href:"/"},Qa={class:"total"},Za=["href"],ns=Sn(()=>r("span",{class:"total-title"},"Archives Total",-1)),es={class:"total-number"},ts={class:"total-tags"},os=Sn(()=>r("span",{class:"total-title"},"Tags:",-1)),as={class:"total-number"},ss={class:"total-categories"},is=Sn(()=>r("span",{class:"total-title"},"Categories:",-1)),rs={class:"total-number"},ls=y({__name:"index",setup(n){const{site:e,theme:t,frontmatter:o}=I(),a=e.value.title,s=t.value.logo,l=t.value.posts.length,c=Object.keys(t.value.tags).length,u=Object.keys(t.value.cats).length,d=v(()=>o.value.sidebar);return(g,_)=>i(d)?(h(),m("div",Va,[r("aside",null,[r("div",null,[r("a",za,[r("img",{src:i(M)(i(s)),alt:"Logo"},null,8,Ua)]),r("h1",Ka,[r("a",Xa,"Dr."+p(i(a)),1)]),r("section",Qa,[r("a",{class:"total-archives",href:i(M)("/pages/archives")},[ns,r("span",es,p(i(l)),1)],8,Za),r("div",ts,[os,r("span",as,p(i(c)),1)]),r("div",ss,[is,r("span",rs,p(i(u)),1)])]),w(Ja)])])])):f("",!0)}});var us=S(ls,[["__scopeId","data-v-1d916c1f"]]);const hs={class:"message-wrapper"},cs=y({__name:"Message",props:{type:{type:String,required:!0},msg:{type:String,required:!0}},setup(n){return(e,t)=>(h(),m("div",hs,[r("span",null,p(n.msg.value),1)]))}});var ds=S(cs,[["__scopeId","data-v-716cb212"]]);const X=D({type:"success",msg:""}),ms=(n=X.type,e,t)=>{X.type=n,X.msg=e;const o=ne(ds,{...an(X)}).mount(document.createElement("div"));document.body.appendChild(o.$el),setTimeout(()=>{document.body.removeChild(o.$el)},t)},ce={success(n,e=1e3){ms("success",n,e)},install(n){n.config.globalProperties.message=ce}};class gs{constructor(){this.codeEles=document.getElementsByTagName("pre"),Array.from(this.codeEles).forEach(async t=>{const o=document.createElement("i");o.setAttribute("class","btn-copy fa fa-clipboard"),t.appendChild(o),o.addEventListener("click",function(){const a=document.createElement("textarea"),s=o.previousElementSibling;a.value=s.innerText,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),ce.success("Copied!")})})}}const ps=n=>(N("data-v-4e6f6b2a"),n=n(),W(),n),fs={class:"post-header"},ys={class:"title"},vs={class:"info"},ws={class:"item date",datetime:"2022-01-25T19:21:35.000Z"},bs=ps(()=>r("div",{class:"divider"},null,-1)),Ss=y({__name:"PostHeader",setup(n){const{frontmatter:e}=I();let t=v(()=>e.value.title),o=v(()=>{const a=e.value.date;return(a?new Date(a).toJSON().split("T")[0]:"").split("-")});return(a,s)=>(h(),m("div",fs,[r("h1",ys,p(i(t)),1),r("div",vs,[r("span",ws,p(i(o)[2])+" / "+p(i(o)[1])+" / "+p(i(o)[0]),1)]),bs]))}});var _s=S(Ss,[["__scopeId","data-v-4e6f6b2a"]]);const _n=n=>(N("data-v-f9cae6c6"),n=n(),W(),n),ks={class:"post-footer"},Is=_n(()=>r("span",null,"\u672C\u6587\u4F5C\u8005\uFF1A",-1)),Rs=["href"],Ts=_n(()=>r("span",null,"\u672C\u6587\u94FE\u63A5\uFF1A",-1)),xs=["href"],As=_n(()=>r("li",null,[r("span",null,"\u7248\u6743\u58F0\u660E\uFF1A"),j(" \u672C\u535A\u5BA2\u6240\u6709\u6587\u7AE0\u9664\u7279\u522B\u58F0\u660E\u5916\uFF0C\u5747\u91C7\u7528 "),r("a",{href:"https://creativecommons.org/licenses/by-nc-sa/4.0/",target:"_blank"},"CC BY-NC-SA 4.0"),j(" \u8BB8\u53EF\u534F\u8BAE\uFF0C\u8F6C\u8F7D\u8BF7\u6CE8\u660E\u51FA\u5904\u3002 ")],-1)),Cs=y({__name:"PostFooter",setup(n){const{page:e,site:t,frontmatter:o}=I();let a=v(()=>{const s=`${e.value.relativePath.split(".")[0]}.html`;return`${t.value.themeConfig.website}/${s}`});return v(()=>o.value.postFooter),(s,l)=>(h(),m("div",ks,[r("ul",null,[r("li",null,[Is,r("a",{href:i(t).themeConfig.website,target:"_blank"},p(i(t).title),9,Rs)]),r("li",null,[Ts,r("a",{href:i(a),target:"_blank"},p(i(a)),9,xs)]),As])]))}});var Hs=S(Cs,[["__scopeId","data-v-f9cae6c6"]]);const de=n=>(N("data-v-22a9c1c0"),n=n(),W(),n),$s={class:"prev-next"},qs=de(()=>r("hr",null,null,-1)),Ls=["href"],Ms={key:1},Ps=["href"],Es={key:1},Ns=de(()=>r("hr",null,null,-1)),Ws=y({__name:"PrevNext",setup(n){const{theme:e,page:t}=I(),o=v(()=>e.value.posts),a=v(()=>t.value.frontmatter.title);let s=D({regularPath:"",frontMatter:{title:""}}),l=D({regularPath:"",frontMatter:{title:""}});const c=(u,d)=>{d?(u.regularPath=d.regularPath,u.frontMatter.title=d.frontMatter.title):(u.regularPath="",u.frontMatter.title="")};return on(()=>{const u=o.value.findIndex(d=>d.frontMatter.title===a.value);if(u>-1){const d=o.value[u-1],g=o.value[u+1];c(s,d),c(l,g)}}),(u,d)=>{var g,_,A,b,k,R;return h(),m("div",$s,[qs,r("div",null,[cn(r("a",{class:"prev",href:i(M)((g=i(s))==null?void 0:g.regularPath)},[i(e).docFooter.prev.icon?(h(),m("i",{key:0,class:L(`fa fa-${i(e).docFooter.prev.icon}`)},null,2)):f("",!0),i(e).docFooter.prev.text?(h(),m("span",Ms,p(i(e).docFooter.prev.text),1)):f("",!0),j(" "+p((A=(_=i(s))==null?void 0:_.frontMatter)==null?void 0:A.title),1)],8,Ls),[[Mn,i(s).regularPath]]),cn(r("a",{class:"next",href:i(M)((b=i(l))==null?void 0:b.regularPath)},[j(p((R=(k=i(l))==null?void 0:k.frontMatter)==null?void 0:R.title)+" ",1),i(e).docFooter.next.icon?(h(),m("i",{key:0,class:L(`fa fa-${i(e).docFooter.next.icon}`)},null,2)):f("",!0),i(e).docFooter.next.text?(h(),m("span",Es,p(i(e).docFooter.next.text),1)):f("",!0)],8,Ps),[[Mn,i(l).regularPath]])]),Ns])}}});var js=S(Ws,[["__scopeId","data-v-22a9c1c0"]]);const me=n=>(N("data-v-413ae51b"),n=n(),W(),n),Bs=me(()=>r("i",{class:"fa fa-caret-up"},null,-1)),Ds=me(()=>r("p",null,"TOP",-1)),Fs=[Bs,Ds],Ys=y({__name:"BackTop",setup(n){const e=$(0),t=v(()=>e.value>300?"block":"none");P(()=>{window.addEventListener("scroll",a)}),K(()=>{window.removeEventListener("scroll",a)});const o=()=>{e.value=document.documentElement.scrollTop},a=he.bind(this,o,1e3)(),s=()=>{const l=document.documentElement.scrollTop/6,c=setInterval(()=>{document.documentElement.scrollTop=document.documentElement.scrollTop-l,e.value=document.documentElement.scrollTop,e.value<=0&&clearInterval(c)},50)};return(l,c)=>(h(),m("div",{class:"back-top",style:Kn({display:i(t)}),onClick:s},Fs,4))}});var Os=S(Ys,[["__scopeId","data-v-413ae51b"]]);function Gs(n="2022-01-01"){const e=new Date(n),t=new Date().getTime()-e.getTime(),o=24*60*60*1e3,a=t/o,s=Math.floor(a),l=(a-s)*24,c=Math.floor(l),u=(l-c)*60,d=Math.floor(u),g=(u-d)*60,_=Math.floor(g);return{day:s,hour:c,minute:d,second:_}}const kn=n=>(N("data-v-514ed06b"),n=n(),W(),n),Js=kn(()=>r("i",{class:"fa fa-heartbeat mr4"},null,-1)),Vs=Pe('<p data-v-514ed06b> Published With <a href="https://vitejs.cn/vitepress/" target="_blank" data-v-514ed06b>VitePress</a> &amp; <a href="https://github.com/Yue-plus/hexo-theme-arknights" target="_blank" class="mr4" data-v-514ed06b>Arknights</a><a href="https://travellings.link/" target="_blank" data-v-514ed06b><i class="fa fa-paper-plane-o" title="Travellings" data-v-514ed06b></i></a></p><p data-v-514ed06b> Mirror Hosting <a href="https://wonderven.netlify.app/" target="_blank" data-v-514ed06b>Netlify</a></p>',2),zs=kn(()=>r("div",null,[r("span",null,"\xA9"),r("span",null,"2021 to 2022")],-1)),Us=kn(()=>r("div",null,[r("span",null,"ICP"),r("span",null,"\u2014 RHODEISLAND \u2014")],-1)),Ks=y({__name:"Footer",setup(n){const{theme:e}=I(),t=$();let o=D({day:0,hour:0,minute:0,second:0}),a=null;P(()=>{e.value.footer.runtime.enable&&(a=setInterval(s,1e3))}),K(()=>{a&&clearInterval(a)});const s=()=>{const l=Gs();o.day=l.day,o.hour=l.hour,o.minute=l.minute,o.second=l.second};return(l,c)=>(h(),m("footer",null,[i(e).footer.runtime.enable?(h(),m("p",{key:0,ref_key:"runtimeRef",ref:t},[Js,j(" "+p(i(o).day)+" days "+p(i(o).hour)+" hours "+p(i(o).minute)+" minutes and "+p(i(o).second)+" seconds ",1)],512)):f("",!0),Vs,i(e).footer.copyright?(h(),m(x,{key:1},[zs,Us],64)):f("",!0)]))}});var Xs=S(Ks,[["__scopeId","data-v-514ed06b"]]);const ge=/^H[1-6]{1,}$/,Qs=n=>{const e=n.childNodes,t=ue(e,ge);return Zs(t)};function Zs(n){const e=[];for(let t=0;t<n.length;t++){const o=n[t],a=/^(_\d{1,})+(-\d{1,})*/ig,s=o.id.match(a)[0];e.push({nodeName:o.nodeName,text:o.innerText.slice(0,o.innerText.length-1),id:o.id,level:s})}return ni(e)}function ni(n){const e=[],t={};n.forEach(o=>{t[o.level]=o});for(const o in t)if(Object.prototype.hasOwnProperty.call(t,o)){const a=t[o];if(/^(_\d{1,})+$/ig.test(o))e.push(a);else{const c=Object.keys(t).filter(d=>d!==o&&o.includes(d)),u=Ha(c);t[u].child?t[u].child.push(a):t[u].child=[a]}}return e}const ei=["href","name","title","onClick"],ti=y({__name:"CataList",props:{tree:Array},setup(n){const e=t=>{t.open=!t.open,t.active=!0};return(t,o)=>(h(),m("ul",null,[(h(!0),m(x,null,q(n.tree,a=>{var s;return h(),m("li",{key:a.id},[r("a",{href:`#${a.id}`,name:a.id,title:a.text,class:L([[a.nodeName,a.active?"active":""],"link"]),onClick:l=>e(a)},p(a.text),11,ei),((s=a.child)==null?void 0:s.length)&&a.open?(h(),H(pe,{key:0,tree:a.child},null,8,["tree"])):f("",!0)])}),128))]))}});var pe=S(ti,[["__scopeId","data-v-33c6374d"]]);const oi={key:0,class:"catalog"},ai=y({__name:"index",setup(n){const{frontmatter:e}=I(),t=$(0),o=$(0),a=D({data:[]}),s=D({titleNodes:[],titleMargins:[]});U(e,(b,k)=>{l()},{deep:!0}),P(()=>{l(),window.addEventListener("scroll",u)}),K(()=>{window.removeEventListener("scroll",u)});const l=()=>{var R;const b=(R=document.getElementById("content"))==null?void 0:R.childNodes[0],k=Qs(b);a.data=k,o.value=b.getBoundingClientRect().top,g(b)},c=()=>{t.value=document.documentElement.scrollTop,d()},u=he.bind(this,c,50)(),d=()=>{const b=s.titleMargins;for(let k=0;k<b.length;k++){const R=b[k];if(R.top-t.value>=o.value){A(a.data),_(a.data,R.id);return}}},g=b=>{const k=b.childNodes;s.titleNodes=ue(k,ge);const R=s.titleNodes.map(E=>({id:E.id,top:E.getBoundingClientRect().top}));s.titleMargins=R,d()},_=(b,k)=>{for(let R=0;R<b.length;R++){const E=b[R];if(E.id===k){E.active=!0,E.open=!0;return}E.child&&_(E.child,k)}},A=b=>{for(let k=0;k<b.length;k++){const R=b[k];R.active&&(R.active=!1),R.child&&A(R.child)}};return(b,k)=>a.data.length?(h(),m("div",oi,[w(pe,{tree:a.data},null,8,["tree"])])):f("",!0)}});var si=S(ai,[["__scopeId","data-v-32f802b6"]]);const ii={key:1,class:"post-des"},ri=["innerHTML"],li=["innerHTML"],ui={key:0,class:"post-tag"},hi=r("i",{class:"fa fa-tags"},null,-1),ci=["href"],di=y({__name:"index",setup(n){const{frontmatter:e}=I(),t=v(()=>e.value.page),o=v(()=>e.value.tags||[]);P(()=>{a()}),Un(()=>{a()});const a=()=>{t.value||new gs};return(s,l)=>{const c=nn("Content");return h(),m("div",{class:L(["content",i(t)?"":"post-content"]),id:"postContent"},[i(t)?f("",!0):(h(),H(_s,{key:0})),i(t)?f("",!0):(h(),m("div",ii,[typeof i(e).description=="string"?(h(),m("p",{key:0,innerHTML:i(e).description},null,8,ri)):(h(!0),m(x,{key:1},q(i(e).description,u=>(h(),m("p",{key:u,innerHTML:u},null,8,li))),128))])),w(c,{id:"content"}),i(t)?f("",!0):(h(),m(x,{key:2},[i(o).length?(h(),m("p",ui,[hi,(h(!0),m(x,null,q(i(o),u=>(h(),m("a",{key:u,href:`/pages/archives#tag=${u}`},p(u),9,ci))),128))])):f("",!0),w(Hs),w(js),w(Os),w(si)],64)),w(Xs)],2)}}}),mi=()=>G("script",{src:"https://cdn.jsdelivr.net/gh/stevenjoezhang/live2d-widget/autoload.js"});const gi={ref:"canvasRef",id:"canvas-dust",width:"1036",height:"228"},pi=y({__name:"App",setup(n){const{theme:e}=I(),t=$("");return Ee("setBg",o=>{t.value=o}),P(()=>{new bn("canvas-dust")}),(o,a)=>(h(),m(x,null,[r("main",{class:"layout",style:Kn({"background-image":`url(${t.value})`})},[w(us,{class:"aside"}),w(di,{class:"content"}),w(Da,{class:"navbar"})],4),i(e).live2d?(h(),H(i(mi),{key:0,class:"l2d-model"})):f("",!0),r("canvas",gi,null,512)],64))}});var fi=S(pi,[["__scopeId","data-v-30a51452"]]);const yi=["href"],vi={class:"post-info"},wi={class:"post-info-categories"},bi=["href"],Si={key:1,href:"#"},_i={class:"post-info-tags"},ki=["href"],Ii={key:1,href:"#"},Ri={datetime:"2022-01-25T19:21:35.000Z"},Ti=["innerHTML"],xi={class:"post-excerpt"},Ai=["innerHTML"],Ci=["innerHTML"],Hi=r("span",{class:"post-btn"},"READ MORE +",-1),$i=y({__name:"PostItem",props:{article:{type:Object,required:!0}},setup(n){return(e,t)=>(h(),m("a",{href:i(M)(n.article.regularPath),class:"post-item"},[r("div",vi,[r("div",null,[r("span",wi,[n.article.frontMatter.category&&n.article.frontMatter.category.length?(h(!0),m(x,{key:0},q(n.article.frontMatter.category,o=>(h(),m("a",{key:o,href:i(M)(`/pages/archives#category=${o}`)},p(o),9,bi))),128)):(h(),m("a",Si,"Empty"))]),r("span",_i,[n.article.frontMatter.tags&&n.article.frontMatter.tags.length?(h(!0),m(x,{key:0},q(n.article.frontMatter.tags,o=>(h(),m("a",{key:o,href:i(M)(`/pages/archives#tag=${o}`)},p(o),9,ki))),128)):(h(),m("a",Ii," Empty "))])]),r("time",Ri,p(n.article.frontMatter.dateArr[2])+" / "+p(n.article.frontMatter.dateArr[1])+" / "+p(n.article.frontMatter.dateArr[0]),1)]),r("h1",{class:"post-title",innerHTML:n.article.frontMatter.title},null,8,Ti),r("div",xi,[typeof n.article.frontMatter.description=="string"?(h(),m("p",{key:0,innerHTML:n.article.frontMatter.description},null,8,Ai)):(h(!0),m(x,{key:1},q(n.article.frontMatter.description,o=>(h(),m("p",{key:o,innerHTML:o},null,8,Ci))),128))]),Hi],8,yi))}});var qi=[{title:"VitePress \u521B\u5EFA\u6587\u7AE0\u76EE\u5F55",content:`1. \u73AF\u5883
VitePress(Vue3 + TS)
2. \u601D\u8DEF
...
For aesthetics, we mostly adopt the history mode.
...
`,excerpt:"",url:"/posts\\Vue\\VueRouter\\route-mode"}];const Li={class:"input-group"},Mi=r("i",{class:"fa fa-search"},null,-1),Pi={class:"result"},Ei=["href"],Ni=["innerHTML"],Wi=["innerHTML"],ji={key:0,class:"empty"},Bi=r("i",{class:"fa fa-meh-o"},null,-1),Di=j(" No Data "),Fi=[Bi,Di],Yi=y({__name:"Search",setup(n){const{theme:e}=I(),t=$("");let o=D([]);const a=v(()=>!!(o.length||t.value));on(()=>{s(t.value)});function s(u){o.length=0,u.trim()!==""&&qi.forEach(d=>{const g=JSON.parse(JSON.stringify(d)),_=new RegExp(u,"ig"),A=g.title.match(_),b=g.content.match(_);A&&(g.title=l(u,g.title)),b&&(g.content=l(u,g.content)),(A||b)&&o.push(g)})}const l=(u,d)=>{const g=new RegExp(u,"ig");return d.replace(g,`<span class="search-highlight">${u}</span>`)},c=()=>{t.value=""};return(u,d)=>i(e).search?(h(),m("div",{key:0,class:L(["search-wrapper",i(a)?"open":""])},[r("div",Li,[Mi,cn(r("input",{type:"text",placeholder:"Search","onUpdate:modelValue":d[0]||(d[0]=g=>t.value=g)},null,512),[[ht,t.value]]),t.value?(h(),m("i",{key:0,class:"fa fa-trash",onClick:c})):f("",!0)]),r("ul",Pi,[(h(!0),m(x,null,q(i(o),g=>(h(),m("li",{key:g.title},[r("a",{href:g.url,onClick:c},[r("p",{innerHTML:g.title,class:"title"},null,8,Ni),r("p",{innerHTML:g.content,class:"content"},null,8,Wi)],8,Ei)]))),128)),!i(o).length&&t.value!==""?(h(),m("li",ji,Fi)):f("",!0)])],2)):f("",!0)}}),Oi=y({__name:"PostList",props:{posts:Array},setup(n){const e=$("");return(t,o)=>(h(),m(x,null,[w(Yi,{filterKey:e.value,"onUpdate:filterKey":o[0]||(o[0]=a=>e.value=a)},null,8,["filterKey"]),r("div",null,[(h(!0),m(x,null,q(n.posts,(a,s)=>(h(),H($i,{key:s,article:a},null,8,["article"]))),128))])],64))}}),Gi=y({__name:"index",setup(n){const{theme:e}=I(),t=e.value.posts,o=$(1),a=$(e.value.pageSize),s=v(()=>t.slice(a.value*(o.value-1),a.value*o.value).map(u=>{const d=JSON.parse(JSON.stringify(u)),g=d.frontMatter.date;return d.frontMatter.dateArr=g.split("-"),d})),l=()=>{window.scrollTo(0,0)};return(c,u)=>(h(),m(x,null,[w(Oi,{posts:i(s)},null,8,["posts"]),w(Oe,{pageSize:a.value,pageNum:o.value,"onUpdate:pageNum":u[0]||(u[0]=d=>o.value=d),total:i(e).posts.length,onPagination:l},null,8,["pageSize","pageNum","total"])],64))}});const Ji=n=>(N("data-v-072447f6"),n=n(),W(),n),Vi={class:"loading"},zi={class:"loading-svg hover",width:"100",height:"100",viewBox:"0 0 40 60"},Ui=Ji(()=>r("polygon",{class:"triangulo",fill:"none",stroke:"#fff","stroke-width":"1",points:"16,1 32,32 1,32"},null,-1)),Ki={class:"text",x:"0",y:"45",fill:"#fff"},Xi=y({__name:"Loading",props:{msg:{type:String,required:!0}},setup(n){return(e,t)=>(h(),m("div",Vi,[(h(),m("svg",zi,[Ui,r("text",Ki,p(n.msg.value),1)]))]))}});var Qi=S(Xi,[["__scopeId","data-v-072447f6"]]);const ln=D({msg:"Loading..."});let un;const fe={show(n=ln.msg){ln.msg=n,un=ne(Qi,{...an(ln)}).mount(document.createElement("div")).$el,document.body.appendChild(un)},hide(){document.body.removeChild(un)},install(n){n.config.globalProperties.loading=fe}};var tn={...xa,Layout:fi,async enhanceApp({app:n,router:e,siteData:t}){n.component("Page",Gi),n.use(fe)}};const hn=new Set,ye=()=>document.createElement("link"),Zi=n=>{const e=ye();e.rel="prefetch",e.href=n,document.head.appendChild(e)},nr=n=>{const e=new XMLHttpRequest;e.open("GET",n,e.withCredentials=!0),e.send()};let Q;const er=J&&(Q=ye())&&Q.relList&&Q.relList.supports&&Q.relList.supports("prefetch")?Zi:nr;function tr(){if(!J||!window.IntersectionObserver)return;let n;if((n=navigator.connection)&&(n.saveData||/2g/.test(n.effectiveType)))return;const e=window.requestIdleCallback||setTimeout;let t=null;const o=()=>{t&&t.disconnect(),t=new IntersectionObserver(s=>{s.forEach(l=>{if(l.isIntersecting){const c=l.target;t.unobserve(c);const{pathname:u}=c;if(!hn.has(u)){hn.add(u);const d=Xn(u);er(d)}}})}),e(()=>{document.querySelectorAll("#app a").forEach(s=>{const{target:l,hostname:c,pathname:u}=s,d=u.match(/\.\w+$/);d&&d[0]!==".html"||l!=="_blank"&&c===location.hostname&&(u!==location.pathname?t.observe(s):hn.add(u))})})};P(o);const a=Y();U(()=>a.path,o),K(()=>{t&&t.disconnect()})}const or=y({setup(n,{slots:e}){const t=$(!1);return P(()=>{t.value=!0}),()=>t.value&&e.default?e.default():null}}),ar=tn.NotFound||(()=>"404 Not Found"),sr={name:"VitePressApp",setup(){const{site:n}=I();return P(()=>{U(()=>n.value.lang,e=>{document.documentElement.lang=e},{immediate:!0})}),tr(),()=>G(tn.Layout)}};function ir(){const n=lr(),e=rr();e.provide(je,n);const t=Be(n.route);return e.provide(De,t),J&&gt(n.route,t.site),e.component("Content",Fe),e.component("ClientOnly",or),e.component("Debug",()=>null),Object.defineProperty(e.config.globalProperties,"$frontmatter",{get(){return t.frontmatter.value}}),tn.enhanceApp&&tn.enhanceApp({app:e,router:n,siteData:Ye}),{app:e,router:n}}function rr(){return mt(sr)}function lr(){let n=J,e;return We(t=>{let o=Xn(t);return n&&(e=o),(n||e===o)&&(o=o.replace(/\.js$/,".lean.js")),J?(n=!1,On(()=>import(o),[])):require(o)},ar)}if(J){const{app:n,router:e}=ir();e.go().then(()=>{n.mount("#app")})}export{jn as N,ir as createApp};
