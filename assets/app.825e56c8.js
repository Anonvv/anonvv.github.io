import{_ as Yn}from"./preload-helper.1c052cf7.js";import{i as Z,c as _e,a as ke,b as Gn,d as fn,e as Ie,t as Rn,f as Re,g as xe,h as Te,j as Jn,k as qe,l as Ae,m as Ce,n as zn,o as He,w as on,_ as S,p as w,q as c,r as m,u as r,s as f,v as $,x as p,y,z as i,A as an,B as C,C as Vn,D as N,E as W,F as H,G as U,H as j,I as T,J as L,K as b,L as A,M as E,N as Un,O as K,P as G,Q as nn,R as $e,S as B,T as Le,U as je,V as D,W as dn,X as Kn,Y as Pe}from"./plugin-vue_export-helper.c35c1c54.js";import{u as R,w as P,a as F,E as Ee,i as J,p as Xn,c as Me,R as Ne,b as We,d as Be,C as De,s as Oe}from"./Debug.vue_vue_type_style_index_0_scoped_true_lang.1370bc6a.js";import{P as Fe}from"./Pagination.7bbf7d94.js";const Ye="http://www.w3.org/2000/svg",O=typeof document!="undefined"?document:null,xn=O&&O.createElement("template"),Ge={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,o)=>{const a=e?O.createElementNS(Ye,n):O.createElement(n,t?{is:t}:void 0);return n==="select"&&o&&o.multiple!=null&&a.setAttribute("multiple",o.multiple),a},createText:n=>O.createTextNode(n),createComment:n=>O.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>O.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},cloneNode(n){const e=n.cloneNode(!0);return"_value"in n&&(e._value=n._value),e},insertStaticContent(n,e,t,o,a,s){const u=t?t.previousSibling:e.lastChild;if(a&&(a===s||a.nextSibling))for(;e.insertBefore(a.cloneNode(!0),t),!(a===s||!(a=a.nextSibling)););else{xn.innerHTML=o?`<svg>${n}</svg>`:n;const h=xn.content;if(o){const l=h.firstChild;for(;l.firstChild;)h.appendChild(l.firstChild);h.removeChild(l)}e.insertBefore(h,t)}return[u?u.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}};function Je(n,e,t){const o=n._vtc;o&&(e=(e?[e,...o]:[...o]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}function ze(n,e,t){const o=n.style,a=Z(t);if(t&&!a){for(const s in t)mn(o,s,t[s]);if(e&&!Z(e))for(const s in e)t[s]==null&&mn(o,s,"")}else{const s=o.display;a?e!==t&&(o.cssText=t):e&&n.removeAttribute("style"),"_vod"in n&&(o.display=s)}}const Tn=/\s*!important$/;function mn(n,e,t){if(fn(t))t.forEach(o=>mn(n,e,o));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const o=Ve(n,e);Tn.test(t)?n.setProperty(Jn(o),t.replace(Tn,""),"important"):n[o]=t}}const qn=["Webkit","Moz","ms"],ln={};function Ve(n,e){const t=ln[e];if(t)return t;let o=qe(e);if(o!=="filter"&&o in n)return ln[e]=o;o=Ae(o);for(let a=0;a<qn.length;a++){const s=qn[a]+o;if(s in n)return ln[e]=s}return e}const An="http://www.w3.org/1999/xlink";function Ue(n,e,t,o,a){if(o&&e.startsWith("xlink:"))t==null?n.removeAttributeNS(An,e.slice(6,e.length)):n.setAttributeNS(An,e,t);else{const s=Ce(e);t==null||s&&!zn(t)?n.removeAttribute(e):n.setAttribute(e,s?"":t)}}function Ke(n,e,t,o,a,s,u){if(e==="innerHTML"||e==="textContent"){o&&u(o,a,s),n[e]=t==null?"":t;return}if(e==="value"&&n.tagName!=="PROGRESS"&&!n.tagName.includes("-")){n._value=t;const l=t==null?"":t;(n.value!==l||n.tagName==="OPTION")&&(n.value=l),t==null&&n.removeAttribute(e);return}let h=!1;if(t===""||t==null){const l=typeof n[e];l==="boolean"?t=zn(t):t==null&&l==="string"?(t="",h=!0):l==="number"&&(t=0,h=!0)}try{n[e]=t}catch{}h&&n.removeAttribute(e)}const[Qn,Xe]=(()=>{let n=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(n=performance.now.bind(performance));const t=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(t&&Number(t[1])<=53)}return[n,e]})();let gn=0;const Qe=Promise.resolve(),Ze=()=>{gn=0},nt=()=>gn||(Qe.then(Ze),gn=Qn());function Y(n,e,t,o){n.addEventListener(e,t,o)}function et(n,e,t,o){n.removeEventListener(e,t,o)}function tt(n,e,t,o,a=null){const s=n._vei||(n._vei={}),u=s[e];if(o&&u)u.value=o;else{const[h,l]=ot(e);if(o){const d=s[e]=at(o,a);Y(n,h,d,l)}else u&&(et(n,h,u,l),s[e]=void 0)}}const Cn=/(?:Once|Passive|Capture)$/;function ot(n){let e;if(Cn.test(n)){e={};let o;for(;o=n.match(Cn);)n=n.slice(0,n.length-o[0].length),e[o[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):Jn(n.slice(2)),e]}function at(n,e){const t=o=>{const a=o.timeStamp||Qn();(Xe||a>=t.attached-1)&&He(st(o,t.value),e,5,[o])};return t.value=n,t.attached=nt(),t}function st(n,e){if(fn(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(o=>a=>!a._stopped&&o&&o(a))}else return e}const Hn=/^on[a-z]/,rt=(n,e,t,o,a=!1,s,u,h,l)=>{e==="class"?Je(n,o,a):e==="style"?ze(n,t,o):xe(e)?Te(e)||tt(n,e,t,o,u):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):it(n,e,o,a))?Ke(n,e,o,s,u,h,l):(e==="true-value"?n._trueValue=o:e==="false-value"&&(n._falseValue=o),Ue(n,e,o,a))};function it(n,e,t,o){return o?!!(e==="innerHTML"||e==="textContent"||e in n&&Hn.test(e)&&Gn(t)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA"||Hn.test(e)&&Z(t)?!1:e in n}const $n=n=>{const e=n.props["onUpdate:modelValue"]||!1;return fn(e)?t=>Ie(e,t):e};function lt(n){n.target.composing=!0}function Ln(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ut={created(n,{modifiers:{lazy:e,trim:t,number:o}},a){n._assign=$n(a);const s=o||a.props&&a.props.type==="number";Y(n,e?"change":"input",u=>{if(u.target.composing)return;let h=n.value;t&&(h=h.trim()),s&&(h=Rn(h)),n._assign(h)}),t&&Y(n,"change",()=>{n.value=n.value.trim()}),e||(Y(n,"compositionstart",lt),Y(n,"compositionend",Ln),Y(n,"change",Ln))},mounted(n,{value:e}){n.value=e==null?"":e},beforeUpdate(n,{value:e,modifiers:{lazy:t,trim:o,number:a}},s){if(n._assign=$n(s),n.composing||document.activeElement===n&&n.type!=="range"&&(t||o&&n.value.trim()===e||(a||n.type==="number")&&Rn(n.value)===e))return;const u=e==null?"":e;n.value!==u&&(n.value=u)}},jn={beforeMount(n,{value:e},{transition:t}){n._vod=n.style.display==="none"?"":n.style.display,t&&e?t.beforeEnter(n):z(n,e)},mounted(n,{value:e},{transition:t}){t&&e&&t.enter(n)},updated(n,{value:e,oldValue:t},{transition:o}){!e!=!t&&(o?e?(o.beforeEnter(n),z(n,!0),o.enter(n)):o.leave(n,()=>{z(n,!1)}):z(n,e))},beforeUnmount(n,{value:e}){z(n,e)}};function z(n,e){n.style.display=e?n._vod:"none"}const Zn=Re({patchProp:rt},Ge);let V,Pn=!1;function ct(){return V||(V=ke(Zn))}function ht(){return V=Pn?V:_e(Zn),Pn=!0,V}const ne=(...n)=>{const e=ct().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(!a)return;const s=e._component;!Gn(s)&&!s.render&&!s.template&&(s.template=a.innerHTML),a.innerHTML="";const u=t(a,!1,a instanceof SVGElement);return a instanceof Element&&(a.removeAttribute("v-cloak"),a.setAttribute("data-v-app","")),u},e},dt=(...n)=>{const e=ht().createApp(...n),{mount:t}=e;return e.mount=o=>{const a=ee(o);if(a)return t(a,!0,a instanceof SVGElement)},e};function ee(n){return Z(n)?document.querySelector(n):n}function mt(n,e){let t=[],o=!0;const a=s=>{if(o){o=!1;return}const u=[],h=Math.min(t.length,s.length);for(let l=0;l<h;l++){let d=t[l];const[g,_,q=""]=s[l];if(d.tagName.toLocaleLowerCase()===g){for(const v in _)d.getAttribute(v)!==_[v]&&d.setAttribute(v,_[v]);for(let v=0;v<d.attributes.length;v++){const k=d.attributes[v].name;k in _||d.removeAttribute(k)}d.innerHTML!==q&&(d.innerHTML=q)}else document.head.removeChild(d),d=En(s[l]),document.head.append(d);u.push(d)}t.slice(h).forEach(l=>document.head.removeChild(l)),s.slice(h).forEach(l=>{const d=En(l);document.head.appendChild(d),u.push(d)}),t=u};on(()=>{const s=n.data,u=e.value,h=s&&s.title,l=s&&s.description,d=s&&s.frontmatter.head;document.title=(h?h+" | ":"")+u.title,document.querySelector("meta[name=description]").setAttribute("content",l||u.description),a([...d?pt(d):[]])})}function En([n,e,t]){const o=document.createElement(n);for(const a in e)o.setAttribute(a,e[a]);return t&&(o.innerHTML=t),o}function gt(n){return n[0]==="meta"&&n[1]&&n[1].name==="description"}function pt(n){return n.filter(e=>!gt(e))}const ft=/#.*$/,yt=/(index)?\.(md|html)$/,en=/\/$/,wt=/^[a-z]+:/i;function yn(n){return Array.isArray(n)}function wn(n){return wt.test(n)}function vt(n,e){if(e===void 0)return!1;const t=Mn(`/${n.data.relativePath}`),o=Mn(e);return t===o}function Mn(n){return decodeURI(n).replace(ft,"").replace(yt,"")}function bt(n,e){const t=n.endsWith("/"),o=e.startsWith("/");return t&&o?n.slice(0,-1)+e:!t&&!o?`${n}/${e}`:n+e}function pn(n){return/^\//.test(n)?n:`/${n}`}function te(n){return n.replace(/(index)?(\.(md|html))?$/,"")||"/"}function St(n){return n===!1||n==="auto"||yn(n)}function _t(n){return n.children!==void 0}function kt(n){return yn(n)?n.length===0:!n}function vn(n,e){if(St(n))return n;e=pn(e);for(const t in n)if(e.startsWith(pn(t)))return n[t];return"auto"}function oe(n){return n.reduce((e,t)=>(t.link&&e.push({text:t.text,link:te(t.link)}),_t(t)&&(e=[...e,...oe(t.children)]),e),[])}const It=["href","aria-label"],Rt=["src"],xt=w({__name:"NavBarTitle",setup(n){const{site:e,theme:t,localePath:o}=R();return(a,s)=>(c(),m("a",{class:"nav-bar-title",href:r(o),"aria-label":`${r(e).title}, back to home`},[r(t).logo?(c(),m("img",{key:0,class:"logo",src:r(P)(r(t).logo),alt:"Logo"},null,8,Rt)):f("",!0),$(" "+p(r(e).title),1)],8,It))}});var Tt=S(xt,[["__scopeId","data-v-7ac13a1e"]]);function qt(){const{site:n,localePath:e,theme:t}=R();return y(()=>{const o=n.value.langs,a=Object.keys(o);if(a.length<2)return null;const u=F().path.replace(e.value,""),h=a.map(d=>({text:o[d].label,link:`${d}${u}`}));return{text:t.value.selectText||"Languages",items:h}})}const At=["GitHub","GitLab","Bitbucket"].map(n=>[n,new RegExp(n,"i")]);function Ct(){const{site:n}=R();return y(()=>{const e=n.value.themeConfig,t=e.docsRepo||e.repo;if(!t)return null;const o=Ht(t);return{text:$t(o,e.repoLabel),link:o}})}function Ht(n){return Ee.test(n)?n:`https://github.com/${n}`}function $t(n,e){if(e)return e;const t=n.match(/^https?:\/\/[^/]+/);if(!t)return"Source";const o=At.find(([a,s])=>s.test(t[0]));return o&&o[0]?o[0]:"Source"}function ae(n){const e=F(),t=wn(n.value.link);return{props:y(()=>{const a=Nn(`/${e.data.relativePath}`);let s=!1;if(n.value.activeMatch)s=new RegExp(n.value.activeMatch).test(a);else{const u=Nn(n.value.link);s=u==="/"?u===a:a.startsWith(u)}return{class:{active:s,isExternal:t},href:t?n.value.link:P(n.value.link),target:n.value.target||(t?"_blank":null),rel:n.value.rel||(t?"noopener noreferrer":null),"aria-label":n.value.ariaLabel}}),isExternal:t}}function Nn(n){return n.replace(/#.*$/,"").replace(/\?.*$/,"").replace(/\.(html|md)$/,"").replace(/\/index$/,"/")}const Lt={},jt={class:"icon outbound",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",x:"0px",y:"0px",viewBox:"0 0 100 100",width:"15",height:"15"},Pt=i("path",{fill:"currentColor",d:"M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"},null,-1),Et=i("polygon",{fill:"currentColor",points:"45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"},null,-1),Mt=[Pt,Et];function Nt(n,e){return c(),m("svg",jt,Mt)}var bn=S(Lt,[["render",Nt]]);const Wt={class:"nav-link"},Bt=w({__name:"NavLink",props:{item:null},setup(n){const t=an(n),{props:o,isExternal:a}=ae(t.item);return(s,u)=>(c(),m("div",Wt,[i("a",Vn({class:"item"},r(o)),[$(p(n.item.text)+" ",1),r(a)?(c(),C(bn,{key:0})):f("",!0)],16)]))}});var Wn=S(Bt,[["__scopeId","data-v-49fe041d"]]);const Dt=n=>(N("data-v-07381bdb"),n=n(),W(),n),Ot={class:"nav-dropdown-link-item"},Ft=Dt(()=>i("span",{class:"arrow"},null,-1)),Yt={class:"text"},Gt={class:"icon"},Jt=w({__name:"NavDropdownLinkItem",props:{item:null},setup(n){const t=an(n),{props:o,isExternal:a}=ae(t.item);return(s,u)=>(c(),m("div",Ot,[i("a",Vn({class:"item"},r(o)),[Ft,i("span",Yt,p(n.item.text),1),i("span",Gt,[r(a)?(c(),C(bn,{key:0})):f("",!0)])],16)]))}});var zt=S(Jt,[["__scopeId","data-v-07381bdb"]]);const Vt=["aria-label"],Ut={class:"button-text"},Kt={class:"dialog"},Xt=w({__name:"NavDropdownLink",props:{item:null},setup(n){const e=F(),t=H(!1);U(()=>e.path,()=>{t.value=!1});function o(){t.value=!t.value}return(a,s)=>(c(),m("div",{class:j(["nav-dropdown-link",{open:t.value}])},[i("button",{class:"button","aria-label":n.item.ariaLabel,onClick:o},[i("span",Ut,p(n.item.text),1),i("span",{class:j(["button-arrow",t.value?"down":"right"])},null,2)],8,Vt),i("ul",Kt,[(c(!0),m(T,null,L(n.item.items,u=>(c(),m("li",{key:u.text,class:"dialog-item"},[b(zt,{item:u},null,8,["item"])]))),128))])],2))}});var Bn=S(Xt,[["__scopeId","data-v-18d75f62"]]);const Qt={key:0,class:"nav-links"},Zt={key:1,class:"item"},no={key:2,class:"item"},eo=w({__name:"NavLinks",setup(n){const{theme:e}=R(),t=qt(),o=Ct(),a=y(()=>e.value.nav||o.value||t.value);return(s,u)=>r(a)?(c(),m("nav",Qt,[r(e).nav?(c(!0),m(T,{key:0},L(r(e).nav,h=>(c(),m("div",{key:h.text,class:"item"},[h.items?(c(),C(Bn,{key:0,item:h},null,8,["item"])):(c(),C(Wn,{key:1,item:h},null,8,["item"]))]))),128)):f("",!0),r(t)?(c(),m("div",Zt,[b(Bn,{item:r(t)},null,8,["item"])])):f("",!0),r(o)?(c(),m("div",no,[b(Wn,{item:r(o)},null,8,["item"])])):f("",!0)])):f("",!0)}});var se=S(eo,[["__scopeId","data-v-35b91e7e"]]);const to={emits:["toggle"]},oo=i("svg",{class:"icon",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",role:"img",viewBox:"0 0 448 512"},[i("path",{fill:"currentColor",d:"M436 124H12c-6.627 0-12-5.373-12-12V80c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12zm0 160H12c-6.627 0-12-5.373-12-12v-32c0-6.627 5.373-12 12-12h424c6.627 0 12 5.373 12 12v32c0 6.627-5.373 12-12 12z",class:""})],-1),ao=[oo];function so(n,e,t,o,a,s){return c(),m("div",{class:"sidebar-button",onClick:e[0]||(e[0]=u=>n.$emit("toggle"))},ao)}var ro=S(to,[["render",so]]);const io=n=>(N("data-v-40587210"),n=n(),W(),n),lo={class:"nav-bar"},uo=io(()=>i("div",{class:"flex-grow"},null,-1)),co={class:"nav"},ho=w({__name:"NavBar",emits:["toggle"],setup(n){return(e,t)=>(c(),m("header",lo,[b(ro,{onToggle:t[0]||(t[0]=o=>e.$emit("toggle"))}),b(Tt),uo,i("div",co,[b(se)]),A(e.$slots,"search",{},void 0,!0)]))}});var mo=S(ho,[["__scopeId","data-v-40587210"]]);function go(){let n=null,e=null;const t=vo(o,300);function o(){const u=po(),h=fo(u);for(let l=0;l<h.length;l++){const d=h[l],g=h[l+1],[_,q]=wo(l,d,g);if(_){history.replaceState(null,document.title,q||" "),a(q);return}}}function a(u){if(s(e),s(n),e=document.querySelector(`.sidebar a[href="${u}"]`),!e)return;e.classList.add("active");const h=e.closest(".sidebar-links > ul > li");h&&h!==e.parentElement?(n=h.querySelector("a"),n&&n.classList.add("active")):n=null}function s(u){u&&u.classList.remove("active")}E(()=>{o(),window.addEventListener("scroll",t)}),Un(()=>{a(decodeURIComponent(location.hash))}),K(()=>{window.removeEventListener("scroll",t)})}function po(){return[].slice.call(document.querySelectorAll(".sidebar a.sidebar-link-item"))}function fo(n){return[].slice.call(document.querySelectorAll(".header-anchor")).filter(e=>n.some(t=>t.hash===e.hash))}function yo(){return document.querySelector(".nav-bar").offsetHeight}function Dn(n){const e=yo();return n.parentElement.offsetTop-e-15}function wo(n,e,t){const o=window.scrollY;return n===0&&o===0?[!0,null]:o<Dn(e)?[!1,null]:!t||o<Dn(t)?[!0,decodeURIComponent(e.hash)]:[!1,null]}function vo(n,e){let t,o=!1;return()=>{t&&clearTimeout(t),o?t=setTimeout(n,e):(n(),o=!0,setTimeout(()=>{o=!1},e))}}function bo(){const n=F(),{site:e}=R();return go(),y(()=>{const t=n.data.headers,o=n.data.frontmatter.sidebar,a=n.data.frontmatter.sidebarDepth;if(o===!1)return[];if(o==="auto")return On(t,a);const s=vn(e.value.themeConfig.sidebar,n.data.relativePath);return s===!1?[]:s==="auto"?On(t,a):s})}function On(n,e){const t=[];if(n===void 0)return[];let o;return n.forEach(({level:a,title:s,slug:u})=>{if(a-1>e)return;const h={text:s,link:`#${u}`};a===2?(o=h,t.push(h)):o&&(o.children||(o.children=[])).push(h)}),t}const re=n=>{const e=F(),{site:t,frontmatter:o}=R(),a=n.depth||1,s=o.value.sidebarDepth||1/0,u=e.data.headers,h=n.item.text,l=So(t.value.base,n.item.link),d=n.item.children,g=vt(e,n.item.link),_=a<s?ie(g,d,u,a+1):null;return G("li",{class:"sidebar-link"},[G(l?"a":"p",{class:{"sidebar-link-item":!0,active:g},href:l},h),_])};function So(n,e){return e===void 0||e.startsWith("#")?e:bt(n,e)}function ie(n,e,t,o=1){return e&&e.length>0?G("ul",{class:"sidebar-links"},e.map(a=>G(re,{item:a,depth:o}))):n&&t?ie(!1,_o(t),void 0,o):null}function _o(n){return le(ko(n))}function ko(n){n=n.map(t=>Object.assign({},t));let e;return n.forEach(t=>{t.level===2?e=t:e&&(e.children||(e.children=[])).push(t)}),n.filter(t=>t.level===2)}function le(n){return n.map(e=>({text:e.title,link:`#${e.slug}`,children:e.children?le(e.children):void 0}))}const Io={key:0,class:"sidebar-links"},Ro=w({__name:"SideBarLinks",setup(n){const e=bo();return(t,o)=>r(e).length>0?(c(),m("ul",Io,[(c(!0),m(T,null,L(r(e),a=>(c(),C(r(re),{item:a},null,8,["item"]))),256))])):f("",!0)}});const xo=w({__name:"SideBar",props:{open:{type:Boolean}},setup(n){return(e,t)=>(c(),m("aside",{class:j(["sidebar",{open:n.open}])},[b(se,{class:"nav"}),A(e.$slots,"sidebar-top",{},void 0,!0),b(Ro),A(e.$slots,"sidebar-bottom",{},void 0,!0)],2))}});var To=S(xo,[["__scopeId","data-v-17c48e2f"]]);const qo=/bitbucket.org/;function Ao(){const{page:n,theme:e,frontmatter:t}=R(),o=y(()=>{const{repo:s,docsDir:u="",docsBranch:h="master",docsRepo:l=s,editLinks:d}=e.value,g=t.value.editLink!=null?t.value.editLink:d,{relativePath:_}=n.value;return!g||!_||!s?null:Co(s,l,u,h,_)}),a=y(()=>e.value.editLinkText||"Edit this page");return{url:o,text:a}}function Co(n,e,t,o,a){return qo.test(n)?$o(n,e,t,o,a):Ho(n,e,t,o,a)}function Ho(n,e,t,o,a){return(wn(e)?e:`https://github.com/${e}`).replace(en,"")+`/edit/${o}/`+(t?t.replace(en,"")+"/":"")+a}function $o(n,e,t,o,a){return(wn(e)?e:n).replace(en,"")+`/src/${o}/`+(t?t.replace(en,"")+"/":"")+a+`?mode=edit&spa=0&at=${o}&fileviewer=file-view-default`}const Lo={class:"edit-link"},jo=["href"],Po=w({__name:"EditLink",setup(n){const{url:e,text:t}=Ao();return(o,a)=>(c(),m("div",Lo,[r(e)?(c(),m("a",{key:0,class:"link",href:r(e),target:"_blank",rel:"noopener noreferrer"},[$(p(r(t))+" ",1),b(bn,{class:"icon"})],8,jo)):f("",!0)]))}});var Eo=S(Po,[["__scopeId","data-v-55695e90"]]);const Mo={key:0,class:"last-updated"},No={class:"prefix"},Wo={class:"datetime"},Bo=w({__name:"LastUpdated",setup(n){const{theme:e,page:t}=R(),o=y(()=>{const u=e.value.lastUpdated;return u!==void 0&&u!==!1}),a=y(()=>{const u=e.value.lastUpdated;return u===!0?"Last Updated":u}),s=H("");return E(()=>{s.value=new Date(t.value.lastUpdated).toLocaleString("en-US")}),(u,h)=>r(o)?(c(),m("p",Mo,[i("span",No,p(r(a))+":",1),i("span",Wo,p(s.value),1)])):f("",!0)}});var Do=S(Bo,[["__scopeId","data-v-30c3cbb4"]]);const Oo={class:"page-footer"},Fo={class:"edit"},Yo={class:"updated"},Go=w({__name:"PageFooter",setup(n){return(e,t)=>(c(),m("footer",Oo,[i("div",Fo,[b(Eo)]),i("div",Yo,[b(Do)])]))}});var Jo=S(Go,[["__scopeId","data-v-5c96fb00"]]);function zo(){const{page:n,theme:e}=R(),t=y(()=>te(pn(n.value.relativePath))),o=y(()=>{const l=vn(e.value.sidebar,t.value);return yn(l)?oe(l):[]}),a=y(()=>o.value.findIndex(l=>l.link===t.value)),s=y(()=>{if(e.value.nextLinks!==!1&&a.value>-1&&a.value<o.value.length-1)return o.value[a.value+1]}),u=y(()=>{if(e.value.prevLinks!==!1&&a.value>0)return o.value[a.value-1]}),h=y(()=>!!s.value||!!u.value);return{next:s,prev:u,hasLinks:h}}const Vo={},Uo={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},Ko=i("path",{d:"M19,11H7.4l5.3-5.3c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-7,7c-0.1,0.1-0.2,0.2-0.2,0.3c-0.1,0.2-0.1,0.5,0,0.8c0.1,0.1,0.1,0.2,0.2,0.3l7,7c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4L7.4,13H19c0.6,0,1-0.4,1-1S19.6,11,19,11z"},null,-1),Xo=[Ko];function Qo(n,e){return c(),m("svg",Uo,Xo)}var Zo=S(Vo,[["render",Qo]]);const na={},ea={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},ta=i("path",{d:"M19.9,12.4c0.1-0.2,0.1-0.5,0-0.8c-0.1-0.1-0.1-0.2-0.2-0.3l-7-7c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l5.3,5.3H5c-0.6,0-1,0.4-1,1s0.4,1,1,1h11.6l-5.3,5.3c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l7-7C19.8,12.6,19.9,12.5,19.9,12.4z"},null,-1),oa=[ta];function aa(n,e){return c(),m("svg",ea,oa)}var sa=S(na,[["render",aa]]);const ra={key:0,class:"next-and-prev-link"},ia={class:"container"},la={class:"prev"},ua=["href"],ca={class:"text"},ha={class:"next"},da=["href"],ma={class:"text"},ga=w({__name:"NextAndPrevLinks",setup(n){const{hasLinks:e,prev:t,next:o}=zo();return(a,s)=>r(e)?(c(),m("div",ra,[i("div",ia,[i("div",la,[r(t)?(c(),m("a",{key:0,class:"link",href:r(P)(r(t).link)},[b(Zo,{class:"icon icon-prev"}),i("span",ca,p(r(t).text),1)],8,ua)):f("",!0)]),i("div",ha,[r(o)?(c(),m("a",{key:0,class:"link",href:r(P)(r(o).link)},[i("span",ma,p(r(o).text),1),b(sa,{class:"icon icon-next"})],8,da)):f("",!0)])])])):f("",!0)}});var pa=S(ga,[["__scopeId","data-v-e65a9748"]]);const fa={class:"page"},ya={class:"container"},wa=w({__name:"Page",setup(n){return(e,t)=>{const o=nn("Content");return c(),m("main",fa,[i("div",ya,[A(e.$slots,"top",{},void 0,!0),b(o,{class:"content"}),b(Jo),b(pa),A(e.$slots,"bottom",{},void 0,!0)])])}}});var va=S(wa,[["__scopeId","data-v-8fcebc32"]]);const ba={key:0,id:"ads-container"},Sa=w({__name:"Layout",setup(n){const e=$e(()=>Yn(()=>import("./Home.bccc60df.js"),["assets/Home.bccc60df.js","assets/Debug.vue_vue_type_style_index_0_scoped_true_lang.1370bc6a.js","assets/plugin-vue_export-helper.c35c1c54.js","assets/preload-helper.1c052cf7.js","assets/Pagination.7bbf7d94.js"])),t=()=>null,o=t,a=t,s=t,u=F(),{site:h,page:l,theme:d,frontmatter:g}=R(),_=y(()=>!!g.value.customLayout),q=y(()=>!!g.value.home),v=y(()=>Object.keys(h.value.langs).length>1),k=y(()=>{const x=d.value;return g.value.navbar===!1||x.navbar===!1?!1:h.value.title||x.logo||x.repo||x.nav}),I=H(!1),M=y(()=>g.value.home||g.value.sidebar===!1?!1:!kt(vn(d.value.sidebar,u.data.relativePath))),rn=x=>{I.value=typeof x=="boolean"?x:!I.value},we=rn.bind(null,!1);U(u,we);const ve=y(()=>[{"no-navbar":!k.value,"sidebar-open":I.value,"no-sidebar":!M.value}]);return(x,In)=>{const be=nn("Content"),Se=nn("Debug");return c(),m(T,null,[i("div",{class:j(["theme",r(ve)])},[r(k)?(c(),C(mo,{key:0,onToggle:rn},{search:B(()=>[A(x.$slots,"navbar-search",{},()=>[r(d).algolia?(c(),C(r(s),{key:0,options:r(d).algolia,multilang:r(v)},null,8,["options","multilang"])):f("",!0)])]),_:3})):f("",!0),b(To,{open:I.value},{"sidebar-top":B(()=>[A(x.$slots,"sidebar-top")]),"sidebar-bottom":B(()=>[A(x.$slots,"sidebar-bottom")]),_:3},8,["open"]),i("div",{class:"sidebar-mask",onClick:In[0]||(In[0]=ui=>rn(!1))}),r(_)?(c(),C(be,{key:1})):r(q)?A(x.$slots,"home",{key:2},()=>[b(r(e),null,{hero:B(()=>[A(x.$slots,"home-hero")]),features:B(()=>[A(x.$slots,"home-features")]),footer:B(()=>[A(x.$slots,"home-footer")]),_:3})]):(c(),C(va,{key:3},{top:B(()=>[A(x.$slots,"page-top-ads",{},()=>[r(d).carbonAds&&r(d).carbonAds.carbon?(c(),m("div",ba,[(c(),C(r(o),{key:"carbon"+r(l).relativePath,code:r(d).carbonAds.carbon,placement:r(d).carbonAds.placement},null,8,["code","placement"]))])):f("",!0)]),A(x.$slots,"page-top")]),bottom:B(()=>[A(x.$slots,"page-bottom"),A(x.$slots,"page-bottom-ads",{},()=>[r(d).carbonAds&&r(d).carbonAds.custom?(c(),C(r(a),{key:"custom"+r(l).relativePath,code:r(d).carbonAds.custom,placement:r(d).carbonAds.placement},null,8,["code","placement"])):f("",!0)])]),_:3}))],2),b(Se)],64)}}}),_a={class:"theme"},ka=i("h1",null,"404",-1),Ia=["href"],Ra=w({__name:"NotFound",setup(n){const{site:e}=R(),t=["There's nothing here.","How did we get here?","That's a Four-Oh-Four.","Looks like we've got some broken links."];function o(){return t[Math.floor(Math.random()*t.length)]}return(a,s)=>(c(),m("div",_a,[ka,i("blockquote",null,p(o()),1),i("a",{href:r(e).base,"aria-label":"go to home"},"Take me home.",8,Ia)]))}}),xa={Layout:Sa,NotFound:Ra};class Ta{constructor(){this.x=50,this.y=50,this.vx=Math.random()*2+2,this.vy=Math.random()*2,this.color="#fff",this.shadowBlur=Math.random()*3,this.shadowX=Math.random()*2-1,this.shadowY=Math.random()*2-1,this.radiusX=Math.random()*3,this.radiusY=Math.random()*3,this.rotation=Math.PI*Math.floor(Math.random()*2)}}class Sn{constructor(e){this.width=300,this.height=300,this.dustQuantity=50,this.dustArr=[];const t=document.getElementById(e);if(t)this.canvas=t,this.ctx=t.getContext("2d"),this.build(),window.addEventListener("resize",()=>this.resize());else throw new Error("canvasID \u65E0\u6548")}build(){if(this.resize(),this.ctx){const e=Sn.getPoint(this.dustQuantity);for(let t of e){const o=new Ta;this.buildDust(t[0],t[1],o),this.dustArr.push(o)}setInterval(()=>{this.play()},40)}}play(){var t;const e=this.dustArr;(t=this.ctx)==null||t.clearRect(0,0,this.width,this.height);for(let o of e)if(o.x<0||o.y<0){const a=this.width,s=Math.floor(Math.random()*window.innerHeight);o.x=a,o.y=s,this.buildDust(a,s,o)}else{const a=o.x-o.vx,s=o.y-o.vy;this.buildDust(a,s,o)}}buildDust(e,t,o){const a=this.ctx;e&&(o.x=e),t&&(o.y=t),a&&(a.beginPath(),a.shadowBlur=o.shadowBlur,a.shadowColor=o.color,a.shadowOffsetX=o.shadowX,a.shadowOffsetY=o.shadowY,a.ellipse(o.x,o.y,o.radiusX,o.radiusY,o.rotation,0,Math.PI*2),a.closePath(),a.fillStyle=o.color,a.fill())}resize(){const e=this.canvas,t=window.innerWidth,o=window.innerHeight;this.width=t,this.height=o,this.dustQuantity=Math.floor((t+o)/38),e!==void 0&&(e.width=t,e.height=o)}static getPoint(e=1){let t=[];for(let o=0;o<e;o++){const a=Math.floor(Math.random()*window.innerWidth),s=Math.floor(Math.random()*window.innerHeight);t.push([a,s])}return t}}const qa=n=>{const e=localStorage.getItem(n);return e&&JSON.parse(e)},Fn=(n,e)=>{localStorage.setItem(n,JSON.stringify(e))};function Aa(n){let e=n[0];for(let t=1;t<n.length;t++){const o=n[t];o.length>e.length&&(e=o)}return e}function ue(n,e){return Array.from(n).filter(a=>e.test(a.nodeName))}function ce(n,e){let t,o,a=0;return function(){t=this,o=arguments;let s=new Date().valueOf();s-a>e&&(n.apply(t,o),a=s)}}const Ca=n=>{n.forEach(e=>{const t=new Image;t.src=e})};const Ha=w({__name:"BgToggle",props:{bgUrl:String},setup(n){const{theme:e}=R(),t=e.value.bgUrls,o=H(0),a=Le("setBg");on(()=>{a(t[o.value])}),je(()=>{Ca(t)}),E(()=>{s()});const s=()=>{const h=qa("bgIdx");h==null?Fn("bgIdx",o.value):o.value=h},u=()=>{o.value>=t.length-1?o.value=0:o.value++,Fn("bgIdx",o.value)};return(h,l)=>(c(),m("i",{class:"fa fa-retweet bg-toggle",title:"toggle background",onClick:u}))}});var $a=S(Ha,[["__scopeId","data-v-2dc83b4c"]]);const La=n=>(N("data-v-7d636702"),n=n(),W(),n),ja={class:"menu-list"},Pa=La(()=>i("a",{href:""},[i("i",{class:"fa fa-navicon"})],-1)),Ea=[Pa],Ma=["href"],Na=["title"],Wa=w({__name:"index",setup(n){const{theme:e,page:t}=R(),o=e.value.nav,a=H(!0),s=y(()=>`/${t.value.relativePath.split(".")[0]}`),u=()=>{a.value=!a.value};return(h,l)=>(c(),m("header",null,[i("nav",null,[i("ul",ja,[i("li",{class:"nav-toggle",onClick:u},Ea),a.value?(c(!0),m(T,{key:0},L(r(o),d=>(c(),m("li",{class:j(d.link===r(s)?"active":"")},[(c(),m("a",{href:d.link,key:d.link},[i("i",{class:j(`fa fa-${d.icon}`),title:d.text},null,10,Na)],8,Ma))],2))),256)):f("",!0),i("li",null,[b($a)])])])]))}});var Ba=S(Wa,[["__scopeId","data-v-7d636702"]]);const _n=n=>(N("data-v-19749d0f"),n=n(),W(),n),Da={key:0,class:"aside-wrapper"},Oa={href:"/",class:"logo"},Fa=["src"],Ya={class:"center dr"},Ga={href:"/"},Ja={class:"total"},za=["href"],Va=_n(()=>i("span",{class:"total-title"},"Archives Total",-1)),Ua={class:"total-number"},Ka={class:"total-tags"},Xa=_n(()=>i("span",{class:"total-title"},"Tags:",-1)),Qa={class:"total-number"},Za={class:"total-categories"},ns=_n(()=>i("span",{class:"total-title"},"Categories:",-1)),es={class:"total-number"},ts=w({__name:"index",setup(n){const{site:e,theme:t,frontmatter:o}=R(),a=e.value.title,s=t.value.logo,u=t.value.posts.length,h=Object.keys(t.value.tags).length,l=Object.keys(t.value.cats).length,d=y(()=>o.value.sidebar);return(g,_)=>r(d)?(c(),m("div",Da,[i("aside",null,[i("div",null,[i("a",Oa,[i("img",{src:r(P)(r(s)),alt:"Logo"},null,8,Fa)]),i("h1",Ya,[i("a",Ga,"Dr."+p(r(a)),1)]),i("section",Ja,[i("a",{class:"total-archives",href:r(P)("/pages/archives")},[Va,i("span",Ua,p(r(u)),1)],8,za),i("div",Ka,[Xa,i("span",Qa,p(r(h)),1)]),i("div",Za,[ns,i("span",es,p(r(l)),1)])])])])])):f("",!0)}});var os=S(ts,[["__scopeId","data-v-19749d0f"]]);const as={class:"message-wrapper"},ss=w({__name:"Message",props:{type:{type:String,required:!0},msg:{type:String,required:!0}},setup(n){return(e,t)=>(c(),m("div",as,[i("span",null,p(n.msg.value),1)]))}});var rs=S(ss,[["__scopeId","data-v-716cb212"]]);const X=D({type:"success",msg:""}),is=(n=X.type,e,t)=>{X.type=n,X.msg=e;const o=ne(rs,{...an(X)}).mount(document.createElement("div"));document.body.appendChild(o.$el),setTimeout(()=>{document.body.removeChild(o.$el)},t)},he={success(n,e=1e3){is("success",n,e)},install(n){n.config.globalProperties.message=he}};class ls{constructor(){this.codeEles=document.getElementsByTagName("pre"),Array.from(this.codeEles).forEach(async t=>{const o=document.createElement("i");o.setAttribute("class","btn-copy fa fa-clipboard"),t.appendChild(o),o.addEventListener("click",function(){const a=document.createElement("textarea"),s=o.previousElementSibling;a.value=s.innerText,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),he.success("Copied!")})})}}const us=n=>(N("data-v-4e6f6b2a"),n=n(),W(),n),cs={class:"post-header"},hs={class:"title"},ds={class:"info"},ms={class:"item date",datetime:"2022-01-25T19:21:35.000Z"},gs=us(()=>i("div",{class:"divider"},null,-1)),ps=w({__name:"PostHeader",setup(n){const{frontmatter:e}=R();let t=y(()=>e.value.title),o=y(()=>{const a=e.value.date;return(a?new Date(a).toJSON().split("T")[0]:"").split("-")});return(a,s)=>(c(),m("div",cs,[i("h1",hs,p(r(t)),1),i("div",ds,[i("span",ms,p(r(o)[2])+" / "+p(r(o)[1])+" / "+p(r(o)[0]),1)]),gs]))}});var fs=S(ps,[["__scopeId","data-v-4e6f6b2a"]]);const kn=n=>(N("data-v-f9cae6c6"),n=n(),W(),n),ys={class:"post-footer"},ws=kn(()=>i("span",null,"\u672C\u6587\u4F5C\u8005\uFF1A",-1)),vs=["href"],bs=kn(()=>i("span",null,"\u672C\u6587\u94FE\u63A5\uFF1A",-1)),Ss=["href"],_s=kn(()=>i("li",null,[i("span",null,"\u7248\u6743\u58F0\u660E\uFF1A"),$(" \u672C\u535A\u5BA2\u6240\u6709\u6587\u7AE0\u9664\u7279\u522B\u58F0\u660E\u5916\uFF0C\u5747\u91C7\u7528 "),i("a",{href:"https://creativecommons.org/licenses/by-nc-sa/4.0/",target:"_blank"},"CC BY-NC-SA 4.0"),$(" \u8BB8\u53EF\u534F\u8BAE\uFF0C\u8F6C\u8F7D\u8BF7\u6CE8\u660E\u51FA\u5904\u3002 ")],-1)),ks=w({__name:"PostFooter",setup(n){const{page:e,site:t,frontmatter:o}=R();let a=y(()=>{const s=`${e.value.relativePath.split(".")[0]}.html`;return`${t.value.themeConfig.website}/${s}`});return y(()=>o.value.postFooter),(s,u)=>(c(),m("div",ys,[i("ul",null,[i("li",null,[ws,i("a",{href:r(t).themeConfig.website,target:"_blank"},p(r(t).title),9,vs)]),i("li",null,[bs,i("a",{href:r(a),target:"_blank"},p(r(a)),9,Ss)]),_s])]))}});var Is=S(ks,[["__scopeId","data-v-f9cae6c6"]]);const de=n=>(N("data-v-22a9c1c0"),n=n(),W(),n),Rs={class:"prev-next"},xs=de(()=>i("hr",null,null,-1)),Ts=["href"],qs={key:1},As=["href"],Cs={key:1},Hs=de(()=>i("hr",null,null,-1)),$s=w({__name:"PrevNext",setup(n){const{theme:e,page:t}=R(),o=y(()=>e.value.posts),a=y(()=>t.value.frontmatter.title);let s=D({regularPath:"",frontMatter:{title:""}}),u=D({regularPath:"",frontMatter:{title:""}});const h=(l,d)=>{d?(l.regularPath=d.regularPath,l.frontMatter.title=d.frontMatter.title):(l.regularPath="",l.frontMatter.title="")};return on(()=>{const l=o.value.findIndex(d=>d.frontMatter.title===a.value);if(l>-1){const d=o.value[l-1],g=o.value[l+1];h(s,d),h(u,g)}}),(l,d)=>{var g,_,q,v,k,I;return c(),m("div",Rs,[xs,i("div",null,[dn(i("a",{class:"prev",href:r(P)((g=r(s))==null?void 0:g.regularPath)},[r(e).docFooter.prev.icon?(c(),m("i",{key:0,class:j(`fa fa-${r(e).docFooter.prev.icon}`)},null,2)):f("",!0),r(e).docFooter.prev.text?(c(),m("span",qs,p(r(e).docFooter.prev.text),1)):f("",!0),$(" "+p((q=(_=r(s))==null?void 0:_.frontMatter)==null?void 0:q.title),1)],8,Ts),[[jn,r(s).regularPath]]),dn(i("a",{class:"next",href:r(P)((v=r(u))==null?void 0:v.regularPath)},[$(p((I=(k=r(u))==null?void 0:k.frontMatter)==null?void 0:I.title)+" ",1),r(e).docFooter.next.icon?(c(),m("i",{key:0,class:j(`fa fa-${r(e).docFooter.next.icon}`)},null,2)):f("",!0),r(e).docFooter.next.text?(c(),m("span",Cs,p(r(e).docFooter.next.text),1)):f("",!0)],8,As),[[jn,r(u).regularPath]])]),Hs])}}});var Ls=S($s,[["__scopeId","data-v-22a9c1c0"]]);function js(n="2022-01-01"){const e=new Date(n),t=new Date().getTime()-e.getTime(),o=24*60*60*1e3,a=t/o,s=Math.floor(a),u=(a-s)*24,h=Math.floor(u),l=(u-h)*60,d=Math.floor(l),g=(l-d)*60,_=Math.floor(g);return{day:s,hour:h,minute:d,second:_}}const sn=n=>(N("data-v-e45bedf6"),n=n(),W(),n),Ps=$(" \xA9 2022 "),Es=["href"],Ms=$(" | "),Ns=sn(()=>i("a",{href:"https://wonderven.netlify.app/",target:"_blank"},"Netlify",-1)),Ws=sn(()=>i("p",null,[$(" Published With "),i("a",{href:"https://vitejs.cn/vitepress/",target:"_blank"},"VitePress"),$(" & "),i("a",{href:"https://github.com/Yue-plus/hexo-theme-arknights",target:"_blank",class:"mr4"},"Arknights")],-1)),Bs={key:0,class:"social-links"},Ds=["href"],Os=$(" | "),Fs=sn(()=>i("a",{href:"https://travellings.link/",target:"_blank"},[i("i",{class:"fa fa-paper-plane-o",title:"Travellings"})],-1)),Ys=sn(()=>i("i",{class:"fa fa-heartbeat mr4"},null,-1)),Gs=w({__name:"Footer",setup(n){const{site:e,theme:t}=R(),o=H();let a=D({day:0,hour:0,minute:0,second:0}),s=null;E(()=>{t.value.footer.runtime.enable&&(s=setInterval(u,1e3))}),K(()=>{s&&clearInterval(s)});const u=()=>{const h=js();a.day=h.day,a.hour=h.hour,a.minute=h.minute,a.second=h.second};return(h,l)=>(c(),m("footer",null,[i("p",null,[Ps,i("a",{href:r(t).website,target:"_blank"},p(r(e).title),9,Es),Ms,Ns]),Ws,r(t).socialLinks.length?(c(),m("p",Bs,[(c(!0),m(T,null,L(r(t).socialLinks,(d,g)=>(c(),m(T,{key:d.link},[i("i",{class:j(`fa fa-${d.icon} mr4`)},null,2),i("a",{href:d.link,target:"_blank"},p(d.text),9,Ds),Os],64))),128)),Fs])):f("",!0),r(t).footer.runtime.enable?(c(),m("p",{key:1,ref_key:"runtimeRef",ref:o},[Ys,$(" "+p(r(a).day)+" days "+p(r(a).hour)+" hours "+p(r(a).minute)+" minutes and "+p(r(a).second)+" seconds ",1)],512)):f("",!0)]))}});var Js=S(Gs,[["__scopeId","data-v-e45bedf6"]]);const me=/^H[1-6]{1,}$/,zs=n=>{const e=n.childNodes,t=ue(e,me);return Vs(t)};function Vs(n){const e=[];for(let t=0;t<n.length;t++){const o=n[t],a=/^(_\d{1,})+(-\d{1,})*/ig,s=o.id.match(a)[0];e.push({nodeName:o.nodeName,text:o.innerText.slice(0,o.innerText.length-1),id:o.id,level:s})}return Us(e)}function Us(n){const e=[],t={};n.forEach(o=>{t[o.level]=o});for(const o in t)if(Object.prototype.hasOwnProperty.call(t,o)){const a=t[o];if(/^(_\d{1,})+$/ig.test(o))e.push(a);else{const h=Object.keys(t).filter(d=>d!==o&&o.includes(d)),l=Aa(h);t[l].child?t[l].child.push(a):t[l].child=[a]}}return e}const Ks=["href","name","title","onClick"],Xs=w({__name:"CataList",props:{tree:Array},setup(n){const e=t=>{t.open=!t.open,t.active=!0};return(t,o)=>(c(),m("ul",null,[(c(!0),m(T,null,L(n.tree,a=>{var s;return c(),m("li",{key:a.id},[i("a",{href:`#${a.id}`,name:a.id,title:a.text,class:j([[a.nodeName,a.active?"active":""],"link"]),onClick:u=>e(a)},p(a.text),11,Ks),((s=a.child)==null?void 0:s.length)&&a.open?(c(),C(ge,{key:0,tree:a.child},null,8,["tree"])):f("",!0)])}),128))]))}});var ge=S(Xs,[["__scopeId","data-v-6e7df7be"]]);const Qs={key:0,class:"catalog"},Zs=w({__name:"index",setup(n){const{frontmatter:e}=R(),t=H(0),o=H(0),a=D({data:[]}),s=D({titleNodes:[],titleMargins:[]});U(e,(v,k)=>{u()},{deep:!0}),E(()=>{u(),window.addEventListener("scroll",l)}),K(()=>{window.removeEventListener("scroll",l)});const u=()=>{var I;const v=(I=document.getElementById("content"))==null?void 0:I.childNodes[0],k=zs(v);a.data=k,o.value=v.getBoundingClientRect().top,g(v)},h=()=>{t.value=document.documentElement.scrollTop,d()},l=ce.bind(this,h,50)(),d=()=>{const v=s.titleMargins;for(let k=0;k<v.length;k++){const I=v[k];if(I.top-t.value>=o.value){q(a.data),_(a.data,I.id);return}}},g=v=>{const k=v.childNodes;s.titleNodes=ue(k,me);const I=s.titleNodes.map(M=>({id:M.id,top:M.getBoundingClientRect().top}));s.titleMargins=I,d()},_=(v,k)=>{for(let I=0;I<v.length;I++){const M=v[I];if(M.id===k){M.active=!0,M.open=!0;return}M.child&&_(M.child,k)}},q=v=>{for(let k=0;k<v.length;k++){const I=v[k];I.active&&(I.active=!1),I.child&&q(I.child)}};return(v,k)=>a.data.length?(c(),m("div",Qs,[b(ge,{tree:a.data},null,8,["tree"])])):f("",!0)}});var nr=S(Zs,[["__scopeId","data-v-32f802b6"]]);const er={key:1,class:"post-des"},tr=["innerHTML"],or=["innerHTML"],ar={key:0,class:"post-tag"},sr=i("i",{class:"fa fa-tags"},null,-1),rr=["href"],ir=w({__name:"index",setup(n){const{frontmatter:e}=R(),t=y(()=>e.value.page),o=y(()=>e.value.tags||[]);E(()=>{a()}),Un(()=>{a()});const a=()=>{t.value||new ls};return(s,u)=>{const h=nn("Content");return c(),m("div",{class:j(["content",r(t)?"":"post-content"]),id:"postContent"},[r(t)?f("",!0):(c(),C(fs,{key:0})),r(t)?f("",!0):(c(),m("div",er,[typeof r(e).description=="string"?(c(),m("p",{key:0,innerHTML:r(e).description},null,8,tr)):(c(!0),m(T,{key:1},L(r(e).description,l=>(c(),m("p",{key:l,innerHTML:l},null,8,or))),128))])),b(h,{id:"content"}),r(t)?f("",!0):(c(),m(T,{key:2},[r(o).length?(c(),m("p",ar,[sr,(c(!0),m(T,null,L(r(o),l=>(c(),m("a",{key:l,href:`/pages/archives#tag=${l}`},p(l),9,rr))),128))])):f("",!0),b(Is),b(Ls),b(nr)],64)),b(Js)],2)}}}),lr=()=>G("script",{src:"https://cdn.jsdelivr.net/gh/stevenjoezhang/live2d-widget/autoload.js"});const pe=n=>(N("data-v-3c98e87a"),n=n(),W(),n),ur=pe(()=>i("i",{class:"fa fa-caret-up"},null,-1)),cr=pe(()=>i("p",null,"TOP",-1)),hr=[ur,cr],dr=w({__name:"BackTop",setup(n){const e=H(0),t=y(()=>e.value>300?"block":"none");E(()=>{window.addEventListener("scroll",a)}),K(()=>{window.removeEventListener("scroll",a)});const o=()=>{e.value=document.documentElement.scrollTop},a=ce.bind(this,o,1e3)(),s=()=>{const u=document.documentElement.scrollTop/6,h=setInterval(()=>{document.documentElement.scrollTop=document.documentElement.scrollTop-u,e.value=document.documentElement.scrollTop,e.value<=0&&clearInterval(h)},50)};return(u,h)=>(c(),m("div",{class:"back-top",style:Kn({display:r(t)}),onClick:s},hr,4))}});var mr=S(dr,[["__scopeId","data-v-3c98e87a"]]);const gr={ref:"canvasRef",id:"canvas-dust",width:"1036",height:"228"},pr=w({__name:"App",setup(n){const{theme:e,frontmatter:t}=R(),o=H("");return Pe("setBg",a=>{o.value=a}),E(()=>{new Sn("canvas-dust")}),(a,s)=>(c(),m(T,null,[i("main",{class:"layout",style:Kn({"background-image":`url(${o.value})`})},[b(os,{class:"aside"}),b(ir,{class:"content"}),b(Ba,{class:"navbar"})],4),b(mr),r(e).live2d?(c(),C(r(lr),{key:0,class:"l2d-model"})):f("",!0),i("canvas",gr,null,512)],64))}});var fr=S(pr,[["__scopeId","data-v-549d457a"]]);const yr=["href"],wr={class:"post-info"},vr={class:"post-info-categories"},br=["href"],Sr={key:1,href:"#"},_r={class:"post-info-tags"},kr=["href"],Ir={key:1,href:"#"},Rr={datetime:"2022-01-25T19:21:35.000Z"},xr=["innerHTML"],Tr={class:"post-excerpt"},qr=["innerHTML"],Ar=["innerHTML"],Cr=i("span",{class:"post-btn"},"READ MORE +",-1),Hr=w({__name:"PostItem",props:{article:{type:Object,required:!0}},setup(n){return(e,t)=>(c(),m("a",{href:r(P)(n.article.regularPath),class:"post-item"},[i("div",wr,[i("div",null,[i("span",vr,[n.article.frontMatter.category&&n.article.frontMatter.category.length?(c(!0),m(T,{key:0},L(n.article.frontMatter.category,o=>(c(),m("a",{key:o,href:r(P)(`/pages/archives#category=${o}`)},p(o),9,br))),128)):(c(),m("a",Sr,"Empty"))]),i("span",_r,[n.article.frontMatter.tags&&n.article.frontMatter.tags.length?(c(!0),m(T,{key:0},L(n.article.frontMatter.tags,o=>(c(),m("a",{key:o,href:r(P)(`/pages/archives#tag=${o}`)},p(o),9,kr))),128)):(c(),m("a",Ir," Empty "))])]),i("time",Rr,p(n.article.frontMatter.dateArr[2])+" / "+p(n.article.frontMatter.dateArr[1])+" / "+p(n.article.frontMatter.dateArr[0]),1)]),i("h1",{class:"post-title",innerHTML:n.article.frontMatter.title},null,8,xr),i("div",Tr,[typeof n.article.frontMatter.description=="string"?(c(),m("p",{key:0,innerHTML:n.article.frontMatter.description},null,8,qr)):(c(!0),m(T,{key:1},L(n.article.frontMatter.description,o=>(c(),m("p",{key:o,innerHTML:o},null,8,Ar))),128))]),Cr],8,yr))}});var $r=[{title:"VitePress \u521B\u5EFA\u6587\u7AE0\u76EE\u5F55",content:`1. \u73AF\u5883
VitePress(Vue3 + TS)
2. \u601D\u8DEF
...
`,excerpt:"",url:"/posts\\tech\\css\\flex-align"},{title:"CSS \u5E38\u7528\u5355\u4F4D",content:`\u76F8\u5BF9\u5355\u4F4D vs \u7EDD\u5BF9\u5355\u4F4D
...
`,excerpt:"",url:"/posts\\tech\\css\\unit"},{title:"High-frequency Git CMD",content:`1. Global config
# global username
...
`,excerpt:"",url:"/posts\\tech\\git\\cmd"},{title:"Synchronize Git and Gitee repository",content:`1. Create a remote repository on Git and Gitee respectively
...
`,excerpt:"",url:"/posts\\tech\\git\\repo-sync"},{title:"GitHub\uFF1AAccess has been restricted?",content:`If your GitHub has been restricted...
1. Solution
...
`,excerpt:"",url:"/posts\\tech\\git\\restricted"},{title:"Multi-user configuration",content:`Add the file config to ~/.ssh.
# ~/.ssh/config
...
`,excerpt:"",url:"/posts\\tech\\git\\uconfig"},{title:"Use and customization of audio tag",content:`1. Basic
1.1. Usage
...
3. Customization
AudioPlayer.vue
`,excerpt:"",url:"/posts\\tech\\html\\audio"},{title:"HTML tag [object] VS [embed]",content:`The two tags are both able to render media object such as audio, video, pdf and flash.Due to the compatibility depending on different browsers, we should mainly use &lt;object&gt;.
1. &lt;object&gt;
...
`,excerpt:"",url:"/posts\\tech\\html\\embed-object"},{title:"JavaScript \u4E00\u952E\u56DE\u5230\u9876\u90E8",content:`1. \u73AF\u5883
Vue3 + TS
2. \u601D\u8DEF
...
`,excerpt:"",url:"/posts\\tech\\javascript\\backtop"},{title:"\u6D4F\u89C8\u5668\u8BED\u97F3\u5408\u6210\u3010Demo\u3011",content:`1. SpeechSynthesisUtterance
:::warning
Experimental: \u8FD9\u662F\u4E00\u4E2A\u5B9E\u9A8C\u4E2D\u7684\u529F\u80FD\u7531\u4E8E\u8BE5\u529F\u80FD\u5BF9\u5E94\u7684\u6807\u51C6\u6587\u6863\u53EF\u80FD\u88AB\u91CD\u65B0\u4FEE\u8BA2\uFF0C\u6240\u4EE5\u5728\u672A\u6765\u7248\u672C\u7684\u6D4F\u89C8\u5668\u4E2D\u8BE5\u529F\u80FD\u7684\u8BED\u6CD5\u548C\u884C\u4E3A\u53EF\u80FD\u968F\u4E4B\u6539\u53D8\u3002
:::

SpeechSynthesisUtterance \u662F HTML5 \u4E2D\u65B0\u589E\u7684 API, \u7528\u4E8E\u5C06\u6307\u5B9A\u6587\u5B57\u5408\u6210\u4E3A\u5BF9\u5E94\u7684\u8BED\u97F3\uFF0C\u4E5F\u5305\u542B\u4E00\u4E9B\u914D\u7F6E\u9879\uFF0C\u6307\u5B9A\u5982\u4F55\u53BB\u9605\u8BFB(\u8BED\u8A00,\u97F3\u91CF,\u97F3\u8C03)\u7B49\u3002
 ...
 * @param {*} rate \u8BED\u901F\uFF1A0.1 - 10, \u9ED8\u8BA4\uFF1A1
 * @param {*} volume \u97F3\u91CF\uFF1A0 - 1\uFF0C\u9ED8\u8BA4\uFF1A0.5
 * 
 */
function speak(sentence, pitch=1, rate=1, volume=1, lang=&#39;zh-CN&#39;) {
...
`,excerpt:"",url:"/posts\\tech\\javascript\\browser-voice"},{title:"JavaScript \u6D45\u62F7\u8D1D\u548C\u6DF1\u62F7\u8D1D",content:`1. \u6D45\u62F7\u8D1D

\u590D\u5236\u6307\u5411\u6E90\u5BF9\u8C61\u5730\u5740\u7684\u6307\u9488\uFF0C\u65B0\u7684\u5BF9\u8C61\u4E0E\u6E90\u5BF9\u8C61\u5171\u4EAB\u5806\u5185\u5B58\u3002
...
\u590D\u5236\u6E90\u5BF9\u8C61\u672C\u8EAB\uFF0C\u65B0\u7684\u5BF9\u8C61\u4E0E\u6E90\u5BF9\u8C61\u4E0D\u5171\u4EAB\u5806\u5185\u5B58\u3002

\u65B9\u6CD5\uFF1A

JSON \u5E8F\u5217\u5316\uFF1AJSON.parse(JSON.tostringify());
JQuery: $.extend;
lodash\uFF1A_clone();
\u9012\u5F52\uFF1A/**
  * deep clone
...
const deepClone = (obj) =&gt; {
     ...
     for (let i in obj) {
         if (obj.hasOwnProperty) { // filter original object self property
             cloneObj[i] = deepClone(obj[i]) // deep clone
         }
     }
     return cloneObj
 }
...
`,excerpt:"",url:"/posts\\tech\\javascript\\clone"},{title:"One-click copy",content:`1. Definition
...
`,excerpt:"",url:"/posts\\tech\\javascript\\copy"},{title:"JavaScript \u9632\u6296\u8282\u6D41",content:`1. \u9632\u6296

\u5728\u6301\u7EED\u89E6\u53D1\u4E8B\u4EF6\u65F6\uFF0C\u53EA\u6267\u884C\u4E00\u6B21\u4E8B\u4EF6\u5904\u7406\u51FD\u6570\u3002

1.1. \u5E94\u7528\u573A\u666F
\u5E38\u7528\u4E8E\u9875\u9762/\u9F20\u6807\u6EDA\u52A8\u3001\u63D0\u4EA4\u6309\u94AE\u3001\u8F93\u5165\u6846\u641C\u7D22\u7B49\u4E8B\u4EF6\u5904\u7406\u3002
1.2. \u5B9E\u73B0\u601D\u8DEF
\u5728\u7B2C\u4E00\u6B21\u4E8B\u4EF6\u89E6\u53D1\u540E\uFF0C\u5F00\u59CB\u5EF6\u65F6\u8BA1\u65F6\uFF1A

if: \u5728\u8BBE\u5B9A\u65F6\u95F4\u5185\u518D\u6B21\u89E6\u53D1\u4E86\u4E8B\u4EF6\uFF0C\u53D6\u6D88\u4E0A\u4E00\u6B21\u8BA1\u65F6\uFF0C\u5F00\u542F\u65B0\u7684\u5EF6\u65F6\u8BA1\u65F6\uFF1B
else: \u5728\u8BBE\u5B9A\u65F6\u95F4\u5185\u6CA1\u6709\u518D\u6B21\u89E6\u53D1\u4E8B\u4EF6\uFF0C\u6267\u884C\u4E8B\u4EF6\u5904\u7406\u51FD\u6570\u3002
 ...
 * @param  {...any} rest rest params 
 * @returns function
 */
const debounce = (fn, delay, ...rest) =&gt; { // rest \u5269\u4F59\u53C2\u6570\u5217\u8868
    let timer = null
    // \u8FD4\u56DE\u4E00\u4E2A\u51FD\u6570
    return (...args) =&gt; { // args \u4E8B\u4EF6\u539F\u59CB\u53C2\u6570\u5217\u8868
        // \u6E05\u9664\u4E0A\u4E00\u6B21\u5B9A\u65F6
...
// \u4E8B\u4EF6\u5904\u7406\u51FD\u6570\uFF0C\u5EF6\u65F61\u79D2\u6267\u884C
const scrollFn = debounce((e, name) =&gt; {
...
\u5728\u6301\u7EED\u89E6\u53D1\u4E8B\u4EF6\u65F6\uFF0C\u5728\u4E00\u5B9A\u65F6\u95F4\u5185\u53EA\u89E6\u53D1\u4E00\u6B21\u4E8B\u4EF6\u5904\u7406\u51FD\u6570\u3002

2.1. \u5E94\u7528\u573A\u666F
\u9875\u9762/\u9F20\u6807\u6EDA\u52A8\u7B49\u9700\u8981\u7A00\u91CA\u4E8B\u4EF6\u89E6\u53D1\u9891\u7387\u7684\u573A\u5408\u3002
2.2. \u5B9E\u73B0\u601D\u8DEF
\u5728\u7B2C\u4E00\u6B21\u4E8B\u4EF6\u89E6\u53D1\u540E\uFF0C\u5F00\u59CB\u5EF6\u65F6\u8BA1\u65F6\uFF1A

\u5230\u8FBE\u8BBE\u5B9A\u65F6\u95F4\uFF0C\u89E6\u53D1\u4E00\u6B21\u4E8B\u4EF6\uFF0C\u7136\u540E\u91CD\u7F6E\u8BA1\u65F6\uFF1B
\u5982\u679C\u5728\u8BBE\u5B9A\u65F6\u95F4\u5185\u518D\u6B21\u89E6\u53D1\u4E86\u4E8B\u4EF6\uFF0C\u5FFD\u7565\u8BE5\u6B21\u89E6\u53D1\u3002
...
`,excerpt:"",url:"/posts\\tech\\javascript\\debounce-throttle"},{title:"ES6+ \u65B0\u7279\u6027",content:`1. \u57FA\u7840
1.1. let &amp; const
...
\u8FD4\u56DE\u5BF9\u8C61\u952E\u503C\u5BF9\u3002\u8FD4\u56DE\u503C\uFF1A[][]
`,excerpt:"",url:"/posts\\tech\\javascript\\es6"},{title:"JavaScript \u679A\u4E3E\u5BF9\u8C61\u5C5E\u6027",content:`1. Reflect.ownKeys(obj)

\u9759\u6001\u65B9\u6CD5 Reflect.ownKeys() \u8FD4\u56DE\u4E00\u4E2A\u7531\u76EE\u6807\u5BF9\u8C61\u81EA\u8EAB\u7684\u5C5E\u6027\u952E\u7EC4\u6210\u7684\u6570\u7EC4\uFF1B\u8BE5\u6570\u7EC4\u5305\u542B\u5BF9\u8C61\u81EA\u8EAB\u7684\u6240\u6709\u952E\u540D\uFF0C\u4E0D\u7BA1\u952E\u540D\u662F Symbol \u6216\u5B57\u7B26\u4E32\uFF0C\u4E5F\u4E0D\u7BA1\u662F\u5426\u53EF\u679A\u4E3E\u3002
...
// expected output: Array [&quot;property1&quot;, &quot;property2&quot;, Symbol()]
...
Object.getOwnPropertyNames() \u8FD4\u56DE\u4E00\u4E2A\u7531\u6307\u5B9A\u5BF9\u8C61\u7684\u6240\u6709\u81EA\u8EAB\u5C5E\u6027\u7684\u5C5E\u6027\u540D\u7EC4\u6210\u7684\u6570\u7EC4\uFF1B\u8BE5\u6570\u7EC4\u5305\u62EC\u4E0D\u53EF\u679A\u4E3E\u5C5E\u6027\uFF0C\u4F46\u4E0D\u5305\u62EC Symbol \u503C\u4F5C\u4E3A\u540D\u79F0\u7684\u5C5E\u6027\u3002
...
// Symbol
var obj = { [Symbol()]: &#39;s1&#39;, a: &#39;a&#39;};
console.log(Object.getOwnPropertyNames(obj)); // [&quot;a&quot;]

3. Object.keys(obj)

Object.keys() \u65B9\u6CD5\u4F1A\u8FD4\u56DE\u4E00\u4E2A\u7531\u4E00\u4E2A\u7ED9\u5B9A\u5BF9\u8C61\u7684\u81EA\u8EAB\u53EF\u679A\u4E3E\u5C5E\u6027\u7EC4\u6210\u7684\u6570\u7EC4\uFF1B\u8BE5\u6570\u7EC4\u4E0D\u5305\u62EC enumerable \u4E3A false \u6216\u8005 symbol \u5C5E\u6027\u7684\u540D\u79F0\uFF0C\u5C5E\u6027\u540D\u7684\u6392\u5217\u987A\u5E8F\u548C\u6B63\u5E38\u5FAA\u73AF\u904D\u5386\u8BE5\u5BF9\u8C61\u65F6\u8FD4\u56DE\u7684\u987A\u5E8F\u4E00\u81F4\u3002
...
`,excerpt:"",url:"/posts\\tech\\javascript\\obj-enum"},{title:"\u56FE\u7247\u9884\u52A0\u8F7D",content:`\u9884\u52A0\u8F7D:\u5728\u9875\u9762\u52A0\u8F7D\u5B8C\u6210\u524D\uFF0C\u63D0\u524D\u52A0\u8F7D\u56FE\u7247\u7B49\u8D44\u6E90\uFF0C\u6709\u5229\u4E8E\u63D0\u9AD8\u7528\u6237\u4F53\u9A8C\u3002
&lt;script setup lang=&quot;ts&quot;&gt;
...
`,excerpt:"",url:"/posts\\tech\\javascript\\preloadimg"},{title:"Node\uFF1ARead local Files and get the direcctory tree data",content:`// fs-extra
...
`,excerpt:"",url:"/posts\\tech\\node\\readfiles"},{title:'NPM\uFF1ACannot start service:Host version "0.15.10" does not match binary version "0.15.9"',content:`1. Error
...
`,excerpt:"",url:"/posts\\tech\\npm\\error-start"},{title:"NPM\uFF1Aoperation not permitted",content:`1. Error
npm install
...
Add global path in the file npmrc Open the npmrc file in the Nodejs installation directory. Ex: D:\\Program\\Nodejs\\node_modules\\npm\\.npmrc Add flowing:
prefix=D:\\Program\\Nodejs\\node_global
cache=D:\\Program\\Nodejs\\node_cache



`,excerpt:"",url:"/posts\\tech\\npm\\not-permitted"},{title:"NPM registry configuration",content:`1. By NPM config cmd
# show current
...
`,excerpt:"",url:"/posts\\tech\\vite\\start"},{title:"Webpack \u57FA\u7840",content:`1. Webpack

Webpack \u662F\u4E00\u4E2A\u57FA\u4E8E Nodejs\uFF0C\u9075\u5FAA Commonjs \u89C4\u8303\u7684\u9759\u6001\u6A21\u5757\u6253\u5305\u5DE5\u5177\u3002

1.1. \u6838\u5FC3

loader\uFF1A\u52A0\u8F7D\u975E JS \u6A21\u5757\uFF1B
plugin\uFF1A\u5728 webpack \u6784\u5EFA\u6D41\u7A0B\u4E2D\u6CE8\u5165\u6269\u5C55\u903B\u8F91\u6765\u6539\u53D8\u6784\u5EFA\u7ED3\u679C\u3002
...
2. \u4F7F\u7528
2.1. \u5B89\u88C5
# webpack-cli: \u89E3\u6790\u7528\u6237\u4F20\u5165\u7684\u53C2\u6570   
$ npm i webpack webpack-cli

2.2. webpack \u9ED8\u8BA4\u914D\u7F6E\u6587\u4EF6

webpack.config.js\uFF08\u5E38\u7528\uFF09
webpack.file.js

2.3. \u6267\u884C webpack \u6253\u5305
# npx: npm 5.2 \u4E4B\u540E\u7684\uFF0C\u9ED8\u8BA4\u6267\u884C node_modules/.bin \u4E0B\u7684\u6587\u4EF6
# \u53EF\u4EE5\u901A\u8FC7 --config \u6307\u5B9A\u6267\u884C\u6587\u4EF6
$ npx webpack # \u96F6\u914D\u7F6E\u6253\u5305
...
webpack-dev-server: \u5F00\u53D1\u73AF\u5883\u670D\u52A1\u5668\uFF0C\u5728\u5185\u5B58\u4E2D\u6253\u5305\uFF0C\u4E0D\u4F1A\u4EA7\u751F\u5B9E\u4F53\u6587\u4EF6
html-webpack-plugin: \u751F\u6210 html \u6A21\u677F\u6587\u4EF6\uFF0C\u5E76\u81EA\u52A8\u63D2\u5165 js
clean-webpack-plugin: \u6BCF\u6B21\u6253\u5305\u524D\u6E05\u7A7A\u76EE\u5F55
autoprefixer: \u81EA\u52A8\u6DFB\u52A0 css \u524D\u7F00
mini-css-extract-plugin: \u62BD\u79BB css \u6837\u5F0F, \u53EF\u4EE5\u548C js \u5E76\u884C\u52A0\u8F7D
optimize-css-assets-webpack-plugin\uFF1A\u538B\u7F29 css \u6587\u4EF6
terser-webpack-plugin\uFF1A\u538B\u7F29 js \u6587\u4EF6
babel\uFF1AES6+ \u8F6C\u5316\u6210 ES5
@babel/core\uFF1A\u6838\u5FC3\u6A21\u5757\uFF0C\u8F6C\u5316\u4EE3\u7801
@babel/preset-env\uFF1A\u6240\u6709\u628A ES6 \u8F6C\u5316\u6210 ES5 \u7684\u63D2\u4EF6\u96C6\u5408\uFF0C\u89E3\u6790 ES6 \u8F6C\u5316\u6210 ES5
@babel-loader\uFF1A\u9ED8\u8BA4\u8C03\u7528 @babel/core \u89E3\u6790 js \u6587\u4EF6
@babel/plugin-proposal-decorators\uFF1A\u89E3\u6790\u8349\u6848\u8BED\u6CD5 - \u88C5\u9970\u5668
@babel/plugin-proposal-class-properties\uFF1A\u89E3\u6790\u8349\u6848\u8BED\u6CD5 - class
@babel/plugin-transform-runtime&quot;\uFF1A\u8282\u7EA6\u4EE3\u7801



3.1. Loader\uFF08\u6267\u884C\u987A\u5E8F\uFF1A\u4ECE\u4E0B\u5F80\u4E0A\uFF0C\u4ECE\u53F3\u5F80\u5DE6\uFF09

css-loader: \u89E3\u6790 css \u8BED\u6CD5\uFF0C\u5E76\u628A\u7ED3\u679C\u4F20\u7ED9 style-loader
style-loader: \u5C06\u89E3\u6790\u7684 css \u53D8\u6210 style \u6807\u7B7E\uFF0C\u63D2\u5165\u5230\u9875\u9762\u4E2D
sass-loader: \u8C03\u7528 node-sass \u5904\u7406 sass \u6587\u4EF6
postcss-loader: \u5904\u7406 css \u524D\u7F00
file-loader: \u5904\u7406\u56FE\u7247\u6A21\u5757
url-loader: \u5C06\u5C0F\u56FE\u7247\u8F6C\u6210 base64

4. \u4F18\u5316

\u5220\u9664\u65E0\u7528\u7684 css \u6837\u5F0F
purgecss-webpack-plugin: \u53EA\u80FD\u914D\u5408 mini-css-extract-plugin \u4F18\u5316
glob: \u67E5\u627E\u5339\u914D\u7684\u6587\u4EF6
...
\u53BB\u9664\u65E0\u7528\u7684\u4EE3\u7801
tree-shaking\uFF1A\u9ED8\u8BA4\u53EA\u652F\u6301 ES6 \u8BED\u6CD5\uFF08\u9759\u6001\u5BFC\u5165\uFF09\uFF0C\u53EA\u5728\u751F\u4EA7\u73AF\u5883\u4E0B\u53EF\u7528

// package.json

 // \u79FB\u9664\u526F\u4F5C\u7528\u4EE3\u7801\uFF0C\u5982\u679C\u5F15\u7528\u7684\u53D8\u91CF\u6CA1\u6709\u4F7F\u7528\uFF0C\u5C31\u5220\u9664
...
DllPlugin \u52A8\u6001\u94FE\u63A5\u5E93\uFF08\u4E00\u822C\u5728\u5F00\u53D1\u73AF\u5883\u4E0B\u4F7F\u7528\uFF09
DllPlugin
DllReferencePlugin


\u52A8\u6001\u52A0\u8F7Dimport { add } from &#39;./add.js&#39;; // \u9759\u6001\u52A0\u8F7D
btn.addEventListener(&#39;click&#39;, function() =&gt; {
    // \u52A8\u6001\u52A0\u8F7D\uFF0C\u7C7B\u4F3C\u8DEF\u7531\u7684\u61D2\u52A0\u8F7D\uFF0C\u539F\u7406\uFF1Ajsonp \u52A8\u6001\u5BFC\u5165
    // import \u53EF\u4EE5\u5B9E\u73B0\u4EE3\u7801\u5206\u5272\uFF0C\u8FD4\u56DE\u4E00\u4E2A promise \u5B9E\u4F8B
    import(/** webpackChunckName: &#39;myAdd&#39; */&#39;./add.js&#39;) // \u9B54\u672F\u5B57\u7B26\u4E32
    .then((data) =&gt; {
        console.log(data);
    })
})
...
\u8017\u65F6\u5206\u6790
speed-meansure-webpack-plugin\uFF1A\u6D4B\u91CF\u6253\u5305\u901F\u5EA6


\u8FC7\u6EE4\u4E0D\u9700\u8981\u89E3\u6790\u7684\u6587\u4EF6\uFF1AnoPars

`,excerpt:"",url:"/posts\\tech\\webpack"},{title:"\u6D4F\u89C8\u5668\u63D2\u4EF6",content:`1. \u5B89\u88C5\u65B9\u5F0F
...
`,excerpt:"",url:"/posts\\tools\\ext-browser"},{title:"VSCode \u63D2\u4EF6",content:`
...
`,excerpt:"",url:"/posts\\tools\\ext-vscode"},{title:"Windows \u5B89\u88C5\u6E05\u5355",content:`1. \u5F00\u53D1
...
`,excerpt:"",url:"/posts\\tools\\sf-win"},{title:"POI lines",content:`This might be the first time I feel I like belong.                                          - Root
...
`,excerpt:"",url:"/posts\\vedio\\poi-lines02"},{title:"POI lines S03",content:`1. S03E05
...
`,excerpt:"",url:"/posts\\vedio\\poi-lines03"},{title:"POI lines S04",content:`1. S04E01
...
`,excerpt:"",url:"/posts\\vedio\\poi-lines04"},{title:"POI lines S05",content:`1. S05E04
...
`,excerpt:"",url:"/posts\\vue\\comm"},{title:"Vue \u9879\u76EE\u90E8\u7F72\u540E\u5237\u65B0\u9875\u9762 404",content:`1. \u95EE\u9898
Vue \u9879\u76EE\u4F7F\u7528 history \u8DEF\u7531\u6A21\u5F0F\u90E8\u7F72\u4E0A\u7EBF\u540E\uFF0C\u5237\u65B0\u9875\u9762\u51FA\u73B0 404\u3002
2. \u539F\u56E0
\u56E0\u4E3A\u7F51\u9875\u8BBF\u95EE\u7684\u662F\u9759\u6001\u7EDD\u5BF9\u8DEF\u5F84\uFF0C\u800C\u670D\u52A1\u5668\u4E0A\u6CA1\u6709\u8BE5\u8DEF\u3002
Vue \u662F\u5355\u9875\u5E94\u7528\uFF0C\u53EA\u6709\u4E00\u4E2A index.html \u4F5C\u4E3A\u5165\u53E3\u6587\u4EF6\uFF0C\u5176\u4ED6\u9875\u9762\u662F\u7531 js \u6765\u5B8C\u6210\u7EC4\u4EF6\u7684\u6E32\u67D3\u3002\u5728 history \u6A21\u5F0F\u4E0B\u7684\u8DEF\u7531\u8DF3\u8F6C\u662F\u901A\u8FC7\u6D4F\u89C8\u5668\u7684 history API \u64CD\u4F5C\u5386\u53F2\u8BB0\u5F55\u6808\u5B8C\u6210\uFF0C\u5E76\u4E0D\u4F1A\u5411\u670D\u52A1\u5668\u53D1\u8D77\u8BF7\u6C42\uFF1B\u5F53\u6211\u4EEC\u5237\u65B0\u975E\u4E3B\u9875\u9762\u65F6\uFF0C\u76F8\u5F53\u4E8E\u76F4\u63A5\u5411\u670D\u52A1\u5668\u53D1\u8D77 http \u8BF7\u6C42\uFF0C\u4F46\u662F\u8FD9\u4E2A\u8DEF\u5F84\u5728\u670D\u52A1\u5668\u4E0A\u5E76\u4E0D\u5B58\u5728\uFF0C\u6240\u4EE5\u4F1A\u8FD4\u56DE 404\u3002
3. \u89E3\u51B3

\u5C06\u8DEF\u7531\u6A21\u5F0F\u8BBE\u7F6E\u4E3A hash\uFF0C\u56E0\u4E3A hash \u503C\u4E0D\u4F1A\u88AB\u5305\u542B\u5230\u5B9E\u9645\u8BF7\u6C42\u4E2D\uFF0C\u8FD9\u6837\u4F1A\u4F7F url \u5730\u5740\u680F\u51FA\u73B0 #;
nginx \u91CD\u5B9A\u5411\uFF1Alocation / {
  try_files $uri $uri/ /index.html;
}


\u5728 GitHub Pages \u9759\u6001\u6258\u7BA1\u4E2D\u53EF\u4EE5\u62F7\u8D1D\u4E00\u4EFD index.html \u547D\u540D\u4E3A 404.html\u3002

`,excerpt:"",url:"/posts\\vue\\history-404"},{title:"Vue \u81EA\u5B9A\u4E49\u5168\u5C40 Loading \u63D2\u4EF6",content:`1. \u5B9A\u4E49\u89C6\u56FE\u6A21\u677F
...
`,excerpt:"",url:"/posts\\vue\\ref-ele"},{title:"Vue router mode\uFF1Ahash vs history",content:`1. Mode
There are two route modes in Vue-router: hash and history.
For aesthetics, we mostly adopt history mode.
So, there is any distinction between the two modes?
2. hash
Example: http:www.baidu.com/#/test 
# means hash = &quot;#/xxx&quot; 
Feature:The content after # will not be contained in the HTTP request,so the webpage will not be refreshed when the hash value has changed.
3. history
Example: http:www.baidu.com/test
History mode is supported by H5 history API:    

pushState(state, title[, url])
replaceState(state, title[, url])

We can operate the history stack of the browser by them.The params are the same for both methods:
3.1. pushState(state, title[, url])
Push a record into history stack of the browser.
Params:

state: Object, can be read by history.state;
title: String | Null, can be ignored;
url: String, target url.

3.2. replaceState(state, title[, url])
Modify a record of history stack.
4. Source
from Vue-router
...
`,excerpt:"",url:"/posts\\vue\\route-mode"},{title:"Vue3 \u5B50\u7EC4\u4EF6\u66F4\u65B0\u7236\u7EC4\u4EF6\u7684\u53C2\u6570",content:`\u7236\u7EC4\u4EF6\u4F20\u53C2\u3002
&lt;!-- index.vue --&gt;
&lt;script setup lang=&quot;ts&quot;&gt;
import { Ref, ref } from &#39;vue&#39;
import Child from &#39;./Child.vue&#39;;
...
`,excerpt:"",url:"/posts\\vue\\v3-model"}];const Lr={class:"input-group"},jr=i("i",{class:"fa fa-search"},null,-1),Pr={class:"result"},Er=["href"],Mr=["innerHTML"],Nr=["innerHTML"],Wr={key:0,class:"empty"},Br=i("i",{class:"fa fa-meh-o"},null,-1),Dr=$(" No Data "),Or=[Br,Dr],Fr=w({__name:"Search",setup(n){const{theme:e}=R(),t=H("");let o=D([]);const a=y(()=>!!(o.length||t.value));on(()=>{s(t.value)});function s(l){o.length=0,l.trim()!==""&&$r.forEach(d=>{const g=JSON.parse(JSON.stringify(d)),_=new RegExp(l,"ig"),q=g.title.match(_),v=g.content.match(_);q&&(g.title=u(l,g.title)),v&&(g.content=u(l,g.content)),(q||v)&&o.push(g)})}const u=(l,d)=>{const g=new RegExp(l,"ig");return d.replace(g,`<span class="search-highlight">${l}</span>`)},h=()=>{t.value=""};return(l,d)=>r(e).search?(c(),m("div",{key:0,class:j(["search-wrapper",r(a)?"open":""])},[i("div",Lr,[jr,dn(i("input",{type:"text",placeholder:"Search","onUpdate:modelValue":d[0]||(d[0]=g=>t.value=g)},null,512),[[ut,t.value]]),t.value?(c(),m("i",{key:0,class:"fa fa-trash",onClick:h})):f("",!0)]),i("ul",Pr,[(c(!0),m(T,null,L(r(o),g=>(c(),m("li",{key:g.title},[i("a",{href:g.url,onClick:h},[i("p",{innerHTML:g.title,class:"title"},null,8,Mr),i("p",{innerHTML:g.content,class:"content"},null,8,Nr)],8,Er)]))),128)),!r(o).length&&t.value!==""?(c(),m("li",Wr,Or)):f("",!0)])],2)):f("",!0)}}),Yr=w({__name:"PostList",props:{posts:Array},setup(n){const e=H("");return(t,o)=>(c(),m(T,null,[b(Fr,{filterKey:e.value,"onUpdate:filterKey":o[0]||(o[0]=a=>e.value=a)},null,8,["filterKey"]),i("div",null,[(c(!0),m(T,null,L(n.posts,(a,s)=>(c(),C(Hr,{key:s,article:a},null,8,["article"]))),128))])],64))}}),Gr=w({__name:"index",setup(n){const{theme:e}=R(),t=e.value.posts,o=H(1),a=H(e.value.pageSize),s=y(()=>t.slice(a.value*(o.value-1),a.value*o.value).map(l=>{const d=JSON.parse(JSON.stringify(l)),g=d.frontMatter.date;return d.frontMatter.dateArr=g.split("-"),d})),u=()=>{window.scrollTo(0,0)};return(h,l)=>(c(),m(T,null,[b(Yr,{posts:r(s)},null,8,["posts"]),b(Fe,{pageSize:a.value,pageNum:o.value,"onUpdate:pageNum":l[0]||(l[0]=d=>o.value=d),total:r(e).posts.length,onPagination:u},null,8,["pageSize","pageNum","total"])],64))}});const Jr=n=>(N("data-v-072447f6"),n=n(),W(),n),zr={class:"loading"},Vr={class:"loading-svg hover",width:"100",height:"100",viewBox:"0 0 40 60"},Ur=Jr(()=>i("polygon",{class:"triangulo",fill:"none",stroke:"#fff","stroke-width":"1",points:"16,1 32,32 1,32"},null,-1)),Kr={class:"text",x:"0",y:"45",fill:"#fff"},Xr=w({__name:"Loading",props:{msg:{type:String,required:!0}},setup(n){return(e,t)=>(c(),m("div",zr,[(c(),m("svg",Vr,[Ur,i("text",Kr,p(n.msg.value),1)]))]))}});var Qr=S(Xr,[["__scopeId","data-v-072447f6"]]);const un=D({msg:"Loading..."});let cn;const fe={show(n=un.msg){un.msg=n,cn=ne(Qr,{...an(un)}).mount(document.createElement("div")).$el,document.body.appendChild(cn)},hide(){document.body.removeChild(cn)},install(n){n.config.globalProperties.loading=fe}};var tn={...xa,Layout:fr,async enhanceApp({app:n,router:e,siteData:t}){n.component("Page",Gr),n.use(fe)}};const hn=new Set,ye=()=>document.createElement("link"),Zr=n=>{const e=ye();e.rel="prefetch",e.href=n,document.head.appendChild(e)},ni=n=>{const e=new XMLHttpRequest;e.open("GET",n,e.withCredentials=!0),e.send()};let Q;const ei=J&&(Q=ye())&&Q.relList&&Q.relList.supports&&Q.relList.supports("prefetch")?Zr:ni;function ti(){if(!J||!window.IntersectionObserver)return;let n;if((n=navigator.connection)&&(n.saveData||/2g/.test(n.effectiveType)))return;const e=window.requestIdleCallback||setTimeout;let t=null;const o=()=>{t&&t.disconnect(),t=new IntersectionObserver(s=>{s.forEach(u=>{if(u.isIntersecting){const h=u.target;t.unobserve(h);const{pathname:l}=h;if(!hn.has(l)){hn.add(l);const d=Xn(l);ei(d)}}})}),e(()=>{document.querySelectorAll("#app a").forEach(s=>{const{target:u,hostname:h,pathname:l}=s,d=l.match(/\.\w+$/);d&&d[0]!==".html"||u!=="_blank"&&h===location.hostname&&(l!==location.pathname?t.observe(s):hn.add(l))})})};E(o);const a=F();U(()=>a.path,o),K(()=>{t&&t.disconnect()})}const oi=w({setup(n,{slots:e}){const t=H(!1);return E(()=>{t.value=!0}),()=>t.value&&e.default?e.default():null}}),ai=tn.NotFound||(()=>"404 Not Found"),si={name:"VitePressApp",setup(){const{site:n}=R();return E(()=>{U(()=>n.value.lang,e=>{document.documentElement.lang=e},{immediate:!0})}),ti(),()=>G(tn.Layout)}};function ri(){const n=li(),e=ii();e.provide(Ne,n);const t=We(n.route);return e.provide(Be,t),J&&mt(n.route,t.site),e.component("Content",De),e.component("ClientOnly",oi),e.component("Debug",()=>null),Object.defineProperty(e.config.globalProperties,"$frontmatter",{get(){return t.frontmatter.value}}),tn.enhanceApp&&tn.enhanceApp({app:e,router:n,siteData:Oe}),{app:e,router:n}}function ii(){return dt(si)}function li(){let n=J,e;return Me(t=>{let o=Xn(t);return n&&(e=o),(n||e===o)&&(o=o.replace(/\.js$/,".lean.js")),J?(n=!1,Yn(()=>import(o),[])):require(o)},ai)}if(J){const{app:n,router:e}=ri();e.go().then(()=>{n.mount("#app")})}export{Wn as N,ri as createApp};
