import{d as n,c as s,o as a,e}from"./app.08a6f253.js";const g='{"title":"High-Frequency Git CMD","description":"Note","frontmatter":{"title":"High-Frequency Git CMD","description":"Note","date":"2022-01-18T08:45:18.000Z","sidebar":true,"comment":true,"category":["Tech"],"tags":["Git"]},"relativePath":"posts/tech/git/cmd.md","lastUpdated":1663592904297}',t={},o=e(`<h1 id="_1-global-config" tabindex="-1">1. Global config <a class="header-anchor" href="#_1-global-config" aria-hidden="true">#</a></h1><div class="language-bash line-numbers-mode"><pre><code><span class="token comment"># global username</span>
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br></div></div>`,4),c=[o];function r(i,l,p,u,m,d){return a(),s("div",null,c)}var _=n(t,[["render",r]]);export{g as __pageData,_ as default};
